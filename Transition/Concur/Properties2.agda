...
{-
   ...
   /-preserves-⌣ [ _│ᵥ•_ {y = y} 𝐸 𝐹 ]ˡ [ _│ᵥ_ {•x⌣•u = ᵛ∇ᵛ} 𝐸′ 𝐹′ ]ˡ [ 𝐸″ │ᵥ• 𝐹″ ]ˡ =
      [ (pop y *ᵇᵇ⌣) (/-preserves-⌣₄ 𝐸′ 𝐸 𝐸″) │ᵥ /-preserves-⌣₄ 𝐹′ 𝐹 𝐹″ ]
-}
   /-preserves-⌣ [ 𝐸 │ᵥᵇ 𝐹 ] [ 𝐸′ │ᵥ• 𝐹′ ] [ 𝐸″ │•ᵇ F ] = [ {!!} ]ˡ
   /-preserves-⌣ [ 𝐸 │ᵥᵇ 𝐹 ] [ 𝐸′ │ᵥ 𝐹′ ] [ 𝐸″ │ᵥᵇ F ] = [ {!!} │ᵥ {!!} ]
   /-preserves-⌣ [ 𝐸 │ᵥᵇ 𝐹 ] [ 𝐸′ │ᵥᵇ .𝐹 ]ˡ [ 𝐸″ ᵇᵇ│ Q ] = [ {!!} ]ˡ
   /-preserves-⌣ [ 𝐸 │ᵥᵇ 𝐹 ] [ 𝐸′ │ᵥᶜ .𝐹 ]ˡ [ 𝐸″ ᵇᶜ│ Q ] = [ {!!} │ᵥᶜ {!!} ]ˡ
   /-preserves-⌣ [ 𝐸 │ᵥᵇ 𝐹 ] [ 𝐸′ ᵇ│ᵥ 𝐹′ ]ˡ [ E ᵇ│ᵇ F ] = [ {!!} ᵇ│ᵥ {!!} ]ˡ
   /-preserves-⌣ [ 𝐸 │ᵥᵇ 𝐹 ] [ 𝐸′ ᶜ│ᵥ 𝐹′ ]ˡ [ E ᵇ│ᶜ F ] = [ {!!} ᶜ│ᵥ {!!} ]ˡ
   /-preserves-⌣ [ 𝐸 │ᵥᵇ 𝐹 ] [ 𝐸′ │ᵥ 𝐹′ ]ˡ [ 𝐸″ │ᵥᵇ F ] = [ {!!} │ᵥ {!!} ]
   /-preserves-⌣ [ 𝐸 │ᵥᵇ 𝐹 ] [ 𝐸′ │ᵥᵇ .𝐹 ]ˡ [ 𝐸″ ᵇᵇ│ Q ]ˡ = [ {!!} ]
{-
