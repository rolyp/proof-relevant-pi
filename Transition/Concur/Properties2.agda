...
{-
   ...
   │ᵥᵇ-preserves 𝐸 F [ 𝐸′ │ᵥᵇ .F ]ˡ [ _ᵇᵇ│_ {a⌣a′ = ᵇ∇ᵇ} 𝐸″ Q ]ˡ = [ /-preserves-⌣₂ 𝐸 𝐸′ 𝐸″ │ᵥᵇ (push *ᵇ) F ]ˡ
   │ᵥᵇ-preserves 𝐸 F [ 𝐸′ │ᵥᵇ .F ]ˡ [ _ᵇᵇ│_ {a⌣a′ = ᵛ∇ᵛ} 𝐸″ Q ]ˡ = [ /-preserves-⌣₂ 𝐸 𝐸′ 𝐸″ │ᵥᶜ (push *ᵇ) F ]ˡ
...
-}
   ...
   │ᵥᵇˡ-preserves 𝐸 F [ 𝐸′ │•ᵇ F′ ] [ 𝐸″ │ᵥ• 𝐹 ] = {!!}
   │ᵥᵇˡ-preserves 𝐸 F [ 𝐸′ │ᵥᵇ F′ ] [ 𝐸″ │ᵥ 𝐹 ] = {!!}
   │ᵥᵇˡ-preserves 𝐸 F [ E ᵇ│ᵇ F′ ] [ E′ ᵇ│ᵥ 𝐹 ]ˡ = {!!}
   │ᵥᵇˡ-preserves 𝐸 F [ E ᵇ│ᶜ F′ ] [ E′ ᶜ│ᵥ 𝐹 ]ˡ = {!!}
   │ᵥᵇˡ-preserves 𝐸 F [ 𝐸′ │ᵥᵇ F′ ] [ 𝐸″ │ᵥ 𝐹 ]ˡ = {!!}
   │ᵥᵇˡ-preserves 𝐸 F [ 𝐸′ ᵇᵇ│ Q ] [ 𝐸″ │ᵥᵇ .F ]ˡ = {!!}
   │ᵥᵇˡ-preserves 𝐸 F [ 𝐸′ ᵇᶜ│ Q ] [ 𝐸″ │ᵥᶜ .F ]ˡ = {!!}
   │ᵥᵇˡ-preserves 𝐸 F [ 𝐸′ ᵇᵇ│ Q ]ˡ [ 𝐸″ │ᵥᵇ .F ]ˡ = {!!}
   │ᵥᵇˡ-preserves 𝐸 F [ E ᵇ│ᵇ F₁ ] [ () ]
   │ᵥᵇˡ-preserves 𝐸 F [ E ᵇ│ᶜ F₁ ] [ () ]
   │ᵥᵇˡ-preserves 𝐸 F [ x₁ ᵇᵇ│ Q ] [ () ]
   │ᵥᵇˡ-preserves 𝐸 F [ x₁ ᵇᶜ│ Q ] [ () ]
   │ᵥᵇˡ-preserves 𝐸 F [ x₂ │•ᵇ F₁ ] [ () ]ˡ
   │ᵥᵇˡ-preserves 𝐸 F [ x₁ ᵇᵇ│ Q ]ˡ [ () ]
{-
