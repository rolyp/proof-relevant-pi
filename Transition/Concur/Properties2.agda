...
-}
   /-preserves-⌣ [ 𝐸 │ᵥᶜ F ] [ x₂ │ᵥ• x₃ ] [ x₄ │•ᶜ F′ ] = {!!}
   /-preserves-⌣ [ 𝐸 │ᵥᶜ F ] [ x₂ │ᵥ x₃ ] [ x₄ │ᵥᶜ F′ ] = {!!}
   /-preserves-⌣ [ 𝐸 │ᵥᶜ F ] [ x₁ │ᵥᶜ .F ]ˡ [ x₂ ᶜᶜ│ Q ] = {!!}
   /-preserves-⌣ [ 𝐸 │ᵥᶜ F ] [ E′ ᵇ│ᵥ x₁ ]ˡ [ E ᶜ│ᵇ F₁ ] = {!!}
   /-preserves-⌣ [ 𝐸 │ᵥᶜ F ] [ E′ ᶜ│ᵥ x₁ ]ˡ [ E ᶜ│ᶜ F₁ ] = {!!}
   /-preserves-⌣ [ 𝐸 │ᵥᶜ F ] [ x₁ │ᵥ x₂ ]ˡ [ x₃ │ᵥᶜ F₁ ] = {!!}
   /-preserves-⌣ [ 𝐸 │ᵥᶜ F ] [ x₁ │ᵥᵇ .F ]ˡ [ x₂ ᵇᶜ│ Q ]ˡ = {!!}
   /-preserves-⌣ [ 𝐸 │ᵥᶜ F ] [ x₁ │ᵥᶜ .F ]ˡ [ x₂ ᶜᶜ│ Q ]ˡ = {!!}
{-
