module Transition.Concur.Properties2 where
   ...
   ... | pop-y*E/E′ = let blah = ⌣-sym (/-preserves-⌣ 𝐸 (⌣-sym 𝐸′) (⌣-sym 𝐸″)) in [ νᵇᶜ [ {!!} │•ᵇ _ ] ]ˡ
   /-preserves-⌣ [ 𝐸 │ᵥ• 𝐹 ] [ 𝐸′ │•ᶜ F ]ˡ [ 𝐸″ │ᵥᶜ F′ ]ˡ =
      let blah = ⌣-sym (/-preserves-⌣ 𝐸 (⌣-sym 𝐸′) (⌣-sym 𝐸″)) in [ νᶜᶜ [ {!!} │•ᶜ {!!} ]ˡ ]
   /-preserves-⌣ [ 𝐸 │ᵥ• 𝐹 ] [ E′ ᵇ│• 𝐹′ ]ˡ [ E ᵇ│ᵥ 𝐹″ ]ˡ = {!!}
   /-preserves-⌣ [ 𝐸 │ᵥ• 𝐹 ] [ E′ ᶜ│• 𝐹′ ]ˡ [ E ᶜ│ᵥ 𝐹″ ]ˡ = [ νᶜᶜ [ ({!!} ᶜ│• {!!}) ]ˡ ]
