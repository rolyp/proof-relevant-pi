module Transition.Concur.Properties2 where
   ...
   │ᵥ•-preserves 𝐸 𝐹 [ 𝐸′ │•ᵇ F ]ˡ [ 𝐸″ │ᵥᵇ F′ ]ˡ = [ νᵇᶜ [ /-preserves-⌣₂ 𝐸 𝐸′ 𝐸″ │•ᵇ _ ] ]ˡ
   │ᵥ•-preserves 𝐸 𝐹 [ 𝐸′ │•ᶜ F ]ˡ [ 𝐸″ │ᵥᶜ F′ ]ˡ = [ νᶜᶜ [ /-preserves-⌣₂ 𝐸 𝐸′ 𝐸″ │•ᶜ _ ]ˡ ]
   │ᵥ•-preserves 𝐸 𝐹 [ E′ ᵇ│• 𝐹′ ]ˡ [ _ᵇ│ᵥ_ {a⌣a′ = ᵇ∇ᵇ} E 𝐹″ ]ˡ = [ νᵇᶜ [ _ ᵇ│• /-preserves-⌣₂ 𝐹 𝐹′ 𝐹″ ] ]ˡ
   │ᵥ•-preserves 𝐸 𝐹 [ E′ ᵇ│• 𝐹′ ]ˡ [ _ᵇ│ᵥ_ {a⌣a′ = ᵛ∇ᵛ} E 𝐹″ ]ˡ = [ ν•ᶜ [ _ ᶜ│• /-preserves-⌣₂ 𝐹 𝐹′ 𝐹″ ] ]ˡ
   │ᵥ•-preserves 𝐸 𝐹 [ E′ ᶜ│• 𝐹′ ]ˡ [ E ᶜ│ᵥ 𝐹″ ]ˡ = [ νᶜᶜ [ _ ᶜ│• /-preserves-⌣₂ 𝐹 𝐹′ 𝐹″ ]ˡ ]
   ...
   │ᵥ•ˡ-preserves 𝐸 𝐹 [ 𝐸′ │ᵥ• 𝐹′ ] [ 𝐸″ │• 𝐹″ ] = [ {!!} │ᵥ• {!!} ]
   │ᵥ•ˡ-preserves 𝐸 𝐹 [ 𝐸′ │ᵥ• 𝐹′ ] [ 𝐸″ │• 𝐹″ ]ˡ = [ {!!} │ᵥ• {!!} ]
   │ᵥ•ˡ-preserves 𝐸 𝐹 [ 𝐸′ │ᵥ 𝐹′ ] [ 𝐸″ │ᵥ• 𝐹″ ]ˡ = [ {!!} │ᵥ {!!} ]
   │ᵥ•ˡ-preserves 𝐸 𝐹 [ 𝐸′ │ᵥᵇ F ]ˡ [ 𝐸″ │•ᵇ F′ ]ˡ = [ {!!} ]
   │ᵥ•ˡ-preserves 𝐸 𝐹 [ 𝐸′ │ᵥᶜ F ]ˡ [ 𝐸″ │•ᶜ F′ ]ˡ = [ {!!} ]
   │ᵥ•ˡ-preserves 𝐸 𝐹 [ E ᵇ│ᵥ 𝐹′ ]ˡ [ E′ ᵇ│• 𝐹″ ]ˡ = [ {!!} ᵇ│ᵥ {!!} ]ˡ
   │ᵥ•ˡ-preserves 𝐸 𝐹 [ E ᶜ│ᵥ 𝐹′ ]ˡ [ E′ ᶜ│• 𝐹″ ]ˡ = [ {!!} ᶜ│ᵥ {!!} ]ˡ
   │ᵥ•ˡ-preserves 𝐸 𝐹 [ 𝐸′ │ᵥ 𝐹′ ]ˡ [ 𝐸″ │ᵥ• 𝐹″ ]ˡ = [ {!!} │ᵥ {!!} ]
...
{-
   ...
   /-preserves-⌣ [ 𝐸 │ᵥᵇ F ] [ 𝐸′ │ᵥᵇ .F ]ˡ [ _ᵇᵇ│_ {a⌣a′ = ᵛ∇ᵛ} 𝐸″ Q ] =
      [ ⌣-sym (/-preserves-⌣ᴰᵁᴰ 𝐸 𝐸′ 𝐸″) │ᵥᶜ (push *ᵇ) F ]ˡ
   /-preserves-⌣ [ 𝐸 │ᵥᵇ F ] [ 𝐸′ │ᵥᶜ .F ]ˡ [ 𝐸″ ᵇᶜ│ Q ] = [ /-preserves-⌣ 𝐸″ 𝐸′ 𝐸 │ᵥᶜ (push *ᵇ) F ]ˡ
   /-preserves-⌣ [ 𝐸 │ᵥᵇ F ] [ E ᵇ│ᵥ 𝐹′ ]ˡ [ E′ ᵇ│ᵇ F′ ] = [ E′/E (⊖ 𝐸) ᵇ│ᵥ (push *ᵇᵇ⌣) 𝐹′ ]ˡ
   /-preserves-⌣ [ 𝐸 │ᵥᵇ F ] [ E ᶜ│ᵥ 𝐹′ ]ˡ [ E′ ᵇ│ᶜ F′ ] = [ E′/E (⊖ 𝐸) ᶜ│ᵥ (push *ᶜᵇ⌣) 𝐹′ ]ˡ
   /-preserves-⌣ [ 𝐸 │ᵥᵇ F ] [ 𝐸′ │ᵥ 𝐹′ ]ˡ [ 𝐸″ │ᵥᵇ F′ ] = [ ⌣-sym (/-preserves-⌣ 𝐸″ 𝐸′ 𝐸) │ᵥ ⌣-sym ((push *ᵇᵇ⌣) 𝐹′) ]
   /-preserves-⌣ [ 𝐸 │ᵥᵇ F ] [ 𝐸′ │ᵥᵇ .F ]ˡ [ _ᵇᵇ│_ {a⌣a′ = ᵇ∇ᵇ} 𝐸″ Q ]ˡ = [ /-preserves-⌣₂ 𝐸 𝐸′ 𝐸″ │ᵥᵇ (push *ᵇ) F ]ˡ
   /-preserves-⌣ [ 𝐸 │ᵥᵇ F ] [ 𝐸′ │ᵥᵇ .F ]ˡ [ _ᵇᵇ│_ {a⌣a′ = ᵛ∇ᵛ} 𝐸″ Q ]ˡ = [ /-preserves-⌣₂ 𝐸 𝐸′ 𝐸″ │ᵥᶜ (push *ᵇ) F ]ˡ
-}
   /-preserves-⌣ [ 𝐸 │ᵥᵇ F ]ˡ [ 𝐸′ │•ᵇ F′ ] [ 𝐸″ │ᵥ• 𝐹 ] = {!!}
   /-preserves-⌣ [ 𝐸 │ᵥᵇ F ]ˡ [ 𝐸′ │ᵥᵇ F′ ] [ 𝐸″ │ᵥ 𝐹 ] = {!!}
   /-preserves-⌣ [ 𝐸 │ᵥᵇ F ]ˡ [ E ᵇ│ᵇ F′ ] [ E′ ᵇ│ᵥ 𝐹 ]ˡ = {!!}
   /-preserves-⌣ [ 𝐸 │ᵥᵇ F ]ˡ [ E ᵇ│ᶜ F′ ] [ E′ ᶜ│ᵥ 𝐹 ]ˡ = {!!}
   /-preserves-⌣ [ 𝐸 │ᵥᵇ F ]ˡ [ 𝐸′ │ᵥᵇ F′ ] [ 𝐸″ │ᵥ 𝐹 ]ˡ = {!!}
   /-preserves-⌣ [ 𝐸 │ᵥᵇ F ]ˡ [ 𝐸′ ᵇᵇ│ Q ] [ 𝐸″ │ᵥᵇ .F ]ˡ = {!!}
   /-preserves-⌣ [ 𝐸 │ᵥᵇ F ]ˡ [ 𝐸′ ᵇᶜ│ Q ] [ 𝐸″ │ᵥᶜ .F ]ˡ = {!!}
   /-preserves-⌣ [ 𝐸 │ᵥᵇ F ]ˡ [ 𝐸′ ᵇᵇ│ Q ]ˡ [ 𝐸″ │ᵥᵇ .F ]ˡ = {!!}
{-
   /-preserves-⌣ [ 𝐸 │ᵥᶜ F ] [ 𝐸′ │ᵥ• 𝐹′ ] [ 𝐸″ │•ᶜ F′ ] = {!!}
   /-preserves-⌣ [ 𝐸 │ᵥᶜ F ] [ 𝐸′ │ᵥ 𝐹′ ] [ 𝐸″ │ᵥᶜ F′ ] = {!!}
   /-preserves-⌣ [ 𝐸 │ᵥᶜ F ] [ 𝐸′ │ᵥᶜ .F ]ˡ [ 𝐸″ ᶜᶜ│ Q ] = {!!}
   /-preserves-⌣ [ 𝐸 │ᵥᶜ F ] [ E′ ᵇ│ᵥ 𝐹′ ]ˡ [ E ᶜ│ᵇ F′ ] = {!!}
   /-preserves-⌣ [ 𝐸 │ᵥᶜ F ] [ E′ ᶜ│ᵥ 𝐹′ ]ˡ [ E ᶜ│ᶜ F′ ] = {!!}
   /-preserves-⌣ [ 𝐸 │ᵥᶜ F ] [ 𝐸′ │ᵥ 𝐹′ ]ˡ [ 𝐸″ │ᵥᶜ F′ ] = {!!}
   /-preserves-⌣ [ 𝐸 │ᵥᶜ F ] [ 𝐸′ │ᵥᵇ .F ]ˡ [ 𝐸″ ᵇᶜ│ Q ]ˡ = {!!}
   /-preserves-⌣ [ 𝐸 │ᵥᶜ F ] [ 𝐸′ │ᵥᶜ .F ]ˡ [ 𝐸″ ᶜᶜ│ Q ]ˡ = {!!}
