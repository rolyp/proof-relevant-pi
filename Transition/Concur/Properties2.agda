...
-}
   ...
   ᵇ│ᵥ-preserves {a⌣a′ = ᵇ∇ᵇ} E 𝐹 [ 𝐸 │ᵥ• 𝐹′ ] [ E′ ᵇ│• 𝐹″ ] = [ (push *ᵇᵇ⌣) 𝐸 │ᵥ• {!!} ]
   ᵇ│ᵥ-preserves {a⌣a′ = ᵛ∇ᵛ} E 𝐹 [ 𝐸 │ᵥ• 𝐹′ ] [ E′ ᵇ│• 𝐹″ ] = [ (push *ᵇᵇ⌣) 𝐸 │• {!!} ]
   ᵇ│ᵥ-preserves {a⌣a′ = ᵇ∇ᵇ} E 𝐹 [ 𝐸 │ᵥ 𝐹′ ] [ _ᵇ│ᵥ_ {a⌣a′ = ᵇ∇ᵇ} E′ 𝐹″ ] = [ (push *ᵇᵇ⌣) (⌣-sym 𝐸) │ᵥ {!!} ]ˡ
   ᵇ│ᵥ-preserves {a⌣a′ = ᵇ∇ᵇ} E 𝐹 [ 𝐸 │ᵥ 𝐹′ ] [ _ᵇ│ᵥ_ {a⌣a′ = ᵛ∇ᵛ} E′ 𝐹″ ] = [ (push *ᵇᵇ⌣) 𝐸 │ᵥ• {!!} ]
   ᵇ│ᵥ-preserves {a⌣a′ = ᵛ∇ᵛ} E 𝐹 [ 𝐸 │ᵥ 𝐹′ ] [ _ᵇ│ᵥ_ {a⌣a′ = ᵇ∇ᵇ} E′ 𝐹″ ] = [ (push *ᵇᵇ⌣) (⌣-sym 𝐸) │ᵥ• {!!} ]ˡ
   ᵇ│ᵥ-preserves {a⌣a′ = ᵛ∇ᵛ} E 𝐹 [ 𝐸 │ᵥ 𝐹′ ] [ _ᵇ│ᵥ_ {a⌣a′ = ᵛ∇ᵛ} E′ 𝐹″ ] = [ (push *ᵇᵇ⌣) 𝐸 │• {!!} ]
   ᵇ│ᵥ-preserves {a⌣a′ = ᵇ∇ᵇ} E 𝐹 [ .E ᵇ│ᵥ 𝐹′ ]ˡ [ _│ᵇᵇ_ {a⌣a′ = ᵇ∇ᵇ} P 𝐹″ ] = [ (push *ᵇ) E ᵇ│ᵥ {!!} ]ˡ
   ᵇ│ᵥ-preserves {a⌣a′ = ᵇ∇ᵇ} E 𝐹 [ .E ᵇ│ᵥ 𝐹′ ]ˡ [ _│ᵇᵇ_ {a⌣a′ = ᵛ∇ᵛ} P 𝐹″ ] = [ (push *ᵇ) E ᶜ│ᵥ {!!} ]ˡ
   ᵇ│ᵥ-preserves {a⌣a′ = ᵛ∇ᵛ} E 𝐹 [ .E ᵇ│ᵥ 𝐹′ ]ˡ [ _│ᵇᵇ_ {a⌣a′ = ᵇ∇ᵇ} P 𝐹″ ] = [ (push *ᵇ) E ᵇ│• {!!} ]ˡ
   ᵇ│ᵥ-preserves {a⌣a′ = ᵛ∇ᵛ} E 𝐹 [ .E ᵇ│ᵥ 𝐹′ ]ˡ [ _│ᵇᵇ_ {a⌣a′ = ᵛ∇ᵛ} P 𝐹″ ] = [ (push *ᵇ) E ᶜ│• {!!} ]ˡ
   ᵇ│ᵥ-preserves {a⌣a′ = ᵇ∇ᵇ} E 𝐹 [ .E ᶜ│ᵥ 𝐹′ ]ˡ [ P │ᵇᶜ 𝐹″ ] = [ (push *ᵇ) E ᶜ│ᵥ {!!} ]ˡ
   ᵇ│ᵥ-preserves {a⌣a′ = ᵛ∇ᵛ} E 𝐹 [ .E ᶜ│ᵥ 𝐹′ ]ˡ [ P │ᵇᶜ 𝐹″ ] = [ (push *ᵇ) E ᶜ│• {!!} ]ˡ
   ᵇ│ᵥ-preserves {a⌣a′ = ᵇ∇ᵇ} E 𝐹 [ 𝐸 │ᵥ 𝐹′ ]ˡ [ _ᵇ│ᵥ_ {a⌣a′ = ᵇ∇ᵇ} E′ 𝐹″ ] = [ (push *ᵇᵇ⌣) (⌣-sym 𝐸) │ᵥ {!!} ]
   ᵇ│ᵥ-preserves {a⌣a′ = ᵇ∇ᵇ} E 𝐹 [ 𝐸 │ᵥ 𝐹′ ]ˡ [ _ᵇ│ᵥ_ {a⌣a′ = ᵛ∇ᵛ} E′ 𝐹″ ] = [ (push *ᵇᵇ⌣) (⌣-sym 𝐸) │ᵥ• {!!} ]
   ᵇ│ᵥ-preserves {a⌣a′ = ᵛ∇ᵛ} E 𝐹 [ 𝐸 │ᵥ 𝐹′ ]ˡ [ _ᵇ│ᵥ_ {a⌣a′ = ᵇ∇ᵇ} E′ 𝐹″ ] = [ (push *ᵇᵇ⌣) 𝐸 │ᵥ• {!!} ]ˡ
   ᵇ│ᵥ-preserves {a⌣a′ = ᵛ∇ᵛ} E 𝐹 [ 𝐸 │ᵥ 𝐹′ ]ˡ [ _ᵇ│ᵥ_ {a⌣a′ = ᵛ∇ᵛ} E′ 𝐹″ ] = [ (push *ᵇᵇ⌣) (⌣-sym 𝐸) │• {!!} ]
   ᵇ│ᵥ-preserves {a⌣a′ = ᵇ∇ᵇ} E 𝐹 [ 𝐸 │ᵥᵇ F′ ]ˡ [ E′ ᵇ│ᵇ F ]ˡ = [ (push *ᵇᵇ⌣) 𝐸 │ᵥᵇ {!!} ]ˡ
   ᵇ│ᵥ-preserves {a⌣a′ = ᵛ∇ᵛ} E 𝐹 [ 𝐸 │ᵥᵇ F′ ]ˡ [ E′ ᵇ│ᵇ F ]ˡ = [ (push *ᵇᵇ⌣) 𝐸 │•ᵇ {!!} ]ˡ
   ᵇ│ᵥ-preserves {a⌣a′ = ᵇ∇ᵇ} E 𝐹 [ 𝐸 │ᵥᶜ F′ ]ˡ [ E′ ᶜ│ᵇ F ]ˡ = [ (push *ᶜᵇ⌣) 𝐸 │ᵥᶜ {!!} ]ˡ
   ᵇ│ᵥ-preserves {a⌣a′ = ᵛ∇ᵛ} E 𝐹 [ 𝐸 │ᵥᶜ F′ ]ˡ [ E′ ᶜ│ᵇ F ]ˡ = [ (push *ᶜᵇ⌣) 𝐸 │•ᶜ {!!} ]ˡ
   ᵇ│ᵥ-preserves {a⌣a′ = ᵇ∇ᵇ} E 𝐹 [ .E ᵇ│ᵥ 𝐹′ ]ˡ [ _│ᵇᵇ_ {a⌣a′ = ᵇ∇ᵇ} P 𝐹″ ]ˡ = [ (push *ᵇ) E ᵇ│ᵥ {!!} ]ˡ
   ᵇ│ᵥ-preserves {a⌣a′ = ᵇ∇ᵇ} E 𝐹 [ .E ᵇ│ᵥ 𝐹′ ]ˡ [ _│ᵇᵇ_ {a⌣a′ = ᵛ∇ᵛ} P 𝐹″ ]ˡ = [ (push *ᵇ) E ᶜ│ᵥ {!!} ]ˡ
   ᵇ│ᵥ-preserves {a⌣a′ = ᵛ∇ᵛ} E 𝐹 [ .E ᵇ│ᵥ 𝐹′ ]ˡ [ _│ᵇᵇ_ {a⌣a′ = ᵇ∇ᵇ} P 𝐹″ ]ˡ = [ (push *ᵇ) E ᵇ│• {!!} ]ˡ
   ᵇ│ᵥ-preserves {a⌣a′ = ᵛ∇ᵛ} E 𝐹 [ .E ᵇ│ᵥ 𝐹′ ]ˡ [ _│ᵇᵇ_ {a⌣a′ = ᵛ∇ᵛ} P 𝐹″ ]ˡ = [ (push *ᵇ) E ᶜ│• {!!} ]ˡ
   ...
   ᵇ│ᵥˡ-preserves E 𝐹 [ E′ ᵇ│• 𝐹′ ] [ 𝐸 │ᵥ• 𝐹″ ] = [ {!!} ]
   ᵇ│ᵥˡ-preserves E 𝐹 [ E′ ᵇ│ᵥ 𝐹′ ] [ 𝐸 │ᵥ 𝐹″ ] = [ {!!} ]
   ᵇ│ᵥˡ-preserves E 𝐹 [ E′ ᵇ│ᵥ 𝐹′ ] [ 𝐸 │ᵥ 𝐹″ ]ˡ = [ {!!} ]
   ᵇ│ᵥˡ-preserves E 𝐹 [ P │ᵇᵇ 𝐹′ ] [ .E ᵇ│ᵥ 𝐹″ ]ˡ = [ {!!} ]
   ᵇ│ᵥˡ-preserves E 𝐹 [ P │ᵇᶜ 𝐹′ ] [ .E ᶜ│ᵥ 𝐹″ ]ˡ = [ {!!} ]
   ᵇ│ᵥˡ-preserves E 𝐹 [ E′ ᵇ│ᵇ F ]ˡ [ 𝐸 │ᵥᵇ F′ ]ˡ = [ {!!} ]
   ᵇ│ᵥˡ-preserves E 𝐹 [ E′ ᶜ│ᵇ F ]ˡ [ 𝐸 │ᵥᶜ F′ ]ˡ = [ {!!} ]
   ᵇ│ᵥˡ-preserves E 𝐹 [ P │ᵇᵇ 𝐹′ ]ˡ [ .E ᵇ│ᵥ 𝐹″ ]ˡ = [ {!!} ]
