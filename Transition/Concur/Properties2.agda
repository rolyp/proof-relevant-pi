module Transition.Concur.Properties2 where
   ...
   ... | pop-y*E/E′ | pop-y*E/E″ rewrite pop∘push y a = [ {-(pop y *ᵇᵇ⌣)-} {!!} │ᵥᵇ _ ]ˡ
   /-preserves-⌣ [ _│ᵥ•_ {y = y} 𝐸 𝐹 ]ˡ [ _│ᵥᶜ_ {a = a} 𝐸′ F ]ˡ [ 𝐸″ │•ᶜ F′ ]ˡ
      with (pop y *ᵇ) (E/E′ (⊖ 𝐸)) | (pop y *ᶜ) (E/E′ (⊖ 𝐸″))
   ... | pop-y*E/E′ | pop-y*E/E″ rewrite pop∘push y a = [ {-(pop y *ᶜᵇ⌣)-} {!!} │ᵥᶜ _ ]ˡ
   /-preserves-⌣ [ _│ᵥ•_ {y = y} 𝐸 𝐹 ]ˡ [ E ᵇ│ᵥ 𝐹′ ]ˡ [ E′ ᵇ│• 𝐹″ ]ˡ = [ {!!} ᵇ│ᵥ {!!}]ˡ
   /-preserves-⌣ [ 𝐸 │ᵥ• 𝐹 ]ˡ [ E ᶜ│ᵥ 𝐹′ ]ˡ [ E′ ᶜ│• 𝐹″ ]ˡ = [ _ ᶜ│ᵥ {!!} ]ˡ
