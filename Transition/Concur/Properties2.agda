module Transition.Concur.Properties2 where
   ...
   /-preserves-⌣ [ _│ᵥ•_ {y = y} 𝐸 𝐹 ] [ 𝐸′ │•ᵇ F ]ˡ [ 𝐸″ │ᵥᵇ F′ ]ˡ =
   ...
   /-preserves-⌣ [ _│ᵥ•_ {y = y} 𝐸 𝐹 ] [ E′ ᵇ│• 𝐹′ ]ˡ [ _ᵇ│ᵥ_ {a⌣a′ = ᵇ∇ᵇ} E 𝐹″ ]ˡ =
      let blah = /-preserves-⌣ 𝐹 (⌣-sym 𝐹′) (⌣-sym 𝐹″) in [ νᵇᶜ [ _ ᵇ│• ⌣-sym {!!} ] ]ˡ
   /-preserves-⌣ [ _│ᵥ•_ {y = y} 𝐸 𝐹 ] [ E′ ᵇ│• 𝐹′ ]ˡ [ _ᵇ│ᵥ_ {a⌣a′ = ᵛ∇ᵛ} E 𝐹″ ]ˡ =
   ...
   /-preserves-⌣ [ 𝐸 │ᵥ• 𝐹 ] [ 𝐸′ │ᵥ• 𝐹′ ]ˡ [ 𝐸″ │ᵥ 𝐹″ ]ˡ = [ {!!} ]ˡ
