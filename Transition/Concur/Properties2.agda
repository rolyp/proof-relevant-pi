...
-}
   ...
   │ᵥᵇˡ-preserves 𝐸 F [ 𝐸′ │•ᵇ F′ ] [ 𝐸″ │ᵥ• 𝐹 ] = [ νᵇᶜ [ /-preserves-⌣ᵁᴰᴰ 𝐸 𝐸′ 𝐸″ │•ᵇ {!!} ] ]
   │ᵥᵇˡ-preserves 𝐸 F [ 𝐸′ │ᵥᵇ F′ ] [ _│ᵥ_ {•x⌣•u = ᵇ∇ᵇ} 𝐸″ 𝐹 ] = [ νᵇᶜ [ /-preserves-⌣ᵁᴰᴰ 𝐸 𝐸′ 𝐸″ │ᵥᵇ {!!} ] ]
   │ᵥᵇˡ-preserves 𝐸 F [ 𝐸′ │ᵥᵇ F′ ] [ _│ᵥ_ {•x⌣•u = ᵛ∇ᵛ} 𝐸″ 𝐹 ] = [ νᵇᶜ [ /-preserves-⌣ᵁᴰᴰ 𝐸 𝐸′ 𝐸″ │•ᵇ {!!} ] ]
   │ᵥᵇˡ-preserves 𝐸 F [ E ᵇ│ᵇ F′ ] [ E′ ᵇ│ᵥ 𝐹 ]ˡ = [ {!!} ]
   │ᵥᵇˡ-preserves 𝐸 F [ E ᵇ│ᶜ F′ ] [ E′ ᶜ│ᵥ 𝐹 ]ˡ = [ νᵇᶜ [ {!!} ᵇ│ᶜ {!!} ] ]
   │ᵥᵇˡ-preserves 𝐸 F [ 𝐸′ │ᵥᵇ F′ ] [ 𝐸″ │ᵥ 𝐹 ]ˡ = [ {!!} ]
   │ᵥᵇˡ-preserves 𝐸 F [ 𝐸′ ᵇᵇ│ Q ] [ 𝐸″ │ᵥᵇ .F ]ˡ = [ {!!} ]
   │ᵥᵇˡ-preserves 𝐸 F [ 𝐸′ ᵇᶜ│ Q ] [ 𝐸″ │ᵥᶜ .F ]ˡ = [ νᵇᶜ [ {!!} ᵇᶜ│ {!!} ] ]
