...
module Transition.Concur.Properties2 where
   ...
   │ᵥ•ˡ-preserves 𝐸 𝐹 [ E ᶜ│ᵥ 𝐹′ ]ˡ [ E′ ᶜ│• 𝐹″ ]ˡ = [ _ ᶜ│ᵥ ⌣-sym (/-preserves-⌣₄ 𝐹 𝐹′ 𝐹″) ]ˡ
   ...
   │ᵥᵇ-preserves : ∀ {Γ} {P : Proc Γ} {a x R R′}
                  {E : P —[ a ᵇ - _ ]→ R} {E′ : P —[ (x •) ᵇ - _ ]→ R′} (𝐸 : E ⌣[ ᵇ∇ᵇ ] E′) →
                  ∀ {Q S} (F : Q —[ (• x) ᵇ - _ ]→ S) {a″ R″} {a′⌣a″ : τ ᶜ ᴬ⌣ a″} {a⌣a″ : a ᵇ ᴬ⌣ a″}
                  {E″ : P │ Q —[ a″ - _ ]→ R″} (𝐸′ : E′ │ᵥ F ⌣[ a′⌣a″ ] E″) (𝐸″ : E ᵇ│ Q ⌣[ a⌣a″ ] E″) →
                  E′/E (⊖ 𝐸) │ᵥ (push *ᵇ) F ⌣[ /-preserves-ᴬ⌣ ᵇ∇ᶜ a′⌣a″ a⌣a″ ] E′/E (⊖ 𝐸″)
   │ᵥᵇ-preserves 𝐸 F 𝐸′ 𝐸″ = {!!}
