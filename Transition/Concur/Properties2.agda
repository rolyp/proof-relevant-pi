module Transition.Concur.Properties2 where
   ...
   /-preserves-⌣ [ 𝐸 │ᵥ• 𝐹 ] (⌣-sym (𝐸′ │• 𝐹′)) [ 𝐸″ │ᵥ• 𝐹″ ] = [ νᶜᶜ [ {!!} │• {!!} ] ]
   /-preserves-⌣ [ 𝐸 │ᵥ• 𝐹 ] (⌣-sym (_│ᵥ•_ {y = y} 𝐸′ 𝐹′)) [ _│ᵥ_ {•x⌣•u = ᵇ∇ᵇ} 𝐸″ 𝐹″ ] = [ νᶜᶜ (⌣-sym (/-preserves-⌣ 𝐸″ 𝐸′ 𝐸 │ᵥ• /-preserves-⌣ 𝐹″ 𝐹′ 𝐹)) ]
   /-preserves-⌣ [ 𝐸 │ᵥ• 𝐹 ] (⌣-sym (_│ᵥ•_ {y = y} 𝐸′ 𝐹′)) [ _│ᵥ_ {•x⌣•u = ᵛ∇ᵛ} 𝐸″ 𝐹″ ] with (pop y *ᵇ) (E/E′ (⊖ 𝐸))
   ... | pop-y*E/E′ = [ νᶜᶜ (⌣-sym ({!!} │• {!!})) ]
   /-preserves-⌣ [ 𝐸 │ᵥ• 𝐹 ] (⌣-sym (𝐸′ │•ᵇ F)) (⌣-sym (𝐸″ │ᵥᵇ F′)) = {!!}
   /-preserves-⌣ [ 𝐸 │ᵥ• 𝐹 ] (⌣-sym (𝐸′ │•ᶜ F)) (⌣-sym (𝐸″ │ᵥᶜ F′)) = [ νᶜᶜ (⌣-sym ({!!} │•ᶜ {!!})) ]
   /-preserves-⌣ [ 𝐸 │ᵥ• 𝐹 ] (⌣-sym (E′ ᵇ│• 𝐹′)) (⌣-sym (E ᵇ│ᵥ 𝐹″)) = {!!}
   /-preserves-⌣ [ 𝐸 │ᵥ• 𝐹 ] (⌣-sym (E′ ᶜ│• 𝐹′)) (⌣-sym (E ᶜ│ᵥ 𝐹″)) = [ νᶜᶜ (⌣-sym ({!!} ᶜ│• {!!})) ]
   /-preserves-⌣ [ 𝐸 │ᵥ• 𝐹 ] (⌣-sym (𝐸′ │ᵥ• 𝐹′)) (⌣-sym (𝐸″ │ᵥ 𝐹″)) = [ {!!} ]
   /-preserves-⌣ (⌣-sym (𝐸 │ᵥ• 𝐹)) [ 𝐸′ │ᵥ• 𝐹′ ] [ 𝐸″ │• 𝐹″ ] = [ {!!} ]
   /-preserves-⌣ (⌣-sym (𝐸 │ᵥ• 𝐹)) [ 𝐸′ │ᵥ• 𝐹′ ] (⌣-sym (𝐸″ │• 𝐹″)) = [ {!!} ]
   /-preserves-⌣ (⌣-sym (𝐸 │ᵥ• 𝐹)) [ 𝐸′ │ᵥ 𝐹′ ] (⌣-sym (𝐸″ │ᵥ• 𝐹″)) = [ {!!} ]
   /-preserves-⌣ (⌣-sym (𝐸 │ᵥ• 𝐹)) (⌣-sym (𝐸′ │ᵥᵇ F)) (⌣-sym (𝐸″ │•ᵇ F′)) = [ {!!} ]
   /-preserves-⌣ (⌣-sym (𝐸 │ᵥ• 𝐹)) (⌣-sym (𝐸′ │ᵥᶜ F)) (⌣-sym (𝐸″ │•ᶜ F′)) = [ {!!} ]
   /-preserves-⌣ (⌣-sym (𝐸 │ᵥ• 𝐹)) (⌣-sym (E ᵇ│ᵥ 𝐹′)) (⌣-sym (E′ ᵇ│• 𝐹″)) = [ {!!} ]
   /-preserves-⌣ (⌣-sym (𝐸 │ᵥ• 𝐹)) (⌣-sym (E ᶜ│ᵥ 𝐹′)) (⌣-sym (E′ ᶜ│• 𝐹″)) = [ {!!} ]
   /-preserves-⌣ (⌣-sym (𝐸 │ᵥ• 𝐹)) (⌣-sym (𝐸′ │ᵥ 𝐹′)) (⌣-sym (𝐸″ │ᵥ• 𝐹″)) = [ {!!} ]
{-
