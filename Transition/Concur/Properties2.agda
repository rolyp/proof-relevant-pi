...
module Transition.Concur.Properties2 where
   ...
   quibble ([_] {a⌣a′ = ᵛ∇ᵛ} _) _ ([_] {a⌣a′ = ᵛ∇ᵛ} _) = ≅-refl
   quibble ([_] {a⌣a′ = ᵛ∇ᵛ} _) _ ([_] {a⌣a′ = ᵇ∇ᵇ} _) = ≅-refl
   quibble ([_] {a⌣a′ = ᵛ∇ᵛ} _) _ ([_] {a⌣a′ = ᶜ∇ᵇ} _) = ≅-refl
   quibble ([_] {a⌣a′ = ᵇ∇ᵇ} _) _ ([_] {a⌣a′ = ᵛ∇ᵛ} _) = ≅-refl
   quibble ([_] {a⌣a′ = ᵇ∇ᵇ} _) _ ([_] {a⌣a′ = ᵇ∇ᵇ} _) = ≅-refl
   quibble ([_] {a⌣a′ = ᵇ∇ᵇ} _) _ ([_] {a⌣a′ = ᶜ∇ᵇ} _) = ≅-refl
   quibble ([_] {a⌣a′ = ᵇ∇ᶜ} _) _ ([_] {a⌣a′ = ᵇ∇ᶜ} _) = ≅-refl
   quibble ([_] {a⌣a′ = ᵇ∇ᶜ} _) _ ([_] {a⌣a′ = ᶜ∇ᶜ} _) = ≅-refl
   quibble ([_] {a⌣a′ = ᶜ∇ᵇ} _) _ ([_] {a⌣a′ = ᵛ∇ᵛ} _) = ≅-refl
   quibble ([_] {a⌣a′ = ᶜ∇ᵇ} _) _ ([_] {a⌣a′ = ᵇ∇ᵇ} _) = ≅-refl
   quibble ([_] {a⌣a′ = ᶜ∇ᵇ} _) _ ([_] {a⌣a′ = ᶜ∇ᵇ} _) = ≅-refl
   quibble ([_] {a⌣a′ = ᶜ∇ᶜ} _) _ ([_] {a⌣a′ = ᵇ∇ᶜ} _) = ≅-refl
   quibble ([_] {a⌣a′ = ᶜ∇ᶜ} _) _ ([_] {a⌣a′ = ᶜ∇ᶜ} _) = ≅-refl
   quibble ([_] {a⌣a′ = ᵛ∇ᵛ} _) _ ([_]ˡ {a⌣a′ = ᵛ∇ᵛ} _) = ≅-refl
   quibble ([_] {a⌣a′ = ᵛ∇ᵛ} _) _ ([_]ˡ {a⌣a′ = ᵇ∇ᵇ} _) = ≅-refl
   quibble ([_] {a⌣a′ = ᵛ∇ᵛ} _) _ ([_]ˡ {a⌣a′ = ᵇ∇ᶜ} _) = ≅-refl
   quibble ([_] {a⌣a′ = ᵇ∇ᵇ} _) _ ([_]ˡ {a⌣a′ = ᵛ∇ᵛ} _) = ≅-refl
   quibble ([_] {a⌣a′ = ᵇ∇ᵇ} _) _ ([_]ˡ {a⌣a′ = ᵇ∇ᵇ} _) = ≅-refl
   quibble ([_] {a⌣a′ = ᵇ∇ᵇ} _) _ ([_]ˡ {a⌣a′ = ᵇ∇ᶜ} _) = ≅-refl
   quibble ([_] {a⌣a′ = ᵇ∇ᶜ} _) _ ([_]ˡ {a⌣a′ = ᶜ∇ᵇ} _) = ≅-refl
   quibble ([_] {a⌣a′ = ᵇ∇ᶜ} _) _ ([_]ˡ {a⌣a′ = ᶜ∇ᶜ} _) = ≅-refl
   quibble ([_] {a⌣a′ = ᶜ∇ᵇ} _) _ ([_]ˡ {a⌣a′ = ᵛ∇ᵛ} _) = ≅-refl
   quibble ([_] {a⌣a′ = ᶜ∇ᵇ} _) _ ([_]ˡ {a⌣a′ = ᵇ∇ᵇ} _) = ≅-refl
   quibble ([_] {a⌣a′ = ᶜ∇ᵇ} _) _ ([_]ˡ {a⌣a′ = ᵇ∇ᶜ} _) = ≅-refl
   quibble ([_] {a⌣a′ = ᶜ∇ᶜ} _) _ ([_]ˡ {a⌣a′ = ᶜ∇ᵇ} _) = ≅-refl
   quibble ([_] {a⌣a′ = ᶜ∇ᶜ} _) _ ([_]ˡ {a⌣a′ = ᶜ∇ᶜ} _) = ≅-refl
   quibble ([_]ˡ {a⌣a′ = ᵛ∇ᵛ} _) _ ([_] {a⌣a′ = ᵛ∇ᵛ} _) = ≅-refl
   quibble ([_]ˡ {a⌣a′ = ᵛ∇ᵛ} _) _ ([_] {a⌣a′ = ᵇ∇ᵇ} _) = ≅-refl
   quibble ([_]ˡ {a⌣a′ = ᵛ∇ᵛ} _) _ ([_] {a⌣a′ = ᶜ∇ᵇ} _) = ≅-refl
   quibble ([_]ˡ {a⌣a′ = ᵇ∇ᵇ} _) _ ([_] {a⌣a′ = ᵛ∇ᵛ} _) = ≅-refl
   quibble ([_]ˡ {a⌣a′ = ᵇ∇ᵇ} _) _ ([_] {a⌣a′ = ᵇ∇ᵇ} _) = ≅-refl
   quibble ([_]ˡ {a⌣a′ = ᵇ∇ᵇ} _) _ ([_] {a⌣a′ = ᶜ∇ᵇ} _) = ≅-refl
   quibble ([_]ˡ {a⌣a′ = ᵇ∇ᶜ} _) _ ([_] {a⌣a′ = ᵛ∇ᵛ} _) = ≅-refl
   quibble ([_]ˡ {a⌣a′ = ᵇ∇ᶜ} _) _ ([_] {a⌣a′ = ᵇ∇ᵇ} _) = ≅-refl
   quibble ([_]ˡ {a⌣a′ = ᵇ∇ᶜ} _) _ ([_] {a⌣a′ = ᶜ∇ᵇ} _) = ≅-refl
   quibble ([_]ˡ {a⌣a′ = ᶜ∇ᵇ} _) _ ([_] {a⌣a′ = ᵇ∇ᶜ} _) = ≅-refl
   quibble ([_]ˡ {a⌣a′ = ᶜ∇ᵇ} _) _ ([_] {a⌣a′ = ᶜ∇ᶜ} _) = ≅-refl
   quibble ([_]ˡ {a⌣a′ = ᶜ∇ᶜ} _) _ ([_] {a⌣a′ = ᵇ∇ᶜ} _) = ≅-refl
   quibble ([_]ˡ {a⌣a′ = ᶜ∇ᶜ} _) _ ([_] {a⌣a′ = ᶜ∇ᶜ} _) = ≅-refl
   quibble ([_]ˡ {a⌣a′ = ᵛ∇ᵛ} _) _ ([_]ˡ {a⌣a′ = ᵛ∇ᵛ} _) = ≅-refl
   quibble ([_]ˡ {a⌣a′ = ᵛ∇ᵛ} _) _ ([_]ˡ {a⌣a′ = ᵇ∇ᵇ} _) = ≅-refl
   quibble ([_]ˡ {a⌣a′ = ᵛ∇ᵛ} _) _ ([_]ˡ {a⌣a′ = ᵇ∇ᶜ} _) = ≅-refl
   quibble ([_]ˡ {a⌣a′ = ᵇ∇ᵇ} _) _ ([_]ˡ {a⌣a′ = ᵛ∇ᵛ} _) = ≅-refl
   quibble ([_]ˡ {a⌣a′ = ᵇ∇ᵇ} _) _ ([_]ˡ {a⌣a′ = ᵇ∇ᵇ} _) = ≅-refl
   quibble ([_]ˡ {a⌣a′ = ᵇ∇ᵇ} _) _ ([_]ˡ {a⌣a′ = ᵇ∇ᶜ} _) = ≅-refl
   quibble ([_]ˡ {a⌣a′ = ᵇ∇ᶜ} _) _ ([_]ˡ {a⌣a′ = ᵛ∇ᵛ} _) = ≅-refl
   quibble ([_]ˡ {a⌣a′ = ᵇ∇ᶜ} _) _ ([_]ˡ {a⌣a′ = ᵇ∇ᵇ} _) = ≅-refl
   quibble ([_]ˡ {a⌣a′ = ᵇ∇ᶜ} _) _ ([_]ˡ {a⌣a′ = ᵇ∇ᶜ} _) = ≅-refl
   quibble ([_]ˡ {a⌣a′ = ᶜ∇ᵇ} _) _ ([_]ˡ {a⌣a′ = ᶜ∇ᵇ} _) = ≅-refl
   quibble ([_]ˡ {a⌣a′ = ᶜ∇ᵇ} _) _ ([_]ˡ {a⌣a′ = ᶜ∇ᶜ} _) = ≅-refl
   quibble ([_]ˡ {a⌣a′ = ᶜ∇ᶜ} _) _ ([_]ˡ {a⌣a′ = ᶜ∇ᵇ} _) = ≅-refl
   quibble ([_]ˡ {a⌣a′ = ᶜ∇ᶜ} _) _ ([_]ˡ {a⌣a′ = ᶜ∇ᶜ} _) = ≅-refl
