module Transition.Concur.Properties2 where
   ...
   /-preserves-⌣ [ 𝐸 │ᵥ• 𝐹 ] (⌣-sym (𝐸′ │• 𝐹′)) [ 𝐸″ │ᵥ• 𝐹″ ] =
      [ νᶜᶜ [ /-preserves-⌣ 𝐸 {!!} {!!} │• /-preserves-⌣ 𝐹 {!!} {!!} ] ]
   /-preserves-⌣ [ 𝐸 │ᵥ• 𝐹 ] (⌣-sym (𝐸′ │ᵥ• 𝐹′)) [ _│ᵥ_ {•x⌣•u = ᵇ∇ᵇ} 𝐸″ 𝐹″ ] =
      [ νᶜᶜ (⌣-sym (/-preserves-⌣ 𝐸″ 𝐸′ 𝐸 │ᵥ• /-preserves-⌣ 𝐹″ 𝐹′ 𝐹)) ]
   /-preserves-⌣ [ 𝐸 │ᵥ• 𝐹 ] (⌣-sym (𝐸′ │ᵥ• 𝐹′)) [ _│ᵥ_ {•x⌣•u = ᵛ∇ᵛ} 𝐸″ 𝐹″ ] =
      [ νᶜᶜ (⌣-sym (/-preserves-⌣ 𝐸″ 𝐸′ 𝐸 │• /-preserves-⌣ 𝐹″ 𝐹′ 𝐹)) ]
