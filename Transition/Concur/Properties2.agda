...
-}
   /-preserves-⌣ [ 𝐸 │ᵥᵇ F ]ˡ [ x₁ │•ᵇ F₁ ] [ x₂ │ᵥ• x₃ ] = {!!}
   /-preserves-⌣ [ 𝐸 │ᵥᵇ F ]ˡ [ x₁ │ᵥᵇ F₁ ] [ x₂ │ᵥ x₃ ] = {!!}
   /-preserves-⌣ [ 𝐸 │ᵥᵇ F ]ˡ [ E ᵇ│ᵇ F₁ ] [ E′ ᵇ│ᵥ x₁ ]ˡ = {!!}
   /-preserves-⌣ [ 𝐸 │ᵥᵇ F ]ˡ [ E ᵇ│ᶜ F₁ ] [ E′ ᶜ│ᵥ x₁ ]ˡ = {!!}
   /-preserves-⌣ [ 𝐸 │ᵥᵇ F ]ˡ [ x₂ │ᵥᵇ F₁ ] [ x₃ │ᵥ x₄ ]ˡ = {!!}
   /-preserves-⌣ [ 𝐸 │ᵥᵇ F ]ˡ [ x₁ ᵇᵇ│ Q ] [ x₂ │ᵥᵇ .F ]ˡ = {!!}
   /-preserves-⌣ [ 𝐸 │ᵥᵇ F ]ˡ [ x₁ ᵇᶜ│ Q ] [ x₂ │ᵥᶜ .F ]ˡ = {!!}
   /-preserves-⌣ [ 𝐸 │ᵥᵇ F ]ˡ [ x₁ ᵇᵇ│ Q ]ˡ [ x₂ │ᵥᵇ .F ]ˡ = {!!}
{-
