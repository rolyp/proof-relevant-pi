...
{-
   ...
   /-preserves-⌣ [ _│ᵥ•_ {y = y} 𝐸 𝐹 ]ˡ [ _│ᵥ_ {•x⌣•u = ᵛ∇ᵛ} 𝐸′ 𝐹′ ]ˡ [ 𝐸″ │ᵥ• 𝐹″ ]ˡ =
      [ (pop y *ᵇᵇ⌣) (/-preserves-⌣₄ 𝐸′ 𝐸 𝐸″) │ᵥ /-preserves-⌣₄ 𝐹′ 𝐹 𝐹″ ]
-}
   /-preserves-⌣ [ 𝐸 │ᵥᵇ 𝐹 ] [ x₂ │ᵥ• x₃ ] [ x₄ │•ᵇ F′ ] = {!!}
   /-preserves-⌣ [ 𝐸 │ᵥᵇ 𝐹 ] [ x₂ │ᵥ x₃ ] [ x₄ │ᵥᵇ F′ ] = {!!}
   /-preserves-⌣ [ 𝐸 │ᵥᵇ 𝐹 ] [ x₁ │ᵥᵇ .𝐹 ]ˡ [ x₂ ᵇᵇ│ Q ] = {!!}
   /-preserves-⌣ [ 𝐸 │ᵥᵇ 𝐹 ] [ x₁ │ᵥᶜ .𝐹 ]ˡ [ x₂ ᵇᶜ│ Q ] = {!!}
   /-preserves-⌣ [ 𝐸 │ᵥᵇ 𝐹 ] [ E′ ᵇ│ᵥ x₁ ]ˡ [ E ᵇ│ᵇ F ] = {!!}
   /-preserves-⌣ [ 𝐸 │ᵥᵇ 𝐹 ] [ E′ ᶜ│ᵥ x₁ ]ˡ [ E ᵇ│ᶜ F ] = {!!}
   /-preserves-⌣ [ 𝐸 │ᵥᵇ 𝐹 ] [ x₁ │ᵥ x₂ ]ˡ [ x₃ │ᵥᵇ F ] = {!!}
   /-preserves-⌣ [ 𝐸 │ᵥᵇ 𝐹 ] [ x₁ │ᵥᵇ .𝐹 ]ˡ [ x₂ ᵇᵇ│ Q ]ˡ = {!!}
{-
