...
-}
   ...
   ᵇ│ᵥ-preserves {a⌣a′ = ᵇ∇ᵇ} E 𝐹 [ 𝐸 │ᵥ• 𝐹′ ] [ E′ ᵇ│• 𝐹″ ] = [ {!!} │ᵥ• {!!} ]
   ᵇ│ᵥ-preserves {a⌣a′ = ᵛ∇ᵛ} E 𝐹 [ 𝐸 │ᵥ• 𝐹′ ] [ E′ ᵇ│• 𝐹″ ] = [ {!!} │• {!!} ]
   ᵇ│ᵥ-preserves {a⌣a′ = ᵇ∇ᵇ} E 𝐹 [ 𝐸 │ᵥ 𝐹′ ] [ _ᵇ│ᵥ_ {a⌣a′ = ᵇ∇ᵇ} E′ 𝐹″ ] = [ {!!} │ᵥ {!!} ]ˡ
   ᵇ│ᵥ-preserves {a⌣a′ = ᵇ∇ᵇ} E 𝐹 [ 𝐸 │ᵥ 𝐹′ ] [ _ᵇ│ᵥ_ {a⌣a′ = ᵛ∇ᵛ} E′ 𝐹″ ] = [ {!!} │ᵥ• {!!} ]
   ᵇ│ᵥ-preserves {a⌣a′ = ᵛ∇ᵛ} E 𝐹 [ 𝐸 │ᵥ 𝐹′ ] [ _ᵇ│ᵥ_ {a⌣a′ = ᵇ∇ᵇ} E′ 𝐹″ ] = [ {!!} │ᵥ• {!!} ]ˡ
   ᵇ│ᵥ-preserves {a⌣a′ = ᵛ∇ᵛ} E 𝐹 [ 𝐸 │ᵥ 𝐹′ ] [ _ᵇ│ᵥ_ {a⌣a′ = ᵛ∇ᵛ} E′ 𝐹″ ] = [ {!!} │• {!!} ]
   ᵇ│ᵥ-preserves {a⌣a′ = ᵇ∇ᵇ} E 𝐹 [ .E ᵇ│ᵥ 𝐹′ ]ˡ [ _│ᵇᵇ_ {a⌣a′ = ᵇ∇ᵇ} P 𝐹″ ] = [ {!!} ᵇ│ᵥ {!!} ]ˡ
   ᵇ│ᵥ-preserves {a⌣a′ = ᵇ∇ᵇ} E 𝐹 [ .E ᵇ│ᵥ 𝐹′ ]ˡ [ _│ᵇᵇ_ {a⌣a′ = ᵛ∇ᵛ} P 𝐹″ ] = [ {!!} ᶜ│ᵥ {!!} ]ˡ
   ᵇ│ᵥ-preserves {a⌣a′ = ᵛ∇ᵛ} E 𝐹 [ .E ᵇ│ᵥ 𝐹′ ]ˡ [ _│ᵇᵇ_ {a⌣a′ = ᵇ∇ᵇ} P 𝐹″ ] = [ {!!} ᵇ│• {!!} ]ˡ
   ᵇ│ᵥ-preserves {a⌣a′ = ᵛ∇ᵛ} E 𝐹 [ .E ᵇ│ᵥ 𝐹′ ]ˡ [ _│ᵇᵇ_ {a⌣a′ = ᵛ∇ᵛ} P 𝐹″ ] = [ {!!} ᶜ│• {!!} ]ˡ
   ᵇ│ᵥ-preserves {a⌣a′ = ᵇ∇ᵇ} E 𝐹 [ .E ᶜ│ᵥ 𝐹′ ]ˡ [ P │ᵇᶜ 𝐹″ ] = [ {!!} ᶜ│ᵥ {!!} ]ˡ
   ᵇ│ᵥ-preserves {a⌣a′ = ᵛ∇ᵛ} E 𝐹 [ .E ᶜ│ᵥ 𝐹′ ]ˡ [ P │ᵇᶜ 𝐹″ ] = [ {!!} ᶜ│• {!!} ]ˡ
   ᵇ│ᵥ-preserves {a⌣a′ = ᵇ∇ᵇ} E 𝐹 [ 𝐸 │ᵥ 𝐹′ ]ˡ [ _ᵇ│ᵥ_ {a⌣a′ = ᵇ∇ᵇ} E′ 𝐹″ ] = [ {!!} │ᵥ {!!} ]
   ᵇ│ᵥ-preserves {a⌣a′ = ᵇ∇ᵇ} E 𝐹 [ 𝐸 │ᵥ 𝐹′ ]ˡ [ _ᵇ│ᵥ_ {a⌣a′ = ᵛ∇ᵛ} E′ 𝐹″ ] = [ {!!} │ᵥ• {!!} ]
   ᵇ│ᵥ-preserves {a⌣a′ = ᵛ∇ᵛ} E 𝐹 [ 𝐸 │ᵥ 𝐹′ ]ˡ [ _ᵇ│ᵥ_ {a⌣a′ = ᵇ∇ᵇ} E′ 𝐹″ ] = [ {!!} │ᵥ• {!!} ]ˡ
   ᵇ│ᵥ-preserves {a⌣a′ = ᵛ∇ᵛ} E 𝐹 [ 𝐸 │ᵥ 𝐹′ ]ˡ [ _ᵇ│ᵥ_ {a⌣a′ = ᵛ∇ᵛ} E′ 𝐹″ ] = [ {!!} │• {!!} ]
   ᵇ│ᵥ-preserves {a⌣a′ = ᵇ∇ᵇ} E 𝐹 [ 𝐸 │ᵥᵇ F′ ]ˡ [ E′ ᵇ│ᵇ F ]ˡ = [ {!!} │ᵥᵇ {!!} ]ˡ
   ᵇ│ᵥ-preserves {a⌣a′ = ᵛ∇ᵛ} E 𝐹 [ 𝐸 │ᵥᵇ F′ ]ˡ [ E′ ᵇ│ᵇ F ]ˡ = [ {!!} │•ᵇ {!!} ]ˡ
   ᵇ│ᵥ-preserves {a⌣a′ = ᵇ∇ᵇ} E 𝐹 [ 𝐸 │ᵥᶜ F′ ]ˡ [ E′ ᶜ│ᵇ F ]ˡ = [ {!!} │ᵥᶜ {!!} ]ˡ
   ᵇ│ᵥ-preserves {a⌣a′ = ᵛ∇ᵛ} E 𝐹 [ 𝐸 │ᵥᶜ F′ ]ˡ [ E′ ᶜ│ᵇ F ]ˡ = [ {!!} │•ᶜ {!!} ]ˡ
   ᵇ│ᵥ-preserves {a⌣a′ = ᵇ∇ᵇ} E 𝐹 [ .E ᵇ│ᵥ 𝐹′ ]ˡ [ _│ᵇᵇ_ {a⌣a′ = ᵇ∇ᵇ} P 𝐹″ ]ˡ = [ {!!} ᵇ│ᵥ {!!} ]ˡ
   ᵇ│ᵥ-preserves {a⌣a′ = ᵇ∇ᵇ} E 𝐹 [ .E ᵇ│ᵥ 𝐹′ ]ˡ [ _│ᵇᵇ_ {a⌣a′ = ᵛ∇ᵛ} P 𝐹″ ]ˡ = [ {!!} ᶜ│ᵥ {!!} ]ˡ
   ᵇ│ᵥ-preserves {a⌣a′ = ᵛ∇ᵛ} E 𝐹 [ .E ᵇ│ᵥ 𝐹′ ]ˡ [ _│ᵇᵇ_ {a⌣a′ = ᵇ∇ᵇ} P 𝐹″ ]ˡ = [ {!!} ᵇ│• {!!} ]ˡ
   ᵇ│ᵥ-preserves {a⌣a′ = ᵛ∇ᵛ} E 𝐹 [ .E ᵇ│ᵥ 𝐹′ ]ˡ [ _│ᵇᵇ_ {a⌣a′ = ᵛ∇ᵛ} P 𝐹″ ]ˡ = [ {!!} ᶜ│• {!!} ]ˡ
