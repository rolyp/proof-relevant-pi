module Transition.Concur.Properties2 where
   ...
   /-preserves-⌣ [ _│ᵥ•_ {y = y} 𝐸 𝐹 ] [ 𝐸′ │•ᵇ F ]ˡ [ 𝐸″ │ᵥᵇ F′ ]ˡ with (pop y *ᵇ) (E/E′ (⊖ 𝐸))
   ... | pop-y*E/E′ = let blah = /-preserves-⌣ 𝐸 (⌣-sym 𝐸′) (⌣-sym 𝐸″) in [ νᵇᶜ [ ⌣-sym {!!} │•ᵇ _ ] ]ˡ
   /-preserves-⌣ [ 𝐸 │ᵥ• 𝐹 ] [ 𝐸′ │•ᶜ F ]ˡ [ 𝐸″ │ᵥᶜ F′ ]ˡ =
      let blah = /-preserves-⌣ 𝐸 (⌣-sym 𝐸′) (⌣-sym 𝐸″) in [ νᶜᶜ [ ⌣-sym {!!} │•ᶜ _ ]ˡ ]
   /-preserves-⌣ [ _│ᵥ•_ {y = y} 𝐸 𝐹 ] [ E′ ᵇ│• 𝐹′ ]ˡ [ _ᵇ│ᵥ_ {a⌣a′ = ᵇ∇ᵇ} E 𝐹″ ]ˡ with (pop y *ᵇ) (E/E′ (⊖ 𝐸))
   ... | pop-y*E/E′ = let blah = /-preserves-⌣ 𝐹 (⌣-sym 𝐹′) (⌣-sym 𝐹″) in [ νᵇᶜ [ _ ᵇ│• ⌣-sym {!!} ] ]ˡ
   /-preserves-⌣ [ _│ᵥ•_ {y = y} 𝐸 𝐹 ] [ E′ ᵇ│• 𝐹′ ]ˡ [ _ᵇ│ᵥ_ {a⌣a′ = ᵛ∇ᵛ} E 𝐹″ ]ˡ with (pop y *ᵇ) (E/E′ (⊖ 𝐸))
   ... | pop-y*E/E′ = let blah = /-preserves-⌣ 𝐹 (⌣-sym 𝐹′) (⌣-sym 𝐹″) in [ ν•ᶜ [ _ ᶜ│• ⌣-sym {!!} ] ]ˡ
   /-preserves-⌣ [ 𝐸 │ᵥ• 𝐹 ] [ E′ ᶜ│• 𝐹′ ]ˡ [ E ᶜ│ᵥ 𝐹″ ]ˡ =
      let blah = /-preserves-⌣ 𝐹 (⌣-sym 𝐹′) (⌣-sym 𝐹″) in [ νᶜᶜ [ _ ᶜ│• ⌣-sym {!!} ]ˡ ]
   /-preserves-⌣ [ 𝐸 │ᵥ• 𝐹 ] [ 𝐸′ │ᵥ• 𝐹′ ]ˡ [ 𝐸″ │ᵥ 𝐹″ ]ˡ = [ {!!} ]
   /-preserves-⌣ [ 𝐸 │ᵥ• 𝐹 ]ˡ [ 𝐸′ │ᵥ• 𝐹′ ] [ 𝐸″ │• 𝐹″ ] = [ {!!} ]
   /-preserves-⌣ [ 𝐸 │ᵥ• 𝐹 ]ˡ [ 𝐸′ │ᵥ• 𝐹′ ] [ 𝐸″ │• 𝐹″ ]ˡ = [ {!!} ]
   /-preserves-⌣ [ 𝐸 │ᵥ• 𝐹 ]ˡ [ 𝐸′ │ᵥ 𝐹′ ] [ 𝐸″ │ᵥ• 𝐹″ ]ˡ = [ {!!} ]
   /-preserves-⌣ [ 𝐸 │ᵥ• 𝐹 ]ˡ [ 𝐸′ │ᵥᵇ F ]ˡ [ 𝐸″ │•ᵇ F′ ]ˡ = [ {!!} ]
   /-preserves-⌣ [ 𝐸 │ᵥ• 𝐹 ]ˡ [ 𝐸′ │ᵥᶜ F ]ˡ [ 𝐸″ │•ᶜ F′ ]ˡ = [ {!!} ]
   /-preserves-⌣ [ 𝐸 │ᵥ• 𝐹 ]ˡ [ E ᵇ│ᵥ 𝐹′ ]ˡ [ E′ ᵇ│• 𝐹″ ]ˡ = [ {!!} ]
   /-preserves-⌣ [ 𝐸 │ᵥ• 𝐹 ]ˡ [ E ᶜ│ᵥ 𝐹′ ]ˡ [ E′ ᶜ│• 𝐹″ ]ˡ = [ {!!} ]
   /-preserves-⌣ [ 𝐸 │ᵥ• 𝐹 ]ˡ [ 𝐸′ │ᵥ 𝐹′ ]ˡ [ 𝐸″ │ᵥ• 𝐹″ ]ˡ = [ {!!} ]
{-
