...
-}
   ...
   │ᵥᵇˡ-preserves 𝐸 F [ E ᵇ│ᵇ F′ ] [ _ᵇ│ᵥ_ {a⌣a′ = ᵛ∇ᵛ} E′ 𝐹 ]ˡ = [ {!!} ]
   │ᵥᵇˡ-preserves 𝐸 F [ E ᵇ│ᶜ F′ ] [ E′ ᶜ│ᵥ 𝐹 ]ˡ = [ νᵇᶜ [ E/E′ (⊖ 𝐸) ᵇ│ᶜ E/E′ (⊖ 𝐹) ] ]
   │ᵥᵇˡ-preserves 𝐸 F [ 𝐸′ │ᵥᵇ F′ ] [ _│ᵥ_ {•x⌣•u = ᵇ∇ᵇ} 𝐸″ 𝐹 ]ˡ = [ νᵇᶜ [ /-preserves-⌣₃ 𝐸 𝐸′ 𝐸″ │ᵥᵇ E/E′ (⊖ 𝐹) ] ]
   │ᵥᵇˡ-preserves 𝐸 F [ 𝐸′ │ᵥᵇ F′ ] [ _│ᵥ_ {•x⌣•u = ᵛ∇ᵛ} 𝐸″ 𝐹 ]ˡ = [ νᵇᶜ [ /-preserves-⌣₃ 𝐸 𝐸′ 𝐸″ │•ᵇ E/E′ (⊖ 𝐹) ] ]
