module Transition.Concur.Properties2 where
   ...
   ... | pop-y*E/E′ | pop-y*E/E″ | pop-y*E/E″⌣E/E′ rewrite pop∘push y a = [ pop-y*E/E″⌣E/E′ │ᵥᵇ _ ]ˡ
   ...
   /-preserves-⌣ [ _│ᵥ•_ {y = y} 𝐸 𝐹 ]ˡ [ E ᵇ│ᵥ 𝐹′ ]ˡ [ E′ ᵇ│• 𝐹″ ]ˡ =
      [ {-(pop y *ᵇ)-} {!!} ᵇ│ᵥ ⌣-sym (/-preserves-⌣₄ 𝐹′ 𝐹 𝐹″) ]ˡ
