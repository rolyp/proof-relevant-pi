...
-}
   ...
   ᵇ│ᵥ-preserves : ∀ {Γ} {P Q : Proc Γ} {x a a″ R R″ S S′} {a⌣a′} {a′⌣a″} {a⌣a″} (E : P —[ (x •) ᵇ - ∞ ]→ R) →
                  {F : Q —[ a ᵇ - _ ]→ S} {F′ : Q —[ (• x) ᵇ - _ ]→ S′}
                  (𝐹 : Concur F F′ a⌣a′) {E″ : P │ Q —[ a″ - _ ]→ R″} → Concur (E │ᵥ F′) E″ a′⌣a″ → (𝐸″ : Concur (P │ᵇ F) E″ a⌣a″) → Concur (E′/E (⊖₁ (E ᵇ│ᵥ 𝐹))) (E′/E (⊖ 𝐸″)) (/-preserves-ᴬ⌣ ᵇ∇ᶜ a′⌣a″ a⌣a″)
   ᵇ│ᵥ-preserves = ?

   /-preserves-⌣ [ E ᵇ│ᵥ 𝐹 ] 𝐸′ 𝐸″ = {!!}
   /-preserves-⌣ [ E ᵇ│ᵥ 𝐹 ]ˡ 𝐸′ 𝐸″ = {!!}
{-
