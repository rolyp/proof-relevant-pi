...
-}
   │ᵥ-preserves : ∀ {Γ} {P Q : Proc Γ} {x u a″ R R′ R″ S S′} {•x⌣•u} {a′⌣a″} {a⌣a″}
                 ...
                 E′/E (⊖₁ (𝐸 │ᵥ 𝐹)) ⌣[ /-preserves-ᴬ⌣ ᶜ∇ᶜ a′⌣a″ a⌣a″ ] E′/E (⊖ 𝐸″)
   │ᵥ-preserves {•x⌣•u = ᵇ∇ᵇ} 𝐸 𝐹 [ 𝐸′ │ᵥ• 𝐹′ ] [ 𝐸″ │ᵥ• 𝐹″ ] = [ {!!} ]
   │ᵥ-preserves {•x⌣•u = ᵛ∇ᵛ} 𝐸 𝐹 [ 𝐸′ │ᵥ• 𝐹′ ] [ 𝐸″ │ᵥ• 𝐹″ ] = [ {!!} ]
   │ᵥ-preserves {•x⌣•u = ᵇ∇ᵇ} 𝐸 𝐹 [ _│ᵥ_ {•x⌣•u = ᵇ∇ᵇ} 𝐸′ 𝐹′ ] [ _│ᵥ_ {•x⌣•u = ᵇ∇ᵇ} 𝐸″ 𝐹″ ] =
      [ νᶜᶜ [ /-preserves-⌣ 𝐸 𝐸′ 𝐸″ │ᵥ {!!} ] ]
   │ᵥ-preserves {•x⌣•u = ᵇ∇ᵇ} 𝐸 𝐹 [ _│ᵥ_ {•x⌣•u = ᵛ∇ᵛ} 𝐸′ 𝐹′ ] [ _│ᵥ_ {•x⌣•u = ᵇ∇ᵇ} 𝐸″ 𝐹″ ] =
      [ νᶜᶜ [ /-preserves-⌣ 𝐸 𝐸′ 𝐸″ │ᵥ {!!} ] ]
   │ᵥ-preserves {•x⌣•u = ᵇ∇ᵇ} 𝐸 𝐹 [ 𝐸′ │ᵥ 𝐹′ ] [ _│ᵥ_ {•x⌣•u = ᵛ∇ᵛ} 𝐸″ 𝐹″ ] =
      [ νᶜᶜ [ /-preserves-⌣ 𝐸 𝐸′ 𝐸″ │ᵥ• {!!} ] ]
   │ᵥ-preserves {•x⌣•u = ᵛ∇ᵛ} 𝐸 𝐹 [ 𝐸′ │ᵥ 𝐹′ ] [ _│ᵥ_ {•x⌣•u = ᵇ∇ᵇ} 𝐸″ 𝐹″ ] =
      [ νᶜᶜ [ ⌣-sym (/-preserves-⌣ 𝐸 𝐸′ 𝐸″) │ᵥ• {!!} ]ˡ ]
   │ᵥ-preserves {•x⌣•u = ᵛ∇ᵛ} 𝐸 𝐹 [ 𝐸′ │ᵥ 𝐹′ ] [ _│ᵥ_ {•x⌣•u = ᵛ∇ᵛ} 𝐸″ 𝐹″ ] =
      [ νᶜᶜ [ /-preserves-⌣ 𝐸 𝐸′ 𝐸″ │• {!!} ] ]
   │ᵥ-preserves {•x⌣•u = ᵇ∇ᵇ} 𝐸 𝐹 [ 𝐸′ │ᵥ 𝐹′ ] [ _│ᵥ_ {•x⌣•u = ᵇ∇ᵇ} 𝐸″ 𝐹″ ]ˡ =
      [ νᶜᶜ [ {!!} │ᵥ {!!} ] ]
   │ᵥ-preserves {•x⌣•u = ᵇ∇ᵇ} 𝐸 𝐹 [ 𝐸′ │ᵥ 𝐹′ ] [ _│ᵥ_ {•x⌣•u = ᵛ∇ᵛ} 𝐸″ 𝐹″ ]ˡ =
      [ νᶜᶜ [ {!!} │ᵥ• {!!} ] ]
   │ᵥ-preserves {•x⌣•u = ᵛ∇ᵛ} 𝐸 𝐹 [ 𝐸′ │ᵥ 𝐹′ ] [ _│ᵥ_ {•x⌣•u = ᵇ∇ᵇ} 𝐸″ 𝐹″ ]ˡ =
      [ νᶜᶜ [ {!!} │ᵥ• {!!} ]ˡ ]
   │ᵥ-preserves {•x⌣•u = ᵛ∇ᵛ} 𝐸 𝐹 [ 𝐸′ │ᵥ 𝐹′ ] [ _│ᵥ_ {•x⌣•u = ᵛ∇ᵛ} 𝐸″ 𝐹″ ]ˡ =
      [ νᶜᶜ [ {!!} │• {!!} ]ˡ ]
   │ᵥ-preserves {•x⌣•u = ᵇ∇ᵇ} 𝐸 𝐹 [ 𝐸′ │ᵥ 𝐹′ ]ˡ [ _│ᵥ_ {•x⌣•u = ᵇ∇ᵇ} 𝐸″ 𝐹″ ] =
      [ νᶜᶜ [ {!!} │ᵥ {!!} ] ]
   │ᵥ-preserves {•x⌣•u = ᵇ∇ᵇ} 𝐸 𝐹 [ 𝐸′ │ᵥ 𝐹′ ]ˡ [ _│ᵥ_ {•x⌣•u = ᵛ∇ᵛ} 𝐸″ 𝐹″ ] =
      [ νᶜᶜ [ {!!} │ᵥ• {!!} ] ]
   │ᵥ-preserves {•x⌣•u = ᵛ∇ᵛ} 𝐸 𝐹 [ 𝐸′ │ᵥ 𝐹′ ]ˡ [ _│ᵥ_ {•x⌣•u = ᵇ∇ᵇ} 𝐸″ 𝐹″ ] =
      [ νᶜᶜ [ {!!} │ᵥ• {!!} ]ˡ ]
   │ᵥ-preserves {•x⌣•u = ᵛ∇ᵛ} 𝐸 𝐹 [ 𝐸′ │ᵥ 𝐹′ ]ˡ [ _│ᵥ_ {•x⌣•u = ᵛ∇ᵛ} 𝐸″ 𝐹″ ] =
      [ νᶜᶜ [ {!!} │• {!!} ] ]
   ...
   │ᵥ-preserves {•x⌣•u = ᵇ∇ᵇ} 𝐸 𝐹 [ E′ ᵇ│ᵥ 𝐹′ ]ˡ [ _ᵇ│ᵥ_ {a⌣a′ = ᵛ∇ᵛ} E 𝐹″ ]ˡ =
      [ ν•ᶜ [ E′/E (⊖ 𝐸) ᶜ│ᵥ {!!} ] ]ˡ
   │ᵥ-preserves {•x⌣•u = ᵛ∇ᵛ} 𝐸 𝐹 [ E′ ᵇ│ᵥ 𝐹′ ]ˡ [ _ᵇ│ᵥ_ {a⌣a′ = ᵇ∇ᵇ} E 𝐹″ ]ˡ =
      [ νᵇᶜ [ E′/E (⊖ 𝐸) ᵇ│• {!!} ] ]ˡ
   │ᵥ-preserves {•x⌣•u = ᵛ∇ᵛ} 𝐸 𝐹 [ E′ ᵇ│ᵥ 𝐹′ ]ˡ [ _ᵇ│ᵥ_ {a⌣a′ = ᵛ∇ᵛ} E 𝐹″ ]ˡ =
      [ ν•ᶜ [ E′/E (⊖ 𝐸) ᶜ│• {!!} ] ]ˡ
