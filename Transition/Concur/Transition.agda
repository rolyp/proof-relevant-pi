...
module Transition.Concur.Transition where
   ...
   /-preserves-⌣₁ (_ᵇ│ᵥ_ {𝑎 = ᵇ∇ᵇ} E 𝐹) (𝐸 │ᵥ′ 𝐹′) (_ᵇ│ᵥ_ {𝑎 = ᵇ∇ᵇ} E′ 𝐹″) =
      (push *ᵇᵇ⌣) 𝐸 │ᵥ′ /-preserves-⌣₁ 𝐹 𝐹′ 𝐹″
   /-preserves-⌣₁ (_ᵇ│ᵥ_ {𝑎 = ᵇ∇ᵇ} E 𝐹) (𝐸 │ᵥ′ 𝐹′) (_ᵇ│ᵥ_ {𝑎 = ˣ∇ˣ} E′ 𝐹″) =
      ? -- (push *ᵇᵇ⌣) 𝐸 │ᵥ• (/-preserves-⌣₁ 𝐹 𝐹′ 𝐹″)
   /-preserves-⌣₁ (_ᵇ│ᵥ_ {𝑎 = ᵇ∇ᵇ} E 𝐹) (𝐸 │ᵥ 𝐹′) (_ᵇ│ᵥ_ {𝑎 = ᵇ∇ᵇ} E′ 𝐹″) =
      (push *ᵇᵇ⌣) 𝐸 │ᵥ /-preserves-⌣₁ 𝐹 𝐹′ 𝐹″
   /-preserves-⌣₁ (_ᵇ│ᵥ_ {𝑎 = ᵇ∇ᵇ} E 𝐹) (𝐸 │ᵥ 𝐹′) (_ᵇ│ᵥ_ {𝑎 = ˣ∇ˣ} E′ 𝐹″) =
      (push *ᵇᵇ⌣) 𝐸 │ᵥ• /-preserves-⌣₁ 𝐹 𝐹′ 𝐹″
   /-preserves-⌣₁ (_ᵇ│ᵥ_ {𝑎 = ˣ∇ˣ} E 𝐹) (𝐸 │ᵥ′ 𝐹′) (_ᵇ│ᵥ_ {𝑎 = ᵇ∇ᵇ} E′ 𝐹″) =
      ? -- (push *ᵇᵇ⌣) 𝐸 │•ᵥ /-preserves-⌣₁ 𝐹 𝐹′ 𝐹″
   /-preserves-⌣₁ (_ᵇ│ᵥ_ {𝑎 = ˣ∇ˣ} E 𝐹) (𝐸 │ᵥ′ 𝐹′) (_ᵇ│ᵥ_ {𝑎 = ˣ∇ˣ} E′ 𝐹″) =
