...
module Transition.Concur.Transition where
   ...
   -- The residual 𝐸′/E, where 𝐸′ is the second argument. Case-explosion because of three-way comparison.
   /-preserves-⌣₁ : ∀ {Γ} {P : Proc Γ} {a a′ a″ R R′ R″} {𝑎 : a ᴬ⌣ a′} {𝑎′ : a′ ᴬ⌣ a″} {𝑎″ : a ᴬ⌣ a″}
                   {E : P —[ a - _ ]→ R} {E′ : P —[ a′ - _ ]→ R′} {E″ : P —[ a″ - _ ]→ R″} →
                   (𝐸 : E ⌣₁[ 𝑎 ] E′) → E′ ⌣₁[ 𝑎′ ] E″ → (𝐸″ : E ⌣₁[ 𝑎″ ] E″) →
   ...
   /-preserves-⌣₁ (𝐸 ᵇᶜ│ Q) (𝐸′ ᵛᵛ│ .Q) (𝐸″ ᵇᶜ│ .Q) = /-preserves-⌣₁ 𝐸 𝐸′ 𝐸″ ᵛᵛ│ (push *) Q
   ...
   /-preserves-⌣₁ (P │ᵇᶜ 𝐹) (.P │ᵛᵛ 𝐹′) (.P │ᵇᶜ 𝐹″) = (push *) P │ᵛᵛ /-preserves-⌣₁ 𝐹 𝐹′ 𝐹″
   ...
   /-preserves-⌣₁ (𝐸 ᶜᶜ│ Q) (𝐸′ ᶜᶜ│ .Q) (𝐸″ ᵛᵛ│ .Q) = /-preserves-⌣₁ 𝐸 𝐸′ 𝐸″ ᶜᶜ│ Q
   /-preserves-⌣₁ (𝐸 ᶜᶜ│ Q) (𝐸′ ᵛᵛ│ .Q) (𝐸″ ᶜᶜ│ .Q) = /-preserves-⌣₁ 𝐸 𝐸′ 𝐸″ ᵛᵛ│ Q
   /-preserves-⌣₁ (𝐸 ᶜᶜ│ Q) (𝐸′ ᵛᵛ│ .Q) (𝐸″ ᵛᵛ│ .Q) = /-preserves-⌣₁ 𝐸 𝐸′ 𝐸″ ᵛᵛ│ Q
   ...
   /-preserves-⌣₁ (P │ᶜᶜ 𝐹) (.P │ᶜᶜ 𝐹′) (.P │ᵛᵛ 𝐹″) = P │ᶜᶜ /-preserves-⌣₁ 𝐹 𝐹′ 𝐹″
   /-preserves-⌣₁ (P │ᶜᶜ 𝐹) (.P │ᵛᵛ 𝐹′) (.P │ᶜᶜ 𝐹″) = P │ᵛᵛ /-preserves-⌣₁ 𝐹 𝐹′ 𝐹″
   /-preserves-⌣₁ (P │ᶜᶜ 𝐹) (.P │ᵛᵛ 𝐹′) (.P │ᵛᵛ 𝐹″) = P │ᵛᵛ /-preserves-⌣₁ 𝐹 𝐹′ 𝐹″
   ...
   /-preserves-⌣₁ (P │ᵛᵛ 𝐹) (.P │ᵛᵛ 𝐹′) (.P │ᶜᶜ 𝐹″) = P │ᵛᵛ /-preserves-⌣₁ 𝐹 𝐹′ 𝐹″
   /-preserves-⌣₁ (P │ᵛᵛ 𝐹) (.P │ᶜᶜ 𝐹′) (.P │ᵛᵛ 𝐹″) = P │ᶜᶜ /-preserves-⌣₁ 𝐹 𝐹′ 𝐹″
   /-preserves-⌣₁ (P │ᵛᵛ 𝐹) (.P │ᵛᵛ 𝐹′) (.P │ᵛᵛ 𝐹″) = P │ᵛᵛ /-preserves-⌣₁ 𝐹 𝐹′ 𝐹″
   ...
   /-preserves-⌣₁ (E ᵇ│ᶜ F) (P │ᵛᵛ 𝐹) (.E ᵇ│ᶜ F′) = _ │ᵛᵛ (push *ᶜᶜ⌣) 𝐹
   ...
   /-preserves-⌣₁ (E ᶜ│ᶜ F) (P │ᵛᵛ 𝐹′) (.E ᶜ│ᶜ F′) = _ │ᵛᵛ 𝐹′
