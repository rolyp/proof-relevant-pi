...
-}
   ...
   /-preserves-⌣ᵁᴰᵁ ([_] {a⌣a′ = ᵛ∇ᵛ} _) _ ([_] {a⌣a′ = ᵛ∇ᵛ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᴰᵁ ([_] {a⌣a′ = ᵛ∇ᵛ} _) _ ([_] {a⌣a′ = ᵇ∇ᵇ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᴰᵁ ([_] {a⌣a′ = ᵛ∇ᵛ} _) _ ([_] {a⌣a′ = ᶜ∇ᵇ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᴰᵁ ([_] {a⌣a′ = ᵇ∇ᵇ} _) _ ([_] {a⌣a′ = ᵛ∇ᵛ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᴰᵁ ([_] {a⌣a′ = ᵇ∇ᵇ} _) _ ([_] {a⌣a′ = ᵇ∇ᵇ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᴰᵁ ([_] {a⌣a′ = ᵇ∇ᵇ} _) _ ([_] {a⌣a′ = ᶜ∇ᵇ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᴰᵁ ([_] {a⌣a′ = ᵇ∇ᶜ} _) _ ([_] {a⌣a′ = ᵇ∇ᶜ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᴰᵁ ([_] {a⌣a′ = ᵇ∇ᶜ} _) _ ([_] {a⌣a′ = ᶜ∇ᶜ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᴰᵁ ([_] {a⌣a′ = ᶜ∇ᵇ} _) _ ([_] {a⌣a′ = ᵛ∇ᵛ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᴰᵁ ([_] {a⌣a′ = ᶜ∇ᵇ} _) _ ([_] {a⌣a′ = ᵇ∇ᵇ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᴰᵁ ([_] {a⌣a′ = ᶜ∇ᵇ} _) _ ([_] {a⌣a′ = ᶜ∇ᵇ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᴰᵁ ([_] {a⌣a′ = ᶜ∇ᶜ} _) _ ([_] {a⌣a′ = ᵇ∇ᶜ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᴰᵁ ([_] {a⌣a′ = ᶜ∇ᶜ} _) _ ([_] {a⌣a′ = ᶜ∇ᶜ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᴰᵁ ([_] {a⌣a′ = ᵛ∇ᵛ} _) _ ([_]ˡ {a⌣a′ = ᵛ∇ᵛ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᴰᵁ ([_] {a⌣a′ = ᵛ∇ᵛ} _) _ ([_]ˡ {a⌣a′ = ᵇ∇ᵇ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᴰᵁ ([_] {a⌣a′ = ᵛ∇ᵛ} _) _ ([_]ˡ {a⌣a′ = ᵇ∇ᶜ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᴰᵁ ([_] {a⌣a′ = ᵇ∇ᵇ} _) _ ([_]ˡ {a⌣a′ = ᵛ∇ᵛ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᴰᵁ ([_] {a⌣a′ = ᵇ∇ᵇ} _) _ ([_]ˡ {a⌣a′ = ᵇ∇ᵇ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᴰᵁ ([_] {a⌣a′ = ᵇ∇ᵇ} _) _ ([_]ˡ {a⌣a′ = ᵇ∇ᶜ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᴰᵁ ([_] {a⌣a′ = ᵇ∇ᶜ} _) _ ([_]ˡ {a⌣a′ = ᶜ∇ᵇ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᴰᵁ ([_] {a⌣a′ = ᵇ∇ᶜ} _) _ ([_]ˡ {a⌣a′ = ᶜ∇ᶜ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᴰᵁ ([_] {a⌣a′ = ᶜ∇ᵇ} _) _ ([_]ˡ {a⌣a′ = ᵛ∇ᵛ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᴰᵁ ([_] {a⌣a′ = ᶜ∇ᵇ} _) _ ([_]ˡ {a⌣a′ = ᵇ∇ᵇ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᴰᵁ ([_] {a⌣a′ = ᶜ∇ᵇ} _) _ ([_]ˡ {a⌣a′ = ᵇ∇ᶜ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᴰᵁ ([_] {a⌣a′ = ᶜ∇ᶜ} _) _ ([_]ˡ {a⌣a′ = ᶜ∇ᵇ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᴰᵁ ([_] {a⌣a′ = ᶜ∇ᶜ} _) _ ([_]ˡ {a⌣a′ = ᶜ∇ᶜ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᴰᵁ ([_]ˡ {a⌣a′ = ᵛ∇ᵛ} _) _ ([_] {a⌣a′ = ᵛ∇ᵛ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᴰᵁ ([_]ˡ {a⌣a′ = ᵛ∇ᵛ} _) _ ([_] {a⌣a′ = ᵇ∇ᵇ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᴰᵁ ([_]ˡ {a⌣a′ = ᵛ∇ᵛ} _) _ ([_] {a⌣a′ = ᶜ∇ᵇ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᴰᵁ ([_]ˡ {a⌣a′ = ᵇ∇ᵇ} _) _ ([_] {a⌣a′ = ᵛ∇ᵛ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᴰᵁ ([_]ˡ {a⌣a′ = ᵇ∇ᵇ} _) _ ([_] {a⌣a′ = ᵇ∇ᵇ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᴰᵁ ([_]ˡ {a⌣a′ = ᵇ∇ᵇ} _) _ ([_] {a⌣a′ = ᶜ∇ᵇ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᴰᵁ ([_]ˡ {a⌣a′ = ᵇ∇ᶜ} _) _ ([_] {a⌣a′ = ᵛ∇ᵛ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᴰᵁ ([_]ˡ {a⌣a′ = ᵇ∇ᶜ} _) _ ([_] {a⌣a′ = ᵇ∇ᵇ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᴰᵁ ([_]ˡ {a⌣a′ = ᵇ∇ᶜ} _) _ ([_] {a⌣a′ = ᶜ∇ᵇ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᴰᵁ ([_]ˡ {a⌣a′ = ᶜ∇ᵇ} _) _ ([_] {a⌣a′ = ᵇ∇ᶜ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᴰᵁ ([_]ˡ {a⌣a′ = ᶜ∇ᵇ} _) _ ([_] {a⌣a′ = ᶜ∇ᶜ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᴰᵁ ([_]ˡ {a⌣a′ = ᶜ∇ᶜ} _) _ ([_] {a⌣a′ = ᵇ∇ᶜ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᴰᵁ ([_]ˡ {a⌣a′ = ᶜ∇ᶜ} _) _ ([_] {a⌣a′ = ᶜ∇ᶜ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᴰᵁ ([_]ˡ {a⌣a′ = ᵛ∇ᵛ} _) _ ([_]ˡ {a⌣a′ = ᵛ∇ᵛ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᴰᵁ ([_]ˡ {a⌣a′ = ᵛ∇ᵛ} _) _ ([_]ˡ {a⌣a′ = ᵇ∇ᵇ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᴰᵁ ([_]ˡ {a⌣a′ = ᵛ∇ᵛ} _) _ ([_]ˡ {a⌣a′ = ᵇ∇ᶜ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᴰᵁ ([_]ˡ {a⌣a′ = ᵇ∇ᵇ} _) _ ([_]ˡ {a⌣a′ = ᵛ∇ᵛ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᴰᵁ ([_]ˡ {a⌣a′ = ᵇ∇ᵇ} _) _ ([_]ˡ {a⌣a′ = ᵇ∇ᵇ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᴰᵁ ([_]ˡ {a⌣a′ = ᵇ∇ᵇ} _) _ ([_]ˡ {a⌣a′ = ᵇ∇ᶜ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᴰᵁ ([_]ˡ {a⌣a′ = ᵇ∇ᶜ} _) _ ([_]ˡ {a⌣a′ = ᵛ∇ᵛ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᴰᵁ ([_]ˡ {a⌣a′ = ᵇ∇ᶜ} _) _ ([_]ˡ {a⌣a′ = ᵇ∇ᵇ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᴰᵁ ([_]ˡ {a⌣a′ = ᵇ∇ᶜ} _) _ ([_]ˡ {a⌣a′ = ᵇ∇ᶜ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᴰᵁ ([_]ˡ {a⌣a′ = ᶜ∇ᵇ} _) _ ([_]ˡ {a⌣a′ = ᶜ∇ᵇ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᴰᵁ ([_]ˡ {a⌣a′ = ᶜ∇ᵇ} _) _ ([_]ˡ {a⌣a′ = ᶜ∇ᶜ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᴰᵁ ([_]ˡ {a⌣a′ = ᶜ∇ᶜ} _) _ ([_]ˡ {a⌣a′ = ᶜ∇ᵇ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᴰᵁ ([_]ˡ {a⌣a′ = ᶜ∇ᶜ} _) _ ([_]ˡ {a⌣a′ = ᶜ∇ᶜ} _) | 𝐸′/E = 𝐸′/E

   /-preserves-⌣ᵁᵁᵁ 𝐸 𝐸′ 𝐸″ with /-preserves-⌣ (⌣-sym 𝐸) (⌣-sym 𝐸′) (⌣-sym 𝐸″)
   /-preserves-⌣ᵁᵁᵁ ([_] {a⌣a′ = ᵛ∇ᵛ} _) _ ([_] {a⌣a′ = ᵛ∇ᵛ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᵁᵁ ([_] {a⌣a′ = ᵛ∇ᵛ} _) _ ([_] {a⌣a′ = ᵇ∇ᵇ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᵁᵁ ([_] {a⌣a′ = ᵛ∇ᵛ} _) _ ([_] {a⌣a′ = ᶜ∇ᵇ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᵁᵁ ([_] {a⌣a′ = ᵇ∇ᵇ} _) _ ([_] {a⌣a′ = ᵛ∇ᵛ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᵁᵁ ([_] {a⌣a′ = ᵇ∇ᵇ} _) _ ([_] {a⌣a′ = ᵇ∇ᵇ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᵁᵁ ([_] {a⌣a′ = ᵇ∇ᵇ} _) _ ([_] {a⌣a′ = ᶜ∇ᵇ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᵁᵁ ([_] {a⌣a′ = ᵇ∇ᶜ} _) _ ([_] {a⌣a′ = ᵇ∇ᶜ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᵁᵁ ([_] {a⌣a′ = ᵇ∇ᶜ} _) _ ([_] {a⌣a′ = ᶜ∇ᶜ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᵁᵁ ([_] {a⌣a′ = ᶜ∇ᵇ} _) _ ([_] {a⌣a′ = ᵛ∇ᵛ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᵁᵁ ([_] {a⌣a′ = ᶜ∇ᵇ} _) _ ([_] {a⌣a′ = ᵇ∇ᵇ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᵁᵁ ([_] {a⌣a′ = ᶜ∇ᵇ} _) _ ([_] {a⌣a′ = ᶜ∇ᵇ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᵁᵁ ([_] {a⌣a′ = ᶜ∇ᶜ} _) _ ([_] {a⌣a′ = ᵇ∇ᶜ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᵁᵁ ([_] {a⌣a′ = ᶜ∇ᶜ} _) _ ([_] {a⌣a′ = ᶜ∇ᶜ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᵁᵁ ([_] {a⌣a′ = ᵛ∇ᵛ} _) _ ([_]ˡ {a⌣a′ = ᵛ∇ᵛ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᵁᵁ ([_] {a⌣a′ = ᵛ∇ᵛ} _) _ ([_]ˡ {a⌣a′ = ᵇ∇ᵇ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᵁᵁ ([_] {a⌣a′ = ᵛ∇ᵛ} _) _ ([_]ˡ {a⌣a′ = ᵇ∇ᶜ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᵁᵁ ([_] {a⌣a′ = ᵇ∇ᵇ} _) _ ([_]ˡ {a⌣a′ = ᵛ∇ᵛ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᵁᵁ ([_] {a⌣a′ = ᵇ∇ᵇ} _) _ ([_]ˡ {a⌣a′ = ᵇ∇ᵇ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᵁᵁ ([_] {a⌣a′ = ᵇ∇ᵇ} _) _ ([_]ˡ {a⌣a′ = ᵇ∇ᶜ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᵁᵁ ([_] {a⌣a′ = ᵇ∇ᶜ} _) _ ([_]ˡ {a⌣a′ = ᶜ∇ᵇ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᵁᵁ ([_] {a⌣a′ = ᵇ∇ᶜ} _) _ ([_]ˡ {a⌣a′ = ᶜ∇ᶜ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᵁᵁ ([_] {a⌣a′ = ᶜ∇ᵇ} _) _ ([_]ˡ {a⌣a′ = ᵛ∇ᵛ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᵁᵁ ([_] {a⌣a′ = ᶜ∇ᵇ} _) _ ([_]ˡ {a⌣a′ = ᵇ∇ᵇ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᵁᵁ ([_] {a⌣a′ = ᶜ∇ᵇ} _) _ ([_]ˡ {a⌣a′ = ᵇ∇ᶜ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᵁᵁ ([_] {a⌣a′ = ᶜ∇ᶜ} _) _ ([_]ˡ {a⌣a′ = ᶜ∇ᵇ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᵁᵁ ([_] {a⌣a′ = ᶜ∇ᶜ} _) _ ([_]ˡ {a⌣a′ = ᶜ∇ᶜ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᵁᵁ ([_]ˡ {a⌣a′ = ᵛ∇ᵛ} _) _ ([_] {a⌣a′ = ᵛ∇ᵛ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᵁᵁ ([_]ˡ {a⌣a′ = ᵛ∇ᵛ} _) _ ([_] {a⌣a′ = ᵇ∇ᵇ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᵁᵁ ([_]ˡ {a⌣a′ = ᵛ∇ᵛ} _) _ ([_] {a⌣a′ = ᶜ∇ᵇ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᵁᵁ ([_]ˡ {a⌣a′ = ᵇ∇ᵇ} _) _ ([_] {a⌣a′ = ᵛ∇ᵛ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᵁᵁ ([_]ˡ {a⌣a′ = ᵇ∇ᵇ} _) _ ([_] {a⌣a′ = ᵇ∇ᵇ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᵁᵁ ([_]ˡ {a⌣a′ = ᵇ∇ᵇ} _) _ ([_] {a⌣a′ = ᶜ∇ᵇ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᵁᵁ ([_]ˡ {a⌣a′ = ᵇ∇ᶜ} _) _ ([_] {a⌣a′ = ᵛ∇ᵛ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᵁᵁ ([_]ˡ {a⌣a′ = ᵇ∇ᶜ} _) _ ([_] {a⌣a′ = ᵇ∇ᵇ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᵁᵁ ([_]ˡ {a⌣a′ = ᵇ∇ᶜ} _) _ ([_] {a⌣a′ = ᶜ∇ᵇ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᵁᵁ ([_]ˡ {a⌣a′ = ᶜ∇ᵇ} _) _ ([_] {a⌣a′ = ᵇ∇ᶜ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᵁᵁ ([_]ˡ {a⌣a′ = ᶜ∇ᵇ} _) _ ([_] {a⌣a′ = ᶜ∇ᶜ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᵁᵁ ([_]ˡ {a⌣a′ = ᶜ∇ᶜ} _) _ ([_] {a⌣a′ = ᵇ∇ᶜ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᵁᵁ ([_]ˡ {a⌣a′ = ᶜ∇ᶜ} _) _ ([_] {a⌣a′ = ᶜ∇ᶜ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᵁᵁ ([_]ˡ {a⌣a′ = ᵛ∇ᵛ} _) _ ([_]ˡ {a⌣a′ = ᵛ∇ᵛ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᵁᵁ ([_]ˡ {a⌣a′ = ᵛ∇ᵛ} _) _ ([_]ˡ {a⌣a′ = ᵇ∇ᵇ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᵁᵁ ([_]ˡ {a⌣a′ = ᵛ∇ᵛ} _) _ ([_]ˡ {a⌣a′ = ᵇ∇ᶜ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᵁᵁ ([_]ˡ {a⌣a′ = ᵇ∇ᵇ} _) _ ([_]ˡ {a⌣a′ = ᵛ∇ᵛ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᵁᵁ ([_]ˡ {a⌣a′ = ᵇ∇ᵇ} _) _ ([_]ˡ {a⌣a′ = ᵇ∇ᵇ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᵁᵁ ([_]ˡ {a⌣a′ = ᵇ∇ᵇ} _) _ ([_]ˡ {a⌣a′ = ᵇ∇ᶜ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᵁᵁ ([_]ˡ {a⌣a′ = ᵇ∇ᶜ} _) _ ([_]ˡ {a⌣a′ = ᵛ∇ᵛ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᵁᵁ ([_]ˡ {a⌣a′ = ᵇ∇ᶜ} _) _ ([_]ˡ {a⌣a′ = ᵇ∇ᵇ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᵁᵁ ([_]ˡ {a⌣a′ = ᵇ∇ᶜ} _) _ ([_]ˡ {a⌣a′ = ᵇ∇ᶜ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᵁᵁ ([_]ˡ {a⌣a′ = ᶜ∇ᵇ} _) _ ([_]ˡ {a⌣a′ = ᶜ∇ᵇ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᵁᵁ ([_]ˡ {a⌣a′ = ᶜ∇ᵇ} _) _ ([_]ˡ {a⌣a′ = ᶜ∇ᶜ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᵁᵁ ([_]ˡ {a⌣a′ = ᶜ∇ᶜ} _) _ ([_]ˡ {a⌣a′ = ᶜ∇ᵇ} _) | 𝐸′/E = 𝐸′/E
   /-preserves-⌣ᵁᵁᵁ ([_]ˡ {a⌣a′ = ᶜ∇ᶜ} _) _ ([_]ˡ {a⌣a′ = ᶜ∇ᶜ} _) | 𝐸′/E = 𝐸′/E
