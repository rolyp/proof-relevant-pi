...
module Transition.Concur.Transition where
   ...
   -- This certainly should be true, although perhaps it won't be easy to prove.
   postulate
      impossible : ∀ {Γ} {P : Proc Γ} {x x′ x″ R R′ R″}
                   {F : P —[ (• x) ᵇ - _ ]→ R} {F′ : P —[ (• x′) ᵇ - _ ]→ R′}  →
                   F ⌣[ ᵛ∇ᵛ ] F′ → {F″ : P —[ (• x″) ᵇ - _ ]→ R″} → F ⌣[ ᵛ∇ᵛ ] F″ → F″ ⌣[ ᵇ∇ᵇ ] F′ → ⊥
...
{-
   ...
   ᵇ│ᵥˡ-preserves {a⌣a′ = ᵛ∇ᵛ} E 𝐹 [ _│ᵇᵇ_ {a⌣a′ = ᵇ∇ᵇ} P 𝐹′ ] [ _ᵇ│ᵥ_ {a⌣a′ = ᵛ∇ᵛ} .E 𝐹″ ]ˡ =
      ⊥-elim (impossible (⌣-sym 𝐹″) (⌣-sym 𝐹) 𝐹′)
   ᵇ│ᵥˡ-preserves {a⌣a′ = ᵇ∇ᵇ} E 𝐹 [ _│ᵇᵇ_ {a⌣a′ = ᵛ∇ᵛ} P 𝐹′ ] [ _ᵇ│ᵥ_ {a⌣a′ = ᵛ∇ᵛ} .E 𝐹″ ]ˡ =
      ⊥-elim (impossible 𝐹″ (⌣-sym 𝐹′) 𝐹)
   ...
   ᵇ│ᶜ-preserves E F [ _ᶜ│•_ {y = y} E′ 𝐹 ] [ _│•ᵇ_ {a = a} 𝐸 F′ ] with (pop y *ᵇ) (E/E′ (⊖ 𝐸))
   ... | _ rewrite pop∘push y a = [ E′/E (⊖ 𝐸) ᶜ│• (push *ᶜᶜ⌣) 𝐹 ]
   ᵇ│ᶜ-preserves E F [ E′ ᶜ│ᵥ 𝐹 ] [ 𝐸 │ᵥᵇ F′ ] = [ E′/E (⊖ 𝐸) ᶜ│ᵥ (push *ᶜᵇ⌣) 𝐹 ]
   ᵇ│ᶜ-preserves E F [ P │ᶜᶜ 𝐹 ] [ .E ᵇ│ᶜ F′ ] = [ _ │ᶜᶜ (push *ᶜᶜ⌣) 𝐹 ]
   ᵇ│ᶜ-preserves E F [ E′ ᵇ│ᶜ .F ]ˡ [ _ᵇᵇ│_ {a⌣a′ = ᵇ∇ᵇ} 𝐸 Q ] = [ (E′/E (⊖ 𝐸)) ᵇ│ᶜ (push *ᶜ) F ]ˡ
   ᵇ│ᶜ-preserves E F [ E′ ᵇ│ᶜ .F ]ˡ [ _ᵇᵇ│_ {a⌣a′ = ᵛ∇ᵛ} 𝐸 Q ] = [ E′/E (⊖ 𝐸) ᶜ│ᶜ (push *ᶜ) F ]ˡ
   ᵇ│ᶜ-preserves E F [ E′ ᶜ│ᶜ .F ]ˡ [ 𝐸 ᵇᶜ│ Q ] = [ E′/E (⊖ 𝐸) ᶜ│ᶜ (push *ᶜ) F ]ˡ
   ᵇ│ᶜ-preserves E F [ P │ᵇᶜ 𝐹 ]ˡ [ .E ᵇ│ᵇ F′ ] = [ _ │ᵇᶜ (push *ᵇᶜ⌣) 𝐹 ]ˡ
   ᵇ│ᶜ-preserves E F [ P │ᶜᶜ 𝐹 ]ˡ [ .E ᵇ│ᶜ F′ ] = [ _ │ᶜᶜ ⌣-sym ((push *ᶜᶜ⌣) 𝐹) ]
   ᵇ│ᶜ-preserves E F [ E′ ᵇ│ᶜ .F ]ˡ [ _ᵇᵇ│_ {a⌣a′ = ᵇ∇ᵇ} 𝐸 Q ]ˡ = [ E/E′ (⊖ 𝐸) ᵇ│ᶜ (push *ᶜ) F ]ˡ
   ᵇ│ᶜ-preserves E F [ E′ ᵇ│ᶜ .F ]ˡ [ _ᵇᵇ│_ {a⌣a′ = ᵛ∇ᵛ} 𝐸 Q ]ˡ = [ E/E′ (⊖ 𝐸) ᶜ│ᶜ (push *ᶜ) F ]ˡ
   ᵇ│ᶜ-preserves _ _ [ _ ᶜ│• _ ] [ () ]ˡ
   ᵇ│ᶜ-preserves _ _ [ _ ᶜ│ᵥ _ ] [ () ]ˡ
   ᵇ│ᶜ-preserves _ _ [ _ │ᶜᶜ _ ] [ () ]ˡ
   ᵇ│ᶜ-preserves _ _ [ _ ᶜ│ᶜ ._ ]ˡ [ () ]ˡ
   ᵇ│ᶜ-preserves _ _ [ _ │ᵇᶜ _ ]ˡ [ () ]ˡ
   ᵇ│ᶜ-preserves _ _ [ _ │ᶜᶜ _ ]ˡ [ () ]ˡ

   ᵇ│ᶜˡ-preserves : ∀ {Γ} {P Q : Proc Γ} {a a′ a″ R R″ S} {a′⌣a″} {a⌣a″}
                  (E : P —[ a ᵇ - _ ]→ R) (F : Q —[ a′ ᶜ - _ ]→ S) {E″ : P │ Q —[ a″ - _ ]→ R″} →
                  E ᵇ│ Q ⌣[ a′⌣a″ ] E″ → (𝐸″ : P │ᶜ F ⌣[ a⌣a″ ] E″) →
                  E ᵇ│ S ⌣[ /-preserves-ᴬ⌣ ᶜ∇ᵇ a′⌣a″ a⌣a″ ] E′/E (⊖ 𝐸″)
   ᵇ│ᶜˡ-preserves E F₁ [ .E ᵇ│ᶜ F ] [ P │ᶜᶜ 𝐹 ] = [ E ᵇ│ᶜ E′/E (⊖ 𝐹) ]
   ᵇ│ᶜˡ-preserves E F [ 𝐸 │•ᵇ F′ ] [ E′ ᶜ│• 𝐹 ] = [ 𝐸 │•ᵇ E′/E (⊖ 𝐹) ]
   ᵇ│ᶜˡ-preserves E F [ 𝐸 │ᵥᵇ F′ ] [ E′ ᶜ│ᵥ 𝐹 ] = [ 𝐸 │ᵥᵇ E′/E (⊖ 𝐹) ]
   ᵇ│ᶜˡ-preserves E F [ .E ᵇ│ᵇ F′ ] [ P │ᵇᶜ 𝐹 ]ˡ = [ E ᵇ│ᵇ E/E′ (⊖ 𝐹) ]
   ᵇ│ᶜˡ-preserves E F [ .E ᵇ│ᶜ F′ ] [ P │ᶜᶜ 𝐹 ]ˡ = [ E ᵇ│ᶜ E/E′ (⊖ 𝐹) ]
   ᵇ│ᶜˡ-preserves E F [ _ᵇᵇ│_ {a⌣a′ = ᵇ∇ᵇ} 𝐸 Q ] [ E′ ᵇ│ᶜ .F ]ˡ = [ 𝐸 ᵇᵇ│ _ ]
   ᵇ│ᶜˡ-preserves E F [ _ᵇᵇ│_ {a⌣a′ = ᵛ∇ᵛ} 𝐸 Q ] [ E′ ᵇ│ᶜ .F ]ˡ = [ 𝐸 ᵇᵇ│ _ ]
   ᵇ│ᶜˡ-preserves E F [ 𝐸 ᵇᶜ│ Q ] [ E′ ᶜ│ᶜ .F ]ˡ = [ 𝐸 ᵇᶜ│ _ ]
   ᵇ│ᶜˡ-preserves E F [ _ᵇᵇ│_ {a⌣a′ = ᵇ∇ᵇ} 𝐸 Q ]ˡ [ E′ ᵇ│ᶜ .F ]ˡ = [ ⌣-sym 𝐸 ᵇᵇ│ _ ]
   ᵇ│ᶜˡ-preserves E F [ _ᵇᵇ│_ {a⌣a′ = ᵛ∇ᵛ} 𝐸 Q ]ˡ [ E′ ᵇ│ᶜ .F ]ˡ = [ ⌣-sym 𝐸 ᵇᵇ│ _ ]
   ᵇ│ᶜˡ-preserves _ _ [ ._ ᵇ│ᵇ _ ] [ () ]
   ᵇ│ᶜˡ-preserves _ _ [ _ ᵇᵇ│ _ ] [ () ]
   ᵇ│ᶜˡ-preserves _ _ [ _ ᵇᶜ│ _ ] [ () ]
   ᵇ│ᶜˡ-preserves _ _ [ _ │•ᵇ _ ] [ () ]ˡ
   ᵇ│ᶜˡ-preserves _ _ [ _ │ᵥᵇ _ ] [ () ]ˡ
   ᵇ│ᶜˡ-preserves _ _ [ _ ᵇᵇ│ _ ]ˡ [ () ]

   ᶜ│ᵇ-preserves : ∀ {Γ} {P Q : Proc Γ} {a a′ a″ R R″ S} {a′⌣a″} {a⌣a″}
                  (E : P —[ a ᶜ - _ ]→ R) (F : Q —[ a′ ᵇ - _ ]→ S) {E″ : P │ Q —[ a″ - _ ]→ R″} →
                  P │ᵇ F ⌣[ a′⌣a″ ] E″ → (𝐸″ : E ᶜ│ Q ⌣[ a⌣a″ ] E″) →
                  R │ᵇ F ⌣[ /-preserves-ᴬ⌣ ᶜ∇ᵇ a′⌣a″ a⌣a″ ] E′/E (⊖ 𝐸″)
   ᶜ│ᵇ-preserves E F [ _ᵇ│•_ {y = y} E′ 𝐹 ] [ _│•ᶜ_ {a = a} 𝐸 F′ ] with (pop y *ᶜ) (E/E′ (⊖ 𝐸))
   ... | _ rewrite pop∘push y a = [ E′/E (⊖ 𝐸) ᵇ│• 𝐹 ]
   ᶜ│ᵇ-preserves E F [ E′ ᵇ│ᵥ 𝐹 ] [ 𝐸 │ᵥᶜ F′ ] = [ E′/E (⊖ 𝐸) ᵇ│ᵥ 𝐹 ]
   ᶜ│ᵇ-preserves E F [ _│ᵇᵇ_ {a⌣a′ = ᵇ∇ᵇ} P 𝐹 ] [ .E ᶜ│ᵇ F′ ] = [ _ │ᵇᵇ 𝐹 ]
   ᶜ│ᵇ-preserves E F [ _│ᵇᵇ_ {a⌣a′ = ᵛ∇ᵛ} P 𝐹 ] [ .E ᶜ│ᵇ F′ ] = [ _ │ᵇᵇ 𝐹 ]
   ᶜ│ᵇ-preserves E F [ P │ᵇᶜ 𝐹 ] [ .E ᶜ│ᶜ F′ ] = [ _ │ᵇᶜ 𝐹 ]
   ᶜ│ᵇ-preserves E F [ E′ ᶜ│ᵇ .F ]ˡ [ 𝐸 ᶜᶜ│ Q ] = [ E′/E (⊖ 𝐸) ᶜ│ᵇ F ]ˡ
   ᶜ│ᵇ-preserves E F [ _│ᵇᵇ_ {a⌣a′ = ᵇ∇ᵇ} P 𝐹 ]ˡ [ .E ᶜ│ᵇ F′ ] = [ _ │ᵇᵇ ⌣-sym 𝐹 ]
   ᶜ│ᵇ-preserves E F [ _│ᵇᵇ_ {a⌣a′ = ᵛ∇ᵛ} P 𝐹 ]ˡ [ .E ᶜ│ᵇ F′ ] = [ _ │ᵇᵇ ⌣-sym 𝐹 ]
   ᶜ│ᵇ-preserves E F [ E′ ᵇ│ᵇ .F ]ˡ [ 𝐸 ᵇᶜ│ Q ]ˡ = [ E/E′ (⊖ 𝐸) ᵇ│ᵇ F ]ˡ
   ᶜ│ᵇ-preserves E F [ E′ ᶜ│ᵇ .F ]ˡ [ 𝐸 ᶜᶜ│ Q ]ˡ = [ E/E′ (⊖ 𝐸) ᶜ│ᵇ F ]ˡ
   ᶜ│ᵇ-preserves _ _ [ _ ᵇ│• _ ] [ () ]ˡ
   ᶜ│ᵇ-preserves _ _ [ _ ᵇ│ᵥ _ ] [ () ]ˡ
   ᶜ│ᵇ-preserves _ _ [ _ │ᵇᵇ _ ] [ () ]ˡ
   ᶜ│ᵇ-preserves _ _ [ _ │ᵇᶜ _ ] [ () ]ˡ
   ᶜ│ᵇ-preserves _ _ [ _ ᵇ│ᵇ ._ ]ˡ [ () ]
   ᶜ│ᵇ-preserves _ _ [ _ │ᵇᵇ _ ]ˡ [ () ]ˡ

   ᶜ│ᵇˡ-preserves : ∀ {Γ} {P Q : Proc Γ} {a a′ a″ R R″ S} {a′⌣a″} {a⌣a″}
                  (E : P —[ a ᶜ - _ ]→ R) (F : Q —[ a′ ᵇ - _ ]→ S) {E″ : P │ Q —[ a″ - _ ]→ R″} →
                  E ᶜ│ Q ⌣[ a′⌣a″ ] E″ → (𝐸″ : P │ᵇ F ⌣[ a⌣a″ ] E″) →
                  (push *ᶜ) E ᶜ│ S ⌣[ /-preserves-ᴬ⌣ ᵇ∇ᶜ a′⌣a″ a⌣a″ ] E′/E (⊖ 𝐸″)
   ᶜ│ᵇˡ-preserves E F [ .E ᶜ│ᵇ F′ ] [ _│ᵇᵇ_ {a⌣a′ = ᵇ∇ᵇ} P 𝐹 ] = [ (push *ᶜ) E ᶜ│ᵇ E′/E (⊖ 𝐹) ]
   ᶜ│ᵇˡ-preserves E F [ .E ᶜ│ᵇ F′ ] [ _│ᵇᵇ_ {a⌣a′ = ᵛ∇ᵛ} P 𝐹 ] = [ (push *ᶜ) E ᶜ│ᶜ E′/E (⊖ 𝐹) ]
   ᶜ│ᵇˡ-preserves E F [ .E ᶜ│ᶜ F′ ] [ P │ᵇᶜ 𝐹 ] = [ (push *ᶜ) E ᶜ│ᶜ E′/E (⊖ 𝐹) ]
   ᶜ│ᵇˡ-preserves E F [ 𝐸 │•ᶜ F′ ] [ E′ ᵇ│• 𝐹 ] = [ (push *ᶜᵇ⌣) 𝐸 │•ᶜ E′/E (⊖ 𝐹) ]
   ᶜ│ᵇˡ-preserves E F [ 𝐸 │ᵥᶜ F′ ] [ _ᵇ│ᵥ_ {a⌣a′ = ᵇ∇ᵇ} E′ 𝐹 ] = [ (push *ᶜᵇ⌣) 𝐸 │ᵥᶜ E′/E (⊖ 𝐹) ]
   ᶜ│ᵇˡ-preserves E F [ 𝐸 │ᵥᶜ F′ ] [ _ᵇ│ᵥ_ {a⌣a′ = ᵛ∇ᵛ} E′ 𝐹 ] = [ (push *ᶜᵇ⌣) 𝐸 │•ᶜ E′/E (⊖ 𝐹) ]
   ᶜ│ᵇˡ-preserves E F [ .E ᶜ│ᵇ F′ ] [ _│ᵇᵇ_ {a⌣a′ = ᵇ∇ᵇ} P 𝐹 ]ˡ = [ (push *ᶜ) E ᶜ│ᵇ E/E′ (⊖ 𝐹) ]
   ᶜ│ᵇˡ-preserves E F [ .E ᶜ│ᵇ F′ ] [ _│ᵇᵇ_ {a⌣a′ = ᵛ∇ᵛ} P 𝐹 ]ˡ = [ (push *ᶜ) E ᶜ│ᶜ E/E′ (⊖ 𝐹) ]
   ᶜ│ᵇˡ-preserves E F [ 𝐸 ᶜᶜ│ Q ] [ E′ ᶜ│ᵇ .F ]ˡ = [ (push *ᶜᶜ⌣) 𝐸 ᶜᶜ│ _ ]
   ᶜ│ᵇˡ-preserves E F [ 𝐸 ᵇᶜ│ Q ]ˡ [ E′ ᵇ│ᵇ .F ]ˡ = [ (push *ᵇᶜ⌣) 𝐸 ᵇᶜ│ _ ]ˡ
   ᶜ│ᵇˡ-preserves E F [ 𝐸 ᶜᶜ│ Q ]ˡ [ E′ ᶜ│ᵇ .F ]ˡ = [ ⌣-sym ((push *ᶜᶜ⌣) 𝐸) ᶜᶜ│ _ ]
   ᶜ│ᵇˡ-preserves _ _ [ _ ᶜᶜ│ _ ] [ () ]
   ᶜ│ᵇˡ-preserves _ _ [ ._ ᶜ│ᶜ _ ] [ () ]ˡ
   ᶜ│ᵇˡ-preserves _ _ [ _ │•ᶜ _ ] [ () ]ˡ
   ᶜ│ᵇˡ-preserves _ _ [ _ │ᵥᶜ _ ] [ () ]ˡ
   ᶜ│ᵇˡ-preserves _ _ [ _ ᵇᶜ│ _ ]ˡ [ () ]
   ᶜ│ᵇˡ-preserves _ _ [ _ ᶜᶜ│ _ ]ˡ [ () ]

   ᶜ│ᶜ-preserves : ∀ {Γ} {P Q : Proc Γ} {a a′ a″ R R″ S} {a′⌣a″} {a⌣a″}
                  (E : P —[ a ᶜ - _ ]→ R) (F : Q —[ a′ ᶜ - _ ]→ S) {E″ : P │ Q —[ a″ - _ ]→ R″} →
                  P │ᶜ F ⌣[ a′⌣a″ ] E″ → (𝐸″ : E ᶜ│ Q ⌣[ a⌣a″ ] E″) →
                  R │ᶜ F ⌣[ /-preserves-ᴬ⌣ ᶜ∇ᶜ a′⌣a″ a⌣a″ ] E′/E (⊖ 𝐸″)
   ᶜ│ᶜ-preserves E F [ _ᶜ│•_ {y = y} E′ 𝐹 ] [ _│•ᶜ_ {a = a} 𝐸 F′ ] with (pop y *ᶜ) (E/E′ (⊖ 𝐸))
   ... | _ rewrite pop∘push y a = [ E′/E (⊖ 𝐸) ᶜ│• 𝐹 ]
   ᶜ│ᶜ-preserves E F [ E′ ᶜ│ᵥ 𝐹 ] [ 𝐸 │ᵥᶜ F′ ] = [ E′/E (⊖ 𝐸) ᶜ│ᵥ 𝐹 ]
   ᶜ│ᶜ-preserves E F [ P │ᶜᶜ 𝐹 ] [ .E ᶜ│ᶜ F′ ] = [ _ │ᶜᶜ 𝐹 ]
   ᶜ│ᶜ-preserves E F [ E′ ᶜ│ᶜ .F ]ˡ [ 𝐸 ᶜᶜ│ Q ] = [ E′/E (⊖ 𝐸) ᶜ│ᶜ F ]ˡ
   ᶜ│ᶜ-preserves E F [ P │ᵇᶜ 𝐹 ]ˡ [ .E ᶜ│ᵇ F′ ] = [ _ │ᵇᶜ 𝐹 ]ˡ
   ᶜ│ᶜ-preserves E F [ P │ᶜᶜ 𝐹 ]ˡ [ .E ᶜ│ᶜ F′ ] = [ _ │ᶜᶜ ⌣-sym 𝐹 ]
   ᶜ│ᶜ-preserves E F [ E′ ᵇ│ᶜ .F ]ˡ [ 𝐸 ᵇᶜ│ Q ]ˡ = [ E/E′ (⊖ 𝐸) ᵇ│ᶜ F ]ˡ
   ᶜ│ᶜ-preserves E F [ E′ ᶜ│ᶜ .F ]ˡ [ 𝐸 ᶜᶜ│ Q ]ˡ = [ E/E′ (⊖ 𝐸) ᶜ│ᶜ F ]ˡ
   ᶜ│ᶜ-preserves _ _ [ _ ᶜ│• _ ] [ () ]ˡ
   ᶜ│ᶜ-preserves _ _ [ _ ᶜ│ᵥ _ ] [ () ]ˡ
   ᶜ│ᶜ-preserves _ _ [ _ │ᶜᶜ _ ] [ () ]ˡ
   ᶜ│ᶜ-preserves _ _ [ _ ᵇ│ᶜ ._ ]ˡ [ () ]
   ᶜ│ᶜ-preserves _ _ [ _ │ᵇᶜ _ ]ˡ [ () ]ˡ
   ᶜ│ᶜ-preserves _ _ [ _ │ᶜᶜ _ ]ˡ [ () ]ˡ

   ᶜ│ᶜˡ-preserves : ∀ {Γ} {P Q : Proc Γ} {a a′ a″ R R″ S} {a′⌣a″} {a⌣a″}
                  (E : P —[ a ᶜ - _ ]→ R) (F : Q —[ a′ ᶜ - _ ]→ S) {E″ : P │ Q —[ a″ - _ ]→ R″} →
                  E ᶜ│ Q ⌣[ a′⌣a″ ] E″ → (𝐸″ : P │ᶜ F ⌣[ a⌣a″ ] E″) →
                  E ᶜ│ S ⌣[ /-preserves-ᴬ⌣ ᶜ∇ᶜ a′⌣a″ a⌣a″ ] E′/E (⊖ 𝐸″)
   ᶜ│ᶜˡ-preserves E F [ .E ᶜ│ᶜ F′ ] [ P │ᶜᶜ 𝐹 ] = [ E ᶜ│ᶜ E′/E (⊖ 𝐹) ]
   ᶜ│ᶜˡ-preserves E F [ 𝐸 │•ᶜ F′ ] [ E′ ᶜ│• 𝐹 ] = [ 𝐸 │•ᶜ E′/E (⊖ 𝐹) ]
   ᶜ│ᶜˡ-preserves E F [ 𝐸 │ᵥᶜ F′ ] [ E′ ᶜ│ᵥ 𝐹 ] = [ 𝐸 │ᵥᶜ E′/E (⊖ 𝐹) ]
   ᶜ│ᶜˡ-preserves E F [ .E ᶜ│ᵇ F′ ] [ P │ᵇᶜ 𝐹 ]ˡ = [ E ᶜ│ᵇ E/E′ (⊖ 𝐹) ]
   ᶜ│ᶜˡ-preserves E F [ .E ᶜ│ᶜ F′ ] [ P │ᶜᶜ 𝐹 ]ˡ = [ E ᶜ│ᶜ E/E′ (⊖ 𝐹) ]
   ᶜ│ᶜˡ-preserves E F [ 𝐸 ᶜᶜ│ Q ] [ E′ ᶜ│ᶜ .F ]ˡ = [ 𝐸 ᶜᶜ│ _ ]
   ᶜ│ᶜˡ-preserves E F [ 𝐸 ᵇᶜ│ Q ]ˡ [ E′ ᵇ│ᶜ .F ]ˡ = [ 𝐸 ᵇᶜ│ _ ]ˡ
   ᶜ│ᶜˡ-preserves E F [ 𝐸 ᶜᶜ│ Q ]ˡ [ E′ ᶜ│ᶜ .F ]ˡ = [ ⌣-sym 𝐸 ᶜᶜ│ _ ]
   ᶜ│ᶜˡ-preserves _ _ [ ._ ᶜ│ᵇ _ ] [ () ]
   ᶜ│ᶜˡ-preserves _ _ [ _ ᶜᶜ│ _ ] [ () ]
   ᶜ│ᶜˡ-preserves _ _ [ _ │•ᶜ _ ] [ () ]ˡ
   ᶜ│ᶜˡ-preserves _ _ [ _ │ᵥᶜ _ ] [ () ]ˡ
   ᶜ│ᶜˡ-preserves _ _ [ _ ᵇᶜ│ _ ]ˡ [ () ]
   ᶜ│ᶜˡ-preserves _ _ [ _ ᶜᶜ│ _ ]ˡ [ () ]

   ➕₁-preserves : ∀ {Γ} {P : Proc Γ} {a a′ a″ R R′ R″} {a⌣a′} {a′⌣a″} {a⌣a″}
                  {E : P —[ a - _ ]→ R} {E′ : P —[ a′ - _ ]→ R′} (𝐸 : E ⌣[ a⌣a′ ] E′) (Q : Proc Γ)
                  {E″ : P ➕ Q —[ a″ - _ ]→ R″} → E′ ➕₁ Q ⌣[ a′⌣a″ ] E″ → (𝐸″ : E ➕₁ Q ⌣[ a⌣a″ ] E″) →
                  E′/E (⊖ 𝐸) ⌣[ /-preserves-ᴬ⌣ a⌣a′ a′⌣a″ a⌣a″ ] E′/E (⊖ 𝐸″)
   ➕₁-preserves 𝐸 Q [ 𝐸′ ➕₁ .Q ] [ 𝐸″ ➕₁ .Q ] = /-preserves-⌣ 𝐸 𝐸′ 𝐸″
   ➕₁-preserves 𝐸 Q [ 𝐸′ ➕₁ .Q ] [ _➕₁_ {a⌣a′ = ᵛ∇ᵛ} 𝐸″ .Q ]ˡ = /-preserves-⌣ᴰᴰᵁ 𝐸 𝐸′ 𝐸″
   ➕₁-preserves 𝐸 Q [ 𝐸′ ➕₁ .Q ] [ _➕₁_ {a⌣a′ = ᵇ∇ᵇ} 𝐸″ .Q ]ˡ = /-preserves-⌣ᴰᴰᵁ 𝐸 𝐸′ 𝐸″
   ➕₁-preserves 𝐸 Q [ 𝐸′ ➕₁ .Q ] [ _➕₁_ {a⌣a′ = ᶜ∇ᵇ} 𝐸″ .Q ]ˡ = /-preserves-⌣ᴰᴰᵁ 𝐸 𝐸′ 𝐸″
   ➕₁-preserves 𝐸 Q [ 𝐸′ ➕₁ .Q ] [ _➕₁_ {a⌣a′ = ᵇ∇ᶜ} 𝐸″ .Q ]ˡ = /-preserves-⌣ᴰᴰᵁ 𝐸 𝐸′ 𝐸″
   ➕₁-preserves 𝐸 Q [ 𝐸′ ➕₁ .Q ] [ _➕₁_ {a⌣a′ = ᶜ∇ᶜ} 𝐸″ .Q ]ˡ = /-preserves-⌣ᴰᴰᵁ 𝐸 𝐸′ 𝐸″
   ➕₁-preserves 𝐸 Q [ 𝐸′ ➕₁ .Q ]ˡ [ 𝐸″ ➕₁ .Q ] = /-preserves-⌣ᴰᵁᴰ 𝐸 𝐸′ 𝐸″
   ➕₁-preserves 𝐸 Q [ 𝐸′ ➕₁ .Q ]ˡ [ _➕₁_ {a⌣a′ = ᵛ∇ᵛ} 𝐸″ .Q ]ˡ = /-preserves-⌣ᴰᵁᵁ 𝐸 𝐸′ 𝐸″
   ➕₁-preserves 𝐸 Q [ 𝐸′ ➕₁ .Q ]ˡ [ _➕₁_ {a⌣a′ = ᵇ∇ᵇ} 𝐸″ .Q ]ˡ = /-preserves-⌣ᴰᵁᵁ 𝐸 𝐸′ 𝐸″
   ➕₁-preserves 𝐸 Q [ 𝐸′ ➕₁ .Q ]ˡ [ _➕₁_ {a⌣a′ = ᵇ∇ᶜ} 𝐸″ .Q ]ˡ = /-preserves-⌣ᴰᵁᵁ 𝐸 𝐸′ 𝐸″
   ➕₁-preserves 𝐸 Q [ 𝐸′ ➕₁ .Q ]ˡ [ _➕₁_ {a⌣a′ = ᶜ∇ᵇ} 𝐸″ .Q ]ˡ = /-preserves-⌣ᴰᵁᵁ 𝐸 𝐸′ 𝐸″
   ➕₁-preserves 𝐸 Q [ 𝐸′ ➕₁ .Q ]ˡ [ _➕₁_ {a⌣a′ = ᶜ∇ᶜ} 𝐸″ .Q ]ˡ = /-preserves-⌣ᴰᵁᵁ 𝐸 𝐸′ 𝐸″

   ➕₁ˡ-preserves : ∀ {Γ} {P : Proc Γ} {a a′ a″ R R′ R″} {a⌣a′} {a′⌣a″} {a⌣a″}
                  {E : P —[ a - _ ]→ R} {E′ : P —[ a′ - _ ]→ R′} (𝐸 : E ⌣[ a⌣a′ ] E′) (Q : Proc Γ)
                  {E″ : P ➕ Q —[ a″ - _ ]→ R″} → E ➕₁ Q ⌣[ a′⌣a″ ] E″ → (𝐸″ : E′ ➕₁ Q ⌣[ a⌣a″ ] E″) →
                  E′/E (⊖ [ 𝐸 ➕₁ Q ]ˡ) ⌣[ /-preserves-ᴬ⌣ (ᴬ⌣-sym a⌣a′) a′⌣a″ a⌣a″ ] E′/E (⊖ 𝐸″)
   ➕₁ˡ-preserves {a⌣a′ = ᵛ∇ᵛ} 𝐸 Q [ 𝐸′ ➕₁ .Q ] [ 𝐸″ ➕₁ .Q ] = /-preserves-⌣ᵁᴰᴰ 𝐸 𝐸′ 𝐸″
   ➕₁ˡ-preserves {a⌣a′ = ᵇ∇ᵇ} 𝐸 Q [ 𝐸′ ➕₁ .Q ] [ 𝐸″ ➕₁ .Q ] = /-preserves-⌣ᵁᴰᴰ 𝐸 𝐸′ 𝐸″
   ➕₁ˡ-preserves {a⌣a′ = ᵇ∇ᶜ} 𝐸 Q [ 𝐸′ ➕₁ .Q ] [ 𝐸″ ➕₁ .Q ] = /-preserves-⌣ᵁᴰᴰ 𝐸 𝐸′ 𝐸″
   ➕₁ˡ-preserves {a⌣a′ = ᶜ∇ᵇ} 𝐸 Q [ 𝐸′ ➕₁ .Q ] [ 𝐸″ ➕₁ .Q ] = /-preserves-⌣ᵁᴰᴰ 𝐸 𝐸′ 𝐸″
   ➕₁ˡ-preserves {a⌣a′ = ᶜ∇ᶜ} 𝐸 Q [ 𝐸′ ➕₁ .Q ] [ 𝐸″ ➕₁ .Q ] = /-preserves-⌣ᵁᴰᴰ 𝐸 𝐸′ 𝐸″
   ➕₁ˡ-preserves {a⌣a′ = ᵛ∇ᵛ} 𝐸 Q [ 𝐸′ ➕₁ .Q ] [ _➕₁_ {a⌣a′ = ᵛ∇ᵛ} 𝐸″ .Q ]ˡ = /-preserves-⌣ᵁᴰᵁ 𝐸 𝐸′ 𝐸″
   ➕₁ˡ-preserves {a⌣a′ = ᵛ∇ᵛ} 𝐸 Q [ 𝐸′ ➕₁ .Q ] [ _➕₁_ {a⌣a′ = ᵇ∇ᵇ} 𝐸″ .Q ]ˡ = /-preserves-⌣ᵁᴰᵁ 𝐸 𝐸′ 𝐸″
   ➕₁ˡ-preserves {a⌣a′ = ᵛ∇ᵛ} 𝐸 Q [ 𝐸′ ➕₁ .Q ] [ _➕₁_ {a⌣a′ = ᶜ∇ᵇ} 𝐸″ .Q ]ˡ = /-preserves-⌣ᵁᴰᵁ 𝐸 𝐸′ 𝐸″
   ➕₁ˡ-preserves {a⌣a′ = ᵇ∇ᵇ} 𝐸 Q [ 𝐸′ ➕₁ .Q ] [ _➕₁_ {a⌣a′ = ᵛ∇ᵛ} 𝐸″ .Q ]ˡ = /-preserves-⌣ᵁᴰᵁ 𝐸 𝐸′ 𝐸″
   ➕₁ˡ-preserves {a⌣a′ = ᵇ∇ᵇ} 𝐸 Q [ 𝐸′ ➕₁ .Q ] [ _➕₁_ {a⌣a′ = ᵇ∇ᵇ} 𝐸″ .Q ]ˡ = /-preserves-⌣ᵁᴰᵁ 𝐸 𝐸′ 𝐸″
   ➕₁ˡ-preserves {a⌣a′ = ᵇ∇ᵇ} 𝐸 Q [ 𝐸′ ➕₁ .Q ] [ _➕₁_ {a⌣a′ = ᶜ∇ᵇ} 𝐸″ .Q ]ˡ = /-preserves-⌣ᵁᴰᵁ 𝐸 𝐸′ 𝐸″
   ➕₁ˡ-preserves {a⌣a′ = ᵇ∇ᶜ} 𝐸 Q [ 𝐸′ ➕₁ .Q ] [ _➕₁_ {a⌣a′ = ᵇ∇ᶜ} 𝐸″ .Q ]ˡ = /-preserves-⌣ᵁᴰᵁ 𝐸 𝐸′ 𝐸″
   ➕₁ˡ-preserves {a⌣a′ = ᵇ∇ᶜ} 𝐸 Q [ 𝐸′ ➕₁ .Q ] [ _➕₁_ {a⌣a′ = ᶜ∇ᶜ} 𝐸″ .Q ]ˡ = /-preserves-⌣ᵁᴰᵁ 𝐸 𝐸′ 𝐸″
   ➕₁ˡ-preserves {a⌣a′ = ᶜ∇ᵇ} 𝐸 Q [ 𝐸′ ➕₁ .Q ] [ _➕₁_ {a⌣a′ = ᵛ∇ᵛ} 𝐸″ .Q ]ˡ = /-preserves-⌣ᵁᴰᵁ 𝐸 𝐸′ 𝐸″
   ➕₁ˡ-preserves {a⌣a′ = ᶜ∇ᵇ} 𝐸 Q [ 𝐸′ ➕₁ .Q ] [ _➕₁_ {a⌣a′ = ᵇ∇ᵇ} 𝐸″ .Q ]ˡ = /-preserves-⌣ᵁᴰᵁ 𝐸 𝐸′ 𝐸″
   ➕₁ˡ-preserves {a⌣a′ = ᶜ∇ᵇ} 𝐸 Q [ 𝐸′ ➕₁ .Q ] [ _➕₁_ {a⌣a′ = ᶜ∇ᵇ} 𝐸″ .Q ]ˡ = /-preserves-⌣ᵁᴰᵁ 𝐸 𝐸′ 𝐸″
   ➕₁ˡ-preserves {a⌣a′ = ᶜ∇ᶜ} 𝐸 Q [ 𝐸′ ➕₁ .Q ] [ _➕₁_ {a⌣a′ = ᵇ∇ᶜ} 𝐸″ .Q ]ˡ = /-preserves-⌣ᵁᴰᵁ 𝐸 𝐸′ 𝐸″
   ➕₁ˡ-preserves {a⌣a′ = ᶜ∇ᶜ} 𝐸 Q [ 𝐸′ ➕₁ .Q ] [ _➕₁_ {a⌣a′ = ᶜ∇ᶜ} 𝐸″ .Q ]ˡ = /-preserves-⌣ᵁᴰᵁ 𝐸 𝐸′ 𝐸″
   ➕₁ˡ-preserves {a⌣a′ = ᵛ∇ᵛ} 𝐸 Q [ 𝐸′ ➕₁ .Q ]ˡ [ 𝐸″ ➕₁ .Q ] = /-preserves-⌣ᵁᵁᴰ 𝐸 𝐸′ 𝐸″
   ➕₁ˡ-preserves {a⌣a′ = ᵇ∇ᵇ} 𝐸 Q [ 𝐸′ ➕₁ .Q ]ˡ [ 𝐸″ ➕₁ .Q ] = /-preserves-⌣ᵁᵁᴰ 𝐸 𝐸′ 𝐸″
   ➕₁ˡ-preserves {a⌣a′ = ᵇ∇ᶜ} 𝐸 Q [ 𝐸′ ➕₁ .Q ]ˡ [ 𝐸″ ➕₁ .Q ] = /-preserves-⌣ᵁᵁᴰ 𝐸 𝐸′ 𝐸″
   ➕₁ˡ-preserves {a⌣a′ = ᶜ∇ᵇ} 𝐸 Q [ 𝐸′ ➕₁ .Q ]ˡ [ 𝐸″ ➕₁ .Q ] = /-preserves-⌣ᵁᵁᴰ 𝐸 𝐸′ 𝐸″
   ➕₁ˡ-preserves {a⌣a′ = ᶜ∇ᶜ} 𝐸 Q [ 𝐸′ ➕₁ .Q ]ˡ [ 𝐸″ ➕₁ .Q ] = /-preserves-⌣ᵁᵁᴰ 𝐸 𝐸′ 𝐸″
   ➕₁ˡ-preserves {a⌣a′ = ᵛ∇ᵛ} 𝐸 Q [ 𝐸′ ➕₁ .Q ]ˡ [ _➕₁_ {a⌣a′ = ᵛ∇ᵛ} 𝐸″ .Q ]ˡ = /-preserves-⌣ᵁᵁᵁ 𝐸 𝐸′ 𝐸″
   ➕₁ˡ-preserves {a⌣a′ = ᵇ∇ᵇ} 𝐸 Q [ 𝐸′ ➕₁ .Q ]ˡ [ _➕₁_ {a⌣a′ = ᵛ∇ᵛ} 𝐸″ .Q ]ˡ = /-preserves-⌣ᵁᵁᵁ 𝐸 𝐸′ 𝐸″
   ➕₁ˡ-preserves {a⌣a′ = ᶜ∇ᵇ} 𝐸 Q [ 𝐸′ ➕₁ .Q ]ˡ [ _➕₁_ {a⌣a′ = ᵛ∇ᵛ} 𝐸″ .Q ]ˡ = /-preserves-⌣ᵁᵁᵁ 𝐸 𝐸′ 𝐸″
   ➕₁ˡ-preserves {a⌣a′ = ᵛ∇ᵛ} 𝐸 Q [ 𝐸′ ➕₁ .Q ]ˡ [ _➕₁_ {a⌣a′ = ᵇ∇ᵇ} 𝐸″ .Q ]ˡ = /-preserves-⌣ᵁᵁᵁ 𝐸 𝐸′ 𝐸″
   ➕₁ˡ-preserves {a⌣a′ = ᵇ∇ᵇ} 𝐸 Q [ 𝐸′ ➕₁ .Q ]ˡ [ _➕₁_ {a⌣a′ = ᵇ∇ᵇ} 𝐸″ .Q ]ˡ = /-preserves-⌣ᵁᵁᵁ 𝐸 𝐸′ 𝐸″
   ➕₁ˡ-preserves {a⌣a′ = ᶜ∇ᵇ} 𝐸 Q [ 𝐸′ ➕₁ .Q ]ˡ [ _➕₁_ {a⌣a′ = ᵇ∇ᵇ} 𝐸″ .Q ]ˡ = /-preserves-⌣ᵁᵁᵁ 𝐸 𝐸′ 𝐸″
   ➕₁ˡ-preserves {a⌣a′ = ᵇ∇ᶜ} 𝐸 Q [ 𝐸′ ➕₁ .Q ]ˡ [ _➕₁_ {a⌣a′ = ᵇ∇ᶜ} 𝐸″ .Q ]ˡ = /-preserves-⌣ᵁᵁᵁ 𝐸 𝐸′ 𝐸″
   ➕₁ˡ-preserves {a⌣a′ = ᶜ∇ᶜ} 𝐸 Q [ 𝐸′ ➕₁ .Q ]ˡ [ _➕₁_ {a⌣a′ = ᵇ∇ᶜ} 𝐸″ .Q ]ˡ = /-preserves-⌣ᵁᵁᵁ 𝐸 𝐸′ 𝐸″
   ➕₁ˡ-preserves {a⌣a′ = ᵛ∇ᵛ} 𝐸 Q [ 𝐸′ ➕₁ .Q ]ˡ [ _➕₁_ {a⌣a′ = ᶜ∇ᵇ} 𝐸″ .Q ]ˡ = /-preserves-⌣ᵁᵁᵁ 𝐸 𝐸′ 𝐸″
   ➕₁ˡ-preserves {a⌣a′ = ᵇ∇ᵇ} 𝐸 Q [ 𝐸′ ➕₁ .Q ]ˡ [ _➕₁_ {a⌣a′ = ᶜ∇ᵇ} 𝐸″ .Q ]ˡ = /-preserves-⌣ᵁᵁᵁ 𝐸 𝐸′ 𝐸″
   ➕₁ˡ-preserves {a⌣a′ = ᶜ∇ᵇ} 𝐸 Q [ 𝐸′ ➕₁ .Q ]ˡ [ _➕₁_ {a⌣a′ = ᶜ∇ᵇ} 𝐸″ .Q ]ˡ = /-preserves-⌣ᵁᵁᵁ 𝐸 𝐸′ 𝐸″
   ➕₁ˡ-preserves {a⌣a′ = ᵇ∇ᶜ} 𝐸 Q [ 𝐸′ ➕₁ .Q ]ˡ [ _➕₁_ {a⌣a′ = ᶜ∇ᶜ} 𝐸″ .Q ]ˡ = /-preserves-⌣ᵁᵁᵁ 𝐸 𝐸′ 𝐸″
   ➕₁ˡ-preserves {a⌣a′ = ᶜ∇ᶜ} 𝐸 Q [ 𝐸′ ➕₁ .Q ]ˡ [ _➕₁_ {a⌣a′ = ᶜ∇ᶜ} 𝐸″ .Q ]ˡ = /-preserves-⌣ᵁᵁᵁ 𝐸 𝐸′ 𝐸″

   ᵇ│•-preserves : ∀ {Γ} {P Q : Proc Γ} {a a″ x y R R″ S S′} {a′⌣a″} {a⌣a″}
                  (E : P —[ (x •) ᵇ - ∞ ]→ R) {F : Q —[ a ᵇ - _ ]→ S} {F′ : Q —[ • x 〈 y 〉 ᶜ - _ ]→ S′}
                  (𝐹 : F ⌣[ ᵇ∇ᶜ] F′) {E″ : P │ Q —[ a″ - _ ]→ R″} → E │• F′ ⌣[ a′⌣a″ ] E″ → (𝐸″ : P │ᵇ F ⌣[ a⌣a″ ] E″) →
                  (push *ᵇ) E │• E′/E (⊖ 𝐹) ⌣[ /-preserves-ᴬ⌣ ᵇ∇ᶜ a′⌣a″ a⌣a″ ] E′/E (⊖ 𝐸″)
   ᵇ│•-preserves E 𝐹 [ 𝐸 │• 𝐹′ ] [ E′ ᵇ│• 𝐹″ ] = [ (push *ᵇᵇ⌣) 𝐸 │• /-preserves-⌣ 𝐹 𝐹′ 𝐹″ ]
   ᵇ│•-preserves E 𝐹 [ .E ᵇ│• 𝐹′ ]ˡ [ _│ᵇᵇ_ {a⌣a′ = ᵇ∇ᵇ} P 𝐹″ ] = [ (push *ᵇ) E ᵇ│• /-preserves-⌣ 𝐹″ 𝐹′ 𝐹 ]ˡ
   ᵇ│•-preserves E 𝐹 [ .E ᵇ│• 𝐹′ ]ˡ [ _│ᵇᵇ_ {a⌣a′ = ᵛ∇ᵛ} P 𝐹″ ] = [ (push *ᵇ) E ᶜ│• /-preserves-⌣ 𝐹″ 𝐹′ 𝐹 ]ˡ
   ᵇ│•-preserves E 𝐹 [ .E ᶜ│• 𝐹′ ]ˡ [ P │ᵇᶜ 𝐹″ ] = [ (push *ᵇ) E ᶜ│• /-preserves-⌣ 𝐹″ 𝐹′ 𝐹 ]ˡ
   ᵇ│•-preserves E 𝐹 [ 𝐸 │• 𝐹′ ]ˡ [ E′ ᵇ│• 𝐹″ ] = [ (push *ᵇᵇ⌣) (⌣-sym 𝐸) │• /-preserves-⌣ᴰᵁᴰ 𝐹 𝐹′ 𝐹″ ]
   ᵇ│•-preserves E 𝐹 [ 𝐸 │ᵥ• 𝐹′ ]ˡ [ _ᵇ│ᵥ_ {a⌣a′ = ᵇ∇ᵇ} E′ 𝐹″ ] = [ (push *ᵇᵇ⌣) 𝐸 │ᵥ• ⌣-sym (/-preserves-⌣ᴰᵁᴰ 𝐹 𝐹′ 𝐹″) ]ˡ
   ᵇ│•-preserves E 𝐹 [ 𝐸 │ᵥ• 𝐹′ ]ˡ [ _ᵇ│ᵥ_ {a⌣a′ = ᵛ∇ᵛ} E′ 𝐹″ ] = [ (push *ᵇᵇ⌣) (⌣-sym 𝐸) │• /-preserves-⌣ᴰᵁᴰ 𝐹 𝐹′ 𝐹″ ]
   ᵇ│•-preserves E 𝐹 [ 𝐸 │•ᵇ F′ ]ˡ [ E′ ᵇ│ᵇ F ]ˡ = [ (push *ᵇᵇ⌣) 𝐸 │•ᵇ E′/E (⊖ 𝐹) ]ˡ
   ᵇ│•-preserves E 𝐹 [ 𝐸 │•ᶜ F′ ]ˡ [ E′ ᶜ│ᵇ F ]ˡ = [ (push *ᶜᵇ⌣) 𝐸 │•ᶜ E′/E (⊖ 𝐹) ]ˡ
   ᵇ│•-preserves E 𝐹 [ .E ᵇ│• 𝐹′ ]ˡ [ _│ᵇᵇ_ {a⌣a′ = ᵇ∇ᵇ} P 𝐹″ ]ˡ = [ (push *ᵇ) E ᵇ│• /-preserves-⌣ᵁᴰᴰ 𝐹″ 𝐹′ 𝐹 ]ˡ
   ᵇ│•-preserves E 𝐹 [ .E ᵇ│• 𝐹′ ]ˡ [ _│ᵇᵇ_ {a⌣a′ = ᵛ∇ᵛ} P 𝐹″ ]ˡ = [ (push *ᵇ) E ᶜ│• /-preserves-⌣ᵁᴰᴰ 𝐹″ 𝐹′ 𝐹 ]ˡ
   ᵇ│•-preserves _ _ [ _ │• _ ] [ () ]ˡ
   ᵇ│•-preserves _ _ [ _ │•ᵇ _ ]ˡ [ () ]
   ᵇ│•-preserves _ _ [ _ │•ᶜ _ ]ˡ [ () ]
   ᵇ│•-preserves _ _ [ ._ ᶜ│• _ ]ˡ [ () ]ˡ
   ᵇ│•-preserves _ _ [ _ │• _ ]ˡ [ () ]ˡ
   ᵇ│•-preserves _ _ [ _ │ᵥ• _ ]ˡ [ () ]ˡ

   ᵇ│•ˡ-preserves : ∀ {Γ} {P Q : Proc Γ} {a a″ x y R R″ S S′} {a′⌣a″} {a⌣a″}
                   (E : P —[ (x •) ᵇ - ∞ ]→ R) {F : Q —[ a ᵇ - _ ]→ S} {F′ : Q —[ • x 〈 y 〉 ᶜ - _ ]→ S′}
                   (𝐹 : F ⌣[ ᵇ∇ᶜ ] F′) {E″ : P │ Q —[ a″ - _ ]→ R″} → P │ᵇ F ⌣[ a′⌣a″ ] E″ → (𝐸″ : E │• F′ ⌣[ a⌣a″ ] E″) →
                   (pop y *) R │ᵇ E/E′ (⊖ 𝐹) ⌣[ /-preserves-ᴬ⌣ ᶜ∇ᵇ a′⌣a″ a⌣a″ ] E′/E (⊖ 𝐸″)
   ᵇ│•ˡ-preserves E₁ 𝐹 [ E ᵇ│• 𝐹′ ] [ _│•_ {y = y} 𝐸 𝐹″ ] = [ (pop y *ᵇ) (E′/E (⊖ 𝐸)) ᵇ│• /-preserves-⌣ᵁᴰᴰ 𝐹 𝐹′ 𝐹″ ]
   ᵇ│•ˡ-preserves E 𝐹 [ _ᵇ│•_ E′ 𝐹′ ] [ _│•_ {z = y} 𝐸 𝐹″ ]ˡ = [ (pop y *ᵇ) (E/E′ (⊖ 𝐸)) ᵇ│• /-preserves-⌣ᵁᴰᵁ 𝐹 𝐹′ 𝐹″ ]
   ᵇ│•ˡ-preserves E 𝐹 [ E′ ᵇ│ᵥ 𝐹′ ] [ _│ᵥ•_ {y = y} 𝐸 𝐹″ ]ˡ = [ (pop y *ᵇ) (E/E′ (⊖ 𝐸)) ᵇ│ᵥ /-preserves-⌣ᵁᴰᵁ 𝐹 𝐹′ 𝐹″ ]
   ᵇ│•ˡ-preserves E 𝐹 [ _│ᵇᵇ_ {a⌣a′ = ᵇ∇ᵇ} P 𝐹′ ] [ _ᵇ│•_ {y = y} .E 𝐹″ ]ˡ = [ (pop y *) _ │ᵇᵇ /-preserves-⌣ᵁᴰᵁ 𝐹 𝐹′ 𝐹″ ]
   ᵇ│•ˡ-preserves E 𝐹 [ _│ᵇᵇ_ {a⌣a′ = ᵛ∇ᵛ} P 𝐹′ ] [ _ᵇ│•_ {y = y} .E 𝐹″ ]ˡ = [ (pop y *) _ │ᵇᵇ /-preserves-⌣ᵁᴰᵁ 𝐹 𝐹′ 𝐹″ ]
   ᵇ│•ˡ-preserves E 𝐹 [ P │ᵇᶜ 𝐹′ ] [ _ᶜ│•_ {y = y} .E 𝐹″ ]ˡ = [ (pop y *) _ │ᵇᶜ /-preserves-⌣ᵁᴰᵁ 𝐹 𝐹′ 𝐹″ ]
   ᵇ│•ˡ-preserves E 𝐹 [ E′ ᵇ│ᵇ F ]ˡ [ _│•ᵇ_ {y = y} {a = a} 𝐸 F′ ]ˡ with (pop y *ᵇ) (E/E′ (⊖ 𝐸))
   ... | pop-y*E′/E rewrite pop∘push y a = [ pop-y*E′/E ᵇ│ᵇ E/E′ (⊖ 𝐹) ]ˡ
   ᵇ│•ˡ-preserves E 𝐹 [ E′ ᶜ│ᵇ F ]ˡ [ _│•ᶜ_ {y = y} {a = a} 𝐸 F′ ]ˡ with (pop y *ᶜ) (E/E′ (⊖ 𝐸))
   ... | pop-y*E′/E rewrite pop∘push y a = [ pop-y*E′/E ᶜ│ᵇ E/E′ (⊖ 𝐹) ]ˡ
   ᵇ│•ˡ-preserves E 𝐹 [ _│ᵇᵇ_ {a⌣a′ = ᵇ∇ᵇ} P 𝐹′ ]ˡ [ _ᵇ│•_ {y = y} .E 𝐹″ ]ˡ = [ (pop y *) _ │ᵇᵇ /-preserves-⌣ᵁᵁᵁ 𝐹 𝐹′ 𝐹″ ]
   ᵇ│•ˡ-preserves E 𝐹 [ _│ᵇᵇ_ {a⌣a′ = ᵛ∇ᵛ} P 𝐹′ ]ˡ [ _ᵇ│•_ {y = y} .E 𝐹″ ]ˡ = [ (pop y *) _ │ᵇᵇ /-preserves-⌣ᵁᵁᵁ 𝐹 𝐹′ 𝐹″ ]
   ᵇ│•ˡ-preserves _ _ [ _ ᵇ│ᵥ _ ] [ () ]
   ᵇ│•ˡ-preserves _ _ [ _ │ᵇᵇ _ ] [ () ]
   ᵇ│•ˡ-preserves _ _ [ _ │ᵇᶜ _ ] [ () ]
   ᵇ│•ˡ-preserves _ _ [ _ ᵇ│ᵇ _ ]ˡ [ () ]
   ᵇ│•ˡ-preserves _ _ [ _ ᶜ│ᵇ _ ]ˡ [ () ]
   ᵇ│•ˡ-preserves _ _ [ _ │ᵇᵇ _ ]ˡ [ () ]

   ᶜ│•-preserves : ∀ {Γ} {P Q : Proc Γ} {a a″ x y R R″ S S′} {a′⌣a″} {a⌣a″}
                  (E : P —[ (x •) ᵇ - ∞ ]→ R) {F : Q —[ a ᶜ - _ ]→ S} {F′ : Q —[ • x 〈 y 〉 ᶜ - _ ]→ S′}
                  (𝐹 : Concur F F′ ᶜ∇ᶜ) {E″ : P │ Q —[ a″ - _ ]→ R″} → E │• F′ ⌣[ a′⌣a″ ] E″ → (𝐸″ : P │ᶜ F ⌣[ a⌣a″ ] E″) →
                  E │• E′/E (⊖ 𝐹) ⌣[ /-preserves-ᴬ⌣ ᶜ∇ᶜ a′⌣a″ a⌣a″ ] E′/E (⊖ 𝐸″)
   ᶜ│•-preserves E 𝐹 [ 𝐸 │• 𝐹′ ] [ E′ ᶜ│• 𝐹″ ] = [ 𝐸 │• /-preserves-⌣ 𝐹 𝐹′ 𝐹″ ]
   ᶜ│•-preserves E 𝐹 [ .E ᶜ│• 𝐹′ ]ˡ [ P │ᶜᶜ 𝐹″ ] = [ E ᶜ│• ⌣-sym (/-preserves-⌣ᴰᵁᴰ 𝐹 𝐹′ 𝐹″) ]ˡ
   ᶜ│•-preserves E 𝐹 [ 𝐸 │• 𝐹′ ]ˡ [ E′ ᶜ│• 𝐹″ ] = [ ⌣-sym 𝐸 │• /-preserves-⌣ᴰᵁᴰ 𝐹 𝐹′ 𝐹″ ]
   ᶜ│•-preserves E 𝐹 [ 𝐸 │ᵥ• 𝐹′ ]ˡ [ E′ ᶜ│ᵥ 𝐹″ ] = [ 𝐸 │ᵥ• ⌣-sym (/-preserves-⌣ᴰᵁᴰ 𝐹 𝐹′ 𝐹″) ]ˡ
   ᶜ│•-preserves E 𝐹 [ 𝐸 │•ᵇ F′ ]ˡ [ E′ ᵇ│ᶜ F ]ˡ = [ 𝐸 │•ᵇ E′/E (⊖ 𝐹) ]ˡ
   ᶜ│•-preserves E 𝐹 [ 𝐸 │•ᶜ F′ ]ˡ [ E′ ᶜ│ᶜ F ]ˡ = [ 𝐸 │•ᶜ E′/E (⊖ 𝐹) ]ˡ
   ᶜ│•-preserves E 𝐹 [ .E ᵇ│• 𝐹′ ]ˡ [ P │ᵇᶜ 𝐹″ ]ˡ = [ E ᵇ│• /-preserves-⌣ᵁᴰᴰ 𝐹″ 𝐹′ 𝐹 ]ˡ
   ᶜ│•-preserves E 𝐹 [ .E ᶜ│• 𝐹′ ]ˡ [ P │ᶜᶜ 𝐹″ ]ˡ = [ E ᶜ│• /-preserves-⌣ᵁᴰᴰ 𝐹″ 𝐹′ 𝐹 ]ˡ
   ᶜ│•-preserves _ _ [ _ │• _ ] [ () ]ˡ
   ᶜ│•-preserves _ _ [ _ │•ᵇ _ ]ˡ [ () ]
   ᶜ│•-preserves _ _ [ _ │•ᶜ _ ]ˡ [ () ]
   ᶜ│•-preserves _ _ [ ._ ᵇ│• _ ]ˡ [ () ]
   ᶜ│•-preserves _ _ [ _ │• _ ]ˡ [ () ]ˡ
   ᶜ│•-preserves _ _ [ _ │ᵥ• _ ]ˡ [ () ]ˡ

   ᶜ│•ˡ-preserves : ∀ {Γ} {P Q : Proc Γ} {a a″ x y R R″ S S′} {a′⌣a″} {a⌣a″}
                   (E : P —[ (x •) ᵇ - ∞ ]→ R) {F : Q —[ a ᶜ - _ ]→ S} {F′ : Q —[ • x 〈 y 〉 ᶜ - _ ]→ S′}
                   (𝐹 : F ⌣[ ᶜ∇ᶜ ] F′) {E″ : P │ Q —[ a″ - _ ]→ R″} → P │ᶜ F ⌣[ a′⌣a″ ] E″ → (𝐸″ : E │• F′ ⌣[ a⌣a″ ] E″) →
                   (pop y *) R │ᶜ E/E′ (⊖ 𝐹) ⌣[ /-preserves-ᴬ⌣ ᶜ∇ᶜ a′⌣a″ a⌣a″ ] E′/E (⊖ 𝐸″)
   ᶜ│•ˡ-preserves E 𝐹 [ E′ ᶜ│• 𝐹′ ] [ _│•_ {y = y} 𝐸 𝐹″ ] = [ (pop y *ᵇ) (E′/E (⊖ 𝐸)) ᶜ│• /-preserves-⌣ᵁᴰᴰ 𝐹 𝐹′ 𝐹″ ]
   ᶜ│•ˡ-preserves E 𝐹 [ E′ ᶜ│• 𝐹′ ] [ _│•_ {z = y} 𝐸 𝐹″ ]ˡ = [ (pop y *ᵇ) (E/E′ (⊖ 𝐸)) ᶜ│• /-preserves-⌣ᵁᴰᵁ 𝐹 𝐹′ 𝐹″ ]
   ᶜ│•ˡ-preserves E 𝐹 [ E′ ᶜ│ᵥ 𝐹′ ] [ _│ᵥ•_ {y = y} 𝐸 𝐹″ ]ˡ = [ (pop y *ᵇ) (E/E′ (⊖ 𝐸)) ᶜ│ᵥ /-preserves-⌣ᵁᴰᵁ 𝐹 𝐹′ 𝐹″ ]
   ᶜ│•ˡ-preserves E 𝐹 [ P │ᶜᶜ 𝐹′ ] [ _ᶜ│•_ {y = y} .E 𝐹″ ]ˡ = [ (pop y *) _ │ᶜᶜ /-preserves-⌣ᵁᴰᵁ 𝐹 𝐹′ 𝐹″ ]
   ᶜ│•ˡ-preserves E 𝐹 [ E′ ᵇ│ᶜ F ]ˡ [ _│•ᵇ_ {y = y} {a = a} 𝐸 F′ ]ˡ with (pop y *ᵇ) (E/E′ (⊖ 𝐸))
   ... | pop-y*E′/E rewrite pop∘push y a = [ pop-y*E′/E ᵇ│ᶜ E/E′ (⊖ 𝐹) ]ˡ
   ᶜ│•ˡ-preserves E 𝐹 [ E′ ᶜ│ᶜ F ]ˡ [ _│•ᶜ_ {y = y} {a = a} 𝐸 F′ ]ˡ with (pop y *ᶜ) (E/E′ (⊖ 𝐸))
   ... | pop-y*E′/E rewrite pop∘push y a = [ pop-y*E′/E ᶜ│ᶜ E/E′ (⊖ 𝐹) ]ˡ
   ᶜ│•ˡ-preserves E 𝐹 [ P │ᵇᶜ 𝐹′ ]ˡ [ _ᵇ│•_ {y = y} .E 𝐹″ ]ˡ = [ (pop y *) _ │ᵇᶜ ⌣-sym (/-preserves-⌣ᵁᵁᵁ 𝐹 𝐹′ 𝐹″) ]ˡ
   ᶜ│•ˡ-preserves E 𝐹 [ P │ᶜᶜ 𝐹′ ]ˡ [ _ᶜ│•_ {y = y} .E 𝐹″ ]ˡ = [ (pop y *) _ │ᶜᶜ /-preserves-⌣ᵁᵁᵁ 𝐹 𝐹′ 𝐹″ ]
   ᶜ│•ˡ-preserves _ _ [ _ ᶜ│ᵥ _ ] [ () ]
   ᶜ│•ˡ-preserves _ _ [ _ │ᶜᶜ _ ] [ () ]
   ᶜ│•ˡ-preserves _ _ [ _ ᵇ│ᶜ _ ]ˡ [ () ]
   ᶜ│•ˡ-preserves _ _ [ _ ᶜ│ᶜ _ ]ˡ [ () ]
   ᶜ│•ˡ-preserves _ _ [ _ │ᵇᶜ _ ]ˡ [ () ]
   ᶜ│•ˡ-preserves _ _ [ _ │ᶜᶜ _ ]ˡ [ () ]

   │•ᵇ-preserves : ∀ {Γ} {P Q : Proc Γ} {a a″ x y R R′ R″ S} {a′⌣a″} {a⌣a″}
                  {E : P —[ a ᵇ - _ ]→ R} {E′ : P —[ (x •) ᵇ - _ ]→ R′} {E″ : P │ Q —[ a″ - _ ]→ R″}
                  (𝐸 : E ⌣[ ᵇ∇ᵇ ] E′) (F : Q —[ • x 〈 y 〉 ᶜ - _ ]→ S) → E′ │• F ⌣[ a′⌣a″ ] E″ → (𝐸″ : E ᵇ│ Q ⌣[ a⌣a″ ] E″) →
                  E′/E (⊖ 𝐸) │• (push *ᶜ) F ⌣[ /-preserves-ᴬ⌣ ᵇ∇ᶜ a′⌣a″ a⌣a″ ] E′/E (⊖ 𝐸″)
   │•ᵇ-preserves 𝐸 F [ _│•_ {z = z} 𝐸′ 𝐹 ] [ _│•ᵇ_ {a = a} 𝐸″ F′ ] with (pop z *ᵇ) (E/E′ (⊖ 𝐸″))
   ... | _ rewrite pop∘push z a = [ /-preserves-⌣ 𝐸 𝐸′ 𝐸″ │• (push *ᶜᶜ⌣) 𝐹 ]
   │•ᵇ-preserves 𝐸 F [ 𝐸′ │•ᵇ .F ]ˡ [ _ᵇᵇ│_ {a⌣a′ = ᵇ∇ᵇ} 𝐸″ Q ] = [ /-preserves-⌣ 𝐸″ 𝐸′ 𝐸 │•ᵇ (push *ᶜ) F ]ˡ
   │•ᵇ-preserves 𝐸 F [ 𝐸′ │•ᵇ .F ]ˡ [ _ᵇᵇ│_ {a⌣a′ = ᵛ∇ᵛ} 𝐸″ Q ] = [ /-preserves-⌣ 𝐸″ 𝐸′ 𝐸 │•ᶜ (push *ᶜ) F ]ˡ
   │•ᵇ-preserves 𝐸 F [ 𝐸′ │•ᶜ .F ]ˡ [ 𝐸″ ᵇᶜ│ Q ] = [ /-preserves-⌣ 𝐸″ 𝐸′ 𝐸 │•ᶜ (push *ᶜ) F ]ˡ
   │•ᵇ-preserves 𝐸 F [ E′ ᵇ│• 𝐹 ]ˡ [ E ᵇ│ᵇ F′ ] = [ E′/E (⊖ 𝐸) ᵇ│• (push *ᵇᶜ⌣) 𝐹 ]ˡ
   │•ᵇ-preserves 𝐸 F [ E′ ᶜ│• 𝐹 ]ˡ [ E ᵇ│ᶜ F′ ] = [ E′/E (⊖ 𝐸) ᶜ│• (push *ᶜᶜ⌣) 𝐹 ]ˡ
   │•ᵇ-preserves 𝐸 F [ _│•_ {y = y} 𝐸′ 𝐹 ]ˡ [ _│•ᵇ_ {a = a} 𝐸″ F′ ] with (pop y *ᵇ) (E/E′ (⊖ 𝐸″))
   ... | _ rewrite pop∘push y a = [ /-preserves-⌣ᴰᵁᴰ 𝐸 𝐸′ 𝐸″ │• (push *ᶜᶜ⌣) (⌣-sym 𝐹) ]
   │•ᵇ-preserves 𝐸 F [ 𝐸′ │ᵥ• 𝐹 ]ˡ [ 𝐸″ │ᵥᵇ F′ ] = [ /-preserves-⌣ 𝐸″ 𝐸′ 𝐸 │ᵥ• (push *ᵇᶜ⌣) 𝐹 ]ˡ
   │•ᵇ-preserves 𝐸 F [ 𝐸′ │•ᵇ .F ]ˡ [ _ᵇᵇ│_ {a⌣a′ = ᵇ∇ᵇ} 𝐸″ Q ]ˡ = [ /-preserves-⌣ᵁᴰᴰ 𝐸″ 𝐸′ 𝐸 │•ᵇ (push *ᶜ) F ]ˡ
   │•ᵇ-preserves 𝐸 F [ 𝐸′ │•ᵇ .F ]ˡ [ _ᵇᵇ│_ {a⌣a′ = ᵛ∇ᵛ} 𝐸″ Q ]ˡ = [ /-preserves-⌣ᵁᴰᴰ 𝐸″ 𝐸′ 𝐸 │•ᶜ (push *ᶜ) F ]ˡ
   │•ᵇ-preserves _ _ [ _ │• _ ] [ () ]ˡ
   │•ᵇ-preserves _ _ [ _ │•ᶜ ._ ]ˡ [ () ]ˡ
   │•ᵇ-preserves _ _ [ _ ᵇ│• _ ]ˡ [ () ]ˡ
   │•ᵇ-preserves _ _ [ _ ᶜ│• _ ]ˡ [ () ]ˡ
   │•ᵇ-preserves _ _ [ _ │• _ ]ˡ [ () ]ˡ
   │•ᵇ-preserves _ _ [ _ │ᵥ• _ ]ˡ [ () ]ˡ
-}
...
{-
   ...
   /-preserves-⌣ [ E ᶜ│ᵇ F ] = ᶜ│ᵇ-preserves E F
   /-preserves-⌣ [ E ᶜ│ᵇ F ]ˡ = ᶜ│ᵇˡ-preserves E F
   /-preserves-⌣ [ E ᶜ│ᶜ F ] = ᶜ│ᶜ-preserves E F
   /-preserves-⌣ [ E ᶜ│ᶜ F ]ˡ = ᶜ│ᶜˡ-preserves E F
   /-preserves-⌣ [ 𝐸 ➕₁ Q ] = ➕₁-preserves 𝐸 Q
   /-preserves-⌣ [ 𝐸 ➕₁ Q ]ˡ = ➕₁ˡ-preserves 𝐸 Q
   /-preserves-⌣ [ E ᵇ│• 𝐹 ] = ᵇ│•-preserves E 𝐹
   /-preserves-⌣ [ E ᵇ│• 𝐹 ]ˡ = ᵇ│•ˡ-preserves E 𝐹
   /-preserves-⌣ [ E ᶜ│• 𝐹 ] = ᶜ│•-preserves E 𝐹
   /-preserves-⌣ [ E ᶜ│• 𝐹 ]ˡ = ᶜ│•ˡ-preserves E 𝐹
   /-preserves-⌣ [ _│•ᵇ_ {y = y} {a = a} 𝐸 F ] with (pop y *ᵇ) (E/E′ (⊖ 𝐸))
   ... | _ rewrite pop∘push y a = │•ᵇ-preserves 𝐸 F
-}

   /-preserves-⌣ [ _│•ᵇ_ {y = y} {a = a} 𝐸 F ]ˡ [ 𝐸′ │•ᵇ F′ ] [ 𝐸″ │• 𝐹 ]
      with (pop y *ᵇ) (E/E′ (⊖ 𝐸)) | (pop y *ᵇᵇ⌣) (/-preserves-⌣ᵁᴰᴰ 𝐸 𝐸′ 𝐸″)
   ... | _ | pop-y*𝐸′/E′ rewrite pop∘push y a = [ pop-y*𝐸′/E′ │•ᵇ E′/E (⊖ 𝐹) ]
   /-preserves-⌣ [ _│•ᵇ_ {y = y} {a = a} 𝐸 F ]ˡ [ E ᵇ│ᵇ F′ ] [ E′ ᵇ│• 𝐹 ]ˡ with (pop y *ᵇ) (E/E′ (⊖ 𝐸))
   ... | pop-y*E/E′ rewrite pop∘push y a = [ pop-y*E/E′ ᵇ│ᵇ E/E′ (⊖ 𝐹) ]
   /-preserves-⌣ [ _│•ᵇ_ {y = y} {a = a} 𝐸 F ]ˡ [ E ᵇ│ᶜ F′ ] [ E′ ᶜ│• 𝐹 ]ˡ with (pop y *ᵇ) (E/E′ (⊖ 𝐸))
   ... | pop-y*E/E′ rewrite pop∘push y a = [ pop-y*E/E′ ᵇ│ᶜ (E/E′ (⊖ 𝐹)) ]
   /-preserves-⌣ [ _│•ᵇ_ {y = y} {a = a} 𝐸 F ]ˡ [ 𝐸′ │•ᵇ F′ ] [ 𝐸″ │• 𝐹 ]ˡ
      with (pop y *ᵇ) (E/E′ (⊖ 𝐸)) | (pop y *ᵇᵇ⌣) (/-preserves-⌣ᵁᴰᵁ 𝐸 𝐸′ 𝐸″)
   ... | _ | pop-y*𝐸′/E′ rewrite pop∘push y a = [ pop-y*𝐸′/E′ │•ᵇ E/E′ (⊖ 𝐹) ]
   /-preserves-⌣ [ _│•ᵇ_ {y = y} {a = a} 𝐸 F ]ˡ [ 𝐸′ │ᵥᵇ F′ ] [ 𝐸″ │ᵥ• 𝐹 ]ˡ
      with (pop y *ᵇ) (E/E′ (⊖ 𝐸)) | (pop y *ᵇᵇ⌣) (/-preserves-⌣ᵁᴰᵁ 𝐸 𝐸′ 𝐸″)
   ... | _ | pop-y*𝐸′/E′ rewrite pop∘push y a = [ pop-y*𝐸′/E′ │ᵥᵇ E/E′ (⊖ 𝐹) ]
   /-preserves-⌣ [ _│•ᵇ_ {y = y} {a = a} 𝐸 F ]ˡ [ _ᵇᵇ│_ {a′ = a′} {a⌣a′ = ᵇ∇ᵇ} 𝐸′ Q ] [ 𝐸″ │•ᵇ .F ]ˡ
      with (pop y *ᵇ) (E/E′ (⊖ 𝐸)) | (pop y *ᵇ) (E/E′ (⊖ 𝐸″)) | (pop y *ᵇᵇ⌣) (/-preserves-⌣ᵁᴰᵁ 𝐸 𝐸′ 𝐸″)
   ... | _ | _ | pop-y*𝐸′/E′ rewrite pop∘push y a | pop∘push y a′ = [ pop-y*𝐸′/E′ ᵇᵇ│ _ ]
   /-preserves-⌣ [ _│•ᵇ_ {x = x} {y} 𝐸 F ]ˡ [ _ᵇᵇ│_ {a⌣a′ = ᵛ∇ᵛ} 𝐸′ Q ] [ 𝐸″ │•ᵇ .F ]ˡ
       with (pop y *ᵇ) (E/E′ (⊖ 𝐸)) | (pop y *ᵇ) (E/E′ (⊖ 𝐸″)) | (pop y *ᵇᵇ⌣) (/-preserves-⌣ᵁᴰᵁ 𝐸 𝐸′ 𝐸″)
   ... | _ | _ | pop-y*𝐸′/E′ rewrite pop∘push y (• x) = [ pop-y*𝐸′/E′ ᵇᵇ│ _ ]
   /-preserves-⌣ [ _│•ᵇ_ {y = y} {a = a} 𝐸 F ]ˡ [ _ᵇᶜ│_ {a′ = a′} 𝐸′ Q ] [ 𝐸″ │•ᶜ .F ]ˡ
       with (pop y *ᵇ) (E/E′ (⊖ 𝐸)) | (pop y *ᶜ) (E/E′ (⊖ 𝐸″)) | (pop y *ᵇᶜ⌣) (/-preserves-⌣ᵁᴰᵁ 𝐸 𝐸′ 𝐸″)
   ... | _ | _ | pop-y*𝐸′/E′ rewrite pop∘push y a | pop∘push y a′ = [ pop-y*𝐸′/E′ ᵇᶜ│ _ ]
   /-preserves-⌣ [ _│•ᵇ_ {y = y} {a = a} 𝐸 F ]ˡ [ _ᵇᵇ│_ {a⌣a′ = ᵇ∇ᵇ} 𝐸′ Q ]ˡ [ _│•ᵇ_ {a = a′} 𝐸″ .F ]ˡ
       with (pop y *ᵇ) (E/E′ (⊖ 𝐸)) | (pop y *ᵇ) (E/E′ (⊖ 𝐸″)) | (pop y *ᵇᵇ⌣) (/-preserves-⌣ᵁᵁᵁ 𝐸 𝐸′ 𝐸″)
   ... | _ | _ | pop-y*𝐸′/E′ rewrite pop∘push y a | pop∘push y a′ = [ pop-y*𝐸′/E′ ᵇᵇ│ _ ]
   /-preserves-⌣ [ _│•ᵇ_ {x = x} {y} 𝐸 F ]ˡ [ _ᵇᵇ│_ {a⌣a′ = ᵛ∇ᵛ} 𝐸′ Q ]ˡ [ 𝐸″ │•ᵇ .F ]ˡ
       with (pop y *ᵇ) (E/E′ (⊖ 𝐸)) | (pop y *ᵇ) (E/E′ (⊖ 𝐸″)) | (pop y *ᵇᵇ⌣) (/-preserves-⌣ᵁᵁᵁ 𝐸 𝐸′ 𝐸″)
   ... | _ | _ | pop-y*𝐸′/E′ rewrite pop∘push y (• x) = [ pop-y*𝐸′/E′ ᵇᵇ│ _ ]
   /-preserves-⌣ [ _ │•ᵇ _ ]ˡ [ _ ᵇ│ᵇ _ ] [ () ]
   /-preserves-⌣ [ _ │•ᵇ _ ]ˡ [ _ ᵇ│ᶜ _ ] [ () ]
   /-preserves-⌣ [ _ │•ᵇ _ ]ˡ [ _ │ᵥᵇ _ ] [ () ]
   /-preserves-⌣ [ _ │•ᵇ _ ]ˡ [ _ ᵇᵇ│ _ ] [ () ]
   /-preserves-⌣ [ _ │•ᵇ _ ]ˡ [ _ ᵇᶜ│ _ ] [ () ]
   /-preserves-⌣ [ _ │•ᵇ _ ]ˡ [ _ ᵇᵇ│ _ ]ˡ [ () ]
...
-}
   /-preserves-⌣ [ E ᵇ│ᵇ F ] x₁ 𝐸″ = {!!}
   /-preserves-⌣ [ E ᵇ│ᶜ F ] x₁ 𝐸″ = {!!}
   /-preserves-⌣ [ E ᶜ│ᵇ F ] x₁ 𝐸″ = {!!}
   /-preserves-⌣ [ E ᶜ│ᶜ F ] x₁ 𝐸″ = {!!}
   /-preserves-⌣ [ x₁ │•ᵇ F ] x₂ 𝐸″ = {!!}
   /-preserves-⌣ [ x₁ │•ᶜ F ] x₂ 𝐸″ = {!!}
   /-preserves-⌣ [ E ᵇ│• x₁ ] x₂ 𝐸″ = {!!}
   /-preserves-⌣ [ E ᶜ│• x₁ ] x₂ 𝐸″ = {!!}
   /-preserves-⌣ [ x₁ │ᵥᵇ F ] x₂ 𝐸″ = {!!}
   /-preserves-⌣ [ x₁ │ᵥᶜ F ] x₂ 𝐸″ = {!!}
   /-preserves-⌣ [ E ᵇ│ᵥ x₁ ] x₂ 𝐸″ = {!!}
   /-preserves-⌣ [ E ᶜ│ᵥ x₁ ] x₂ 𝐸″ = {!!}
   /-preserves-⌣ [ x ➕₁ Q ] x₁ 𝐸″ = {!!}
   /-preserves-⌣ [ P │ᵇᵇ x ] x₁ 𝐸″ = {!!}
   /-preserves-⌣ [ P │ᵇᶜ x ] x₁ 𝐸″ = {!!}
   /-preserves-⌣ [ P │ᶜᶜ x ] x₁ 𝐸″ = {!!}
   /-preserves-⌣ [ x ᵇᵇ│ Q ] x₁ 𝐸″ = {!!}
   /-preserves-⌣ [ x ᵇᶜ│ Q ] x₁ 𝐸″ = {!!}
   /-preserves-⌣ [ x ᶜᶜ│ Q ] x₁ 𝐸″ = {!!}
   /-preserves-⌣ [ x₁ │• x₂ ] x₃ 𝐸″ = {!!}
   /-preserves-⌣ [ x₁ │ᵥ• x₂ ] x₃ 𝐸″ = {!!}
   /-preserves-⌣ [ x₁ │ᵥ x₂ ] x₃ 𝐸″ = {!!}
   /-preserves-⌣ [ ν• x₁ ] x₂ 𝐸″ = {!!}
   ...
   /-preserves-⌣ [ νᶜᶜ x ] x₁ 𝐸″ = {!!}
   /-preserves-⌣ [ ! x ] x₁ 𝐸″ = {!!}
   /-preserves-⌣ [ E ᵇ│ᵇ F ]ˡ x₁ 𝐸″ = {!!}
   /-preserves-⌣ [ E ᵇ│ᶜ F ]ˡ x₁ 𝐸″ = {!!}
   /-preserves-⌣ [ E ᶜ│ᵇ F ]ˡ x₁ 𝐸″ = {!!}
   /-preserves-⌣ [ E ᶜ│ᶜ F ]ˡ x₁ 𝐸″ = {!!}
   -- /-preserves-⌣ [ x₁ │•ᵇ F ]ˡ x₂ 𝐸″ = ?
   /-preserves-⌣ [ x₁ │•ᶜ F ]ˡ x₂ 𝐸″ = {!!}
   /-preserves-⌣ [ E ᵇ│• x₁ ]ˡ x₂ 𝐸″ = {!!}
   /-preserves-⌣ [ E ᶜ│• x₁ ]ˡ x₂ 𝐸″ = {!!}
   /-preserves-⌣ [ x₁ │ᵥᵇ F ]ˡ x₂ 𝐸″ = {!!}
   /-preserves-⌣ [ x₁ │ᵥᶜ F ]ˡ x₂ 𝐸″ = {!!}
   /-preserves-⌣ [ E ᵇ│ᵥ x₁ ]ˡ x₂ 𝐸″ = {!!}
   /-preserves-⌣ [ E ᶜ│ᵥ x₁ ]ˡ x₂ 𝐸″ = {!!}
   /-preserves-⌣ [ x ➕₁ Q ]ˡ x₁ 𝐸″ = {!!}
   /-preserves-⌣ [ P │ᵇᵇ x ]ˡ x₁ 𝐸″ = {!!}
   /-preserves-⌣ [ P │ᵇᶜ x ]ˡ x₁ 𝐸″ = {!!}
   /-preserves-⌣ [ P │ᶜᶜ x ]ˡ x₁ 𝐸″ = {!!}
   /-preserves-⌣ [ x ᵇᵇ│ Q ]ˡ x₁ 𝐸″ = {!!}
   /-preserves-⌣ [ x ᵇᶜ│ Q ]ˡ x₁ 𝐸″ = {!!}
   /-preserves-⌣ [ x ᶜᶜ│ Q ]ˡ x₁ 𝐸″ = {!!}
   /-preserves-⌣ [ x₁ │• x₂ ]ˡ x₃ 𝐸″ = {!!}
   /-preserves-⌣ [ x₁ │ᵥ• x₂ ]ˡ x₃ 𝐸″ = {!!}
   /-preserves-⌣ [ x₁ │ᵥ x₂ ]ˡ x₃ 𝐸″ = {!!}
   /-preserves-⌣ [ ν• x₁ ]ˡ x₂ 𝐸″ = {!!}
   /-preserves-⌣ [ ν•ᵇ x₁ ]ˡ x₂ 𝐸″ = {!!}
   /-preserves-⌣ [ ν•ᶜ x₁ ]ˡ x₂ 𝐸″ = {!!}
   /-preserves-⌣ [ νᵇᵇ x ]ˡ x₁ 𝐸″ = {!!}
   /-preserves-⌣ [ νᵛᵛ x₁ ]ˡ x₂ 𝐸″ = {!!}
   /-preserves-⌣ [ νᵇᶜ x ]ˡ x₁ 𝐸″ = {!!}
   /-preserves-⌣ [ νᶜᶜ x ]ˡ x₁ 𝐸″ = {!!}
   /-preserves-⌣ [ ! x ]ˡ x₁ 𝐸″ = {!!}
