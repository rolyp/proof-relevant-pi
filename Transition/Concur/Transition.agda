...
module Transition.Concur.Transition where
   ...
   /-preserves-⌣₁ (_ᵇ│ᵥ_ {𝑎 = ᵛ∇ᵛ} E 𝐹) (𝐸′ │ᵥ• 𝐹′) (E′ ᵇ│• 𝐹″) = (push *ᵇᵇ⌣) 𝐸′ │• /-preserves-⌣₁ 𝐹 𝐹′ 𝐹″
   /-preserves-⌣₁ (_ᵇ│ᵥ_ {𝑎 = ᵇ∇ᵇ} E 𝐹) (_│ᵥ_ {•x⌣•u = ᵇ∇ᵇ} 𝐸 𝐹′) (_ᵇ│ᵥ_ {𝑎 = ᵇ∇ᵇ} E′ 𝐹″) =
      (push *ᵇᵇ⌣) 𝐸 │ᵥ /-preserves-⌣₁ 𝐹 𝐹′ 𝐹″
   /-preserves-⌣₁ (_ᵇ│ᵥ_ {𝑎 = ᵇ∇ᵇ} E 𝐹) (_│ᵥ_ {•x⌣•u = ᵇ∇ᵇ} 𝐸 𝐹′) (_ᵇ│ᵥ_ {𝑎 = ᵛ∇ᵛ} E′ 𝐹″) =
      (push *ᵇᵇ⌣) 𝐸 │ᵥ• (/-preserves-⌣₁ 𝐹 𝐹′ 𝐹″)
   /-preserves-⌣₁ (_ᵇ│ᵥ_ {𝑎 = ᵇ∇ᵇ} E 𝐹) (_│ᵥ_ {•x⌣•u = ᵛ∇ᵛ} 𝐸 𝐹′) (_ᵇ│ᵥ_ {𝑎 = ᵇ∇ᵇ} E′ 𝐹″) =
      (push *ᵇᵇ⌣) 𝐸 │ᵥ /-preserves-⌣₁ 𝐹 𝐹′ 𝐹″
   /-preserves-⌣₁ (_ᵇ│ᵥ_ {𝑎 = ᵇ∇ᵇ} E 𝐹) (_│ᵥ_ {•x⌣•u = ᵛ∇ᵛ} 𝐸 𝐹′) (_ᵇ│ᵥ_ {𝑎 = ᵛ∇ᵛ} E′ 𝐹″) =
      (push *ᵇᵇ⌣) 𝐸 │ᵥ• /-preserves-⌣₁ 𝐹 𝐹′ 𝐹″
   /-preserves-⌣₁ (_ᵇ│ᵥ_ {𝑎 = ᵛ∇ᵛ} E 𝐹) (_│ᵥ_ {•x⌣•u = ᵇ∇ᵇ} 𝐸 𝐹′) (_ᵇ│ᵥ_ {𝑎 = ᵇ∇ᵇ} E′ 𝐹″) =
      (push *ᵇᵇ⌣) 𝐸 │•ᵥ /-preserves-⌣₁ 𝐹 𝐹′ 𝐹″
   /-preserves-⌣₁ (_ᵇ│ᵥ_ {𝑎 = ᵛ∇ᵛ} E 𝐹) (_│ᵥ_ {•x⌣•u = ᵇ∇ᵇ} 𝐸 𝐹′) (_ᵇ│ᵥ_ {𝑎 = ᵛ∇ᵛ} E′ 𝐹″) =
      (push *ᵇᵇ⌣) 𝐸 │• /-preserves-⌣₁ 𝐹 𝐹′ 𝐹″
   /-preserves-⌣₁ (_ᵇ│ᵥ_ {𝑎 = ᵛ∇ᵛ} E 𝐹) (_│ᵥ_ {•x⌣•u = ᵛ∇ᵛ} 𝐸 𝐹′) (_ᵇ│ᵥ_ {𝑎 = ᵇ∇ᵇ} E′ 𝐹″) =
      (push *ᵇᵇ⌣) 𝐸 │•ᵥ /-preserves-⌣₁ 𝐹 𝐹′ 𝐹″
   /-preserves-⌣₁ (_ᵇ│ᵥ_ {𝑎 = ᵛ∇ᵛ} E 𝐹) (_│ᵥ_ {•x⌣•u = ᵛ∇ᵛ} 𝐸 𝐹′) (_ᵇ│ᵥ_ {𝑎 = ᵛ∇ᵛ} E′ 𝐹″) =
      (push *ᵇᵇ⌣) 𝐸 │• /-preserves-⌣₁ 𝐹 𝐹′ 𝐹″
   ...
   /-preserves-⌣₁ (𝐸 ᵇᶜ│ Q) (𝐸′ ᶜᵇ│ .Q) (_ᵇᵇ│_ {𝑎 = ᵛ∇ᵛ} 𝐸″ .Q) = /-preserves-⌣₁ 𝐸 𝐸′ 𝐸″ ᶜᶜ│ (push *) Q
   ...
   /-preserves-⌣₁ (P │ᵇᶜ 𝐹) (.P │ᶜᵇ 𝐹′) (_│ᵇᵇ_ {𝑎 = ᵛ∇ᵛ} .P 𝐹″) = (push *) P │ᶜᶜ /-preserves-⌣₁ 𝐹 𝐹′ 𝐹″
   ...
   /-preserves-⌣₁ (P │ᵇᶜ 𝐹) (E ᶜ│ᵥ 𝐹′) (_ᵇ│ᵥ_ {𝑎 = ᵛ∇ᵛ} .E 𝐹″) = (push *ᵇ) E ᶜ│• /-preserves-⌣₁ 𝐹 𝐹′ 𝐹″
   ...
   /-preserves-⌣₁ {𝑎′ = ᵛ∇ᵛ} (E ᵇ│ᵇ F) (P │ᵇᵇ 𝐹) (.E ᵇ│ᵇ F′) = _ │ᵇᵇ (push *ᵇᵇ⌣) 𝐹
   ...
   /-preserves-⌣₁ {𝑎′ = ᵛ∇ᵛ} (E ᶜ│ᵇ F) (P │ᵇᵇ 𝐹) (.E ᶜ│ᵇ F′) = _ │ᵇᵇ 𝐹
   ...
   /-preserves-⌣₁ {𝑎 = ᵛ∇ᵛ} (𝐸 ᵇᵇ│ Q) (E ᵇ│ᵇ F) (E′ ᵇ│ᵇ .F) = _ ᶜ│ᵇ (push *ᵇ) F
   /-preserves-⌣₁ {𝑎 = ᵇ∇ᵇ} (𝐸 ᵇᵇ│ Q) (E ᵇ│ᶜ F) (E′ ᵇ│ᶜ .F) = _ ᵇ│ᶜ (push *ᶜ) F
   /-preserves-⌣₁ {𝑎 = ᵛ∇ᵛ} (𝐸 ᵇᵇ│ Q) (E ᵇ│ᶜ F) (E′ ᵇ│ᶜ .F) = _ ᶜ│ᶜ (push *ᶜ) F
   /-preserves-⌣₁ {𝑎 = ᵇ∇ᵇ} (𝐸 ᵇᵇ│ Q) (𝐸′ │ᵥᵇ F) (𝐸″ │ᵥᵇ .F) = /-preserves-⌣₁ 𝐸 𝐸′ 𝐸″ │ᵥᵇ (push *ᵇ) F
   /-preserves-⌣₁ {𝑎 = ᵛ∇ᵛ} (𝐸 ᵇᵇ│ Q) (𝐸′ │ᵥᵇ F) (𝐸″ │ᵥᵇ .F) = /-preserves-⌣₁ 𝐸 𝐸′ 𝐸″ │ᵥᶜ (push *ᵇ) F
   ...
   /-preserves-⌣₁ {𝑎 = ᵛ∇ᵛ} (𝐸 ᵇᵇ│ Q) (𝐸′ │•ᵇ F) (𝐸″ │•ᵇ .F) = /-preserves-⌣₁ 𝐸 𝐸′ 𝐸″ │•ᶜ (push *ᶜ) F
   /-preserves-⌣₁ {𝑎 = ᵇ∇ᵇ} {𝑎′ = ᵇ∇ᵇ} {𝑎″ = ᵇ∇ᵇ} (𝐸 ᵇᵇ│ Q) (𝐸′ ᵇᵇ│ .Q) (𝐸″ ᵇᵇ│ .Q) =
      /-preserves-⌣₁ 𝐸 𝐸′ 𝐸″ ᵇᵇ│ (push *) Q
   /-preserves-⌣₁ {𝑎 = ᵇ∇ᵇ} {𝑎′ = ᵇ∇ᵇ} {𝑎″ = ᵛ∇ᵛ} (𝐸 ᵇᵇ│ Q) (𝐸′ ᵇᵇ│ .Q) (𝐸″ ᵇᵇ│ .Q) =
      /-preserves-⌣₁ 𝐸 𝐸′ 𝐸″ ᵇᶜ│ (push *) Q
   /-preserves-⌣₁ {𝑎 = ᵇ∇ᵇ} {𝑎′ = ᵛ∇ᵛ} {𝑎″ = ᵇ∇ᵇ} (𝐸 ᵇᵇ│ Q) (𝐸′ ᵇᵇ│ .Q) (𝐸″ ᵇᵇ│ .Q) =
      /-preserves-⌣₁ 𝐸 𝐸′ 𝐸″ ᵇᵇ│ (push *) Q
   /-preserves-⌣₁ {𝑎 = ᵇ∇ᵇ} {𝑎′ = ᵛ∇ᵛ} {𝑎″ = ᵛ∇ᵛ} (𝐸 ᵇᵇ│ Q) (𝐸′ ᵇᵇ│ .Q) (𝐸″ ᵇᵇ│ .Q) =
      /-preserves-⌣₁ 𝐸 𝐸′ 𝐸″ ᵇᶜ│ (push *) Q
   /-preserves-⌣₁ {𝑎 = ᵛ∇ᵛ} {ᵇ∇ᵇ} {ᵇ∇ᵇ} (𝐸 ᵇᵇ│ Q) (𝐸′ ᵇᵇ│ .Q) (𝐸″ ᵇᵇ│ .Q) = /-preserves-⌣₁ 𝐸 𝐸′ 𝐸″ ᶜᵇ│ (push *) Q
   /-preserves-⌣₁ {𝑎 = ᵛ∇ᵛ} {ᵇ∇ᵇ} {ᵛ∇ᵛ} (𝐸 ᵇᵇ│ Q) (𝐸′ ᵇᵇ│ .Q) (𝐸″ ᵇᵇ│ .Q) = /-preserves-⌣₁ 𝐸 𝐸′ 𝐸″ ᶜᶜ│ (push *) Q
   /-preserves-⌣₁ {𝑎 = ᵛ∇ᵛ} {ᵛ∇ᵛ} {ᵇ∇ᵇ} (𝐸 ᵇᵇ│ Q) (𝐸′ ᵇᵇ│ .Q) (𝐸″ ᵇᵇ│ .Q) = /-preserves-⌣₁ 𝐸 𝐸′ 𝐸″ ᶜᵇ│ (push *) Q
   /-preserves-⌣₁ {𝑎 = ᵛ∇ᵛ} {ᵛ∇ᵛ} {ᵛ∇ᵛ} (𝐸 ᵇᵇ│ Q) (𝐸′ ᵇᵇ│ .Q) (𝐸″ ᵇᵇ│ .Q) = /-preserves-⌣₁ 𝐸 𝐸′ 𝐸″ ᶜᶜ│ (push *) Q
   /-preserves-⌣₁ {𝑎 = ᵇ∇ᵇ} (𝐸 ᵇᵇ│ Q) (𝐸′ ᵇᶜ│ .Q) (𝐸″ ᵇᶜ│ .Q) = /-preserves-⌣₁ 𝐸 𝐸′ 𝐸″ ᵇᶜ│ (push *) Q
   /-preserves-⌣₁ {𝑎 = ᵛ∇ᵛ} (𝐸 ᵇᵇ│ Q) (𝐸′ ᵇᶜ│ .Q) (𝐸″ ᵇᶜ│ .Q) = /-preserves-⌣₁ 𝐸 𝐸′ 𝐸″ ᶜᶜ│ (push *) Q

   /-preserves-⌣₁ {𝑎 = ᵛ∇ᵛ} (P │ᵇᵇ 𝐹) (E ᵇ│• 𝐹′) (.E ᵇ│• 𝐹″) = (push *ᵇ) E ᶜ│• /-preserves-⌣₁ 𝐹 𝐹′ 𝐹″
   ...
   /-preserves-⌣₁ {𝑎 = ᵇ∇ᵇ} (P │ᵇᵇ 𝐹) (_ᵇ│ᵥ_ {𝑎 = ᵇ∇ᵇ} E 𝐹′) (_ᵇ│ᵥ_ {𝑎 = ᵛ∇ᵛ} .E 𝐹″) =
      (push *ᵇ) E ᵇ│• /-preserves-⌣₁ 𝐹 𝐹′ 𝐹″
   /-preserves-⌣₁ {𝑎 = ᵇ∇ᵇ} (P │ᵇᵇ 𝐹) (_ᵇ│ᵥ_ {𝑎 = ᵛ∇ᵛ} E 𝐹′) (_ᵇ│ᵥ_ {𝑎 = ᵇ∇ᵇ} .E 𝐹″) =
      (push *ᵇ) E ᵇ│ᵥ /-preserves-⌣₁ 𝐹 𝐹′ 𝐹″
   /-preserves-⌣₁ {𝑎 = ᵇ∇ᵇ} (P │ᵇᵇ 𝐹) (_ᵇ│ᵥ_ {𝑎 = ᵛ∇ᵛ} E 𝐹′) (_ᵇ│ᵥ_ {𝑎 = ᵛ∇ᵛ} .E 𝐹″) =
      (push *ᵇ) E ᵇ│• /-preserves-⌣₁ 𝐹 𝐹′ 𝐹″
   /-preserves-⌣₁ {𝑎 = ᵛ∇ᵛ} (P │ᵇᵇ 𝐹) (_ᵇ│ᵥ_ {𝑎 = ᵇ∇ᵇ} E 𝐹′) (_ᵇ│ᵥ_ {𝑎 = ᵇ∇ᵇ} .E 𝐹″) =
      (push *ᵇ) E ᶜ│ᵥ /-preserves-⌣₁ 𝐹 𝐹′ 𝐹″
   /-preserves-⌣₁ {𝑎 = ᵛ∇ᵛ} (P │ᵇᵇ 𝐹) (_ᵇ│ᵥ_ {𝑎 = ᵛ∇ᵛ} E 𝐹′) (_ᵇ│ᵥ_ {𝑎 = ᵇ∇ᵇ} .E 𝐹″) =
      (push *ᵇ) E ᶜ│ᵥ /-preserves-⌣₁ 𝐹 𝐹′ 𝐹″
   /-preserves-⌣₁ {𝑎 = ᵛ∇ᵛ} (P │ᵇᵇ 𝐹) (_ᵇ│ᵥ_ {𝑎 = ᵇ∇ᵇ} E 𝐹′) (_ᵇ│ᵥ_ {𝑎 = ᵛ∇ᵛ} .E 𝐹″) =
      (push *ᵇ) E ᶜ│• /-preserves-⌣₁ 𝐹 𝐹′ 𝐹″
   /-preserves-⌣₁ {𝑎 = ᵛ∇ᵛ} (P │ᵇᵇ 𝐹) (_ᵇ│ᵥ_ {𝑎 = ᵛ∇ᵛ} E 𝐹′) (_ᵇ│ᵥ_ {𝑎 = ᵛ∇ᵛ} .E 𝐹″) =
      (push *ᵇ) E ᶜ│• /-preserves-⌣₁ 𝐹 𝐹′ 𝐹″
   /-preserves-⌣₁ {𝑎 = ᵇ∇ᵇ} {𝑎″ = ᵇ∇ᵇ} (P │ᵇᵇ 𝐹) (.P │ᵇᵇ 𝐹′) (.P │ᵇᵇ 𝐹″) =
      (push *) P │ᵇᵇ /-preserves-⌣₁ 𝐹 𝐹′ 𝐹″
   /-preserves-⌣₁ {𝑎 = ᵇ∇ᵇ} {𝑎′ = ᵇ∇ᵇ} {𝑎″ = ᵛ∇ᵛ} (P │ᵇᵇ 𝐹) (.P │ᵇᵇ 𝐹′) (.P │ᵇᵇ 𝐹″) =
      (push *) P │ᵇᶜ /-preserves-⌣₁ 𝐹 𝐹′ 𝐹″
   /-preserves-⌣₁ {𝑎 = ᵇ∇ᵇ} {𝑎′ = ᵛ∇ᵛ} {𝑎″ = ᵛ∇ᵛ} (P │ᵇᵇ 𝐹) (.P │ᵇᵇ 𝐹′) (.P │ᵇᵇ 𝐹″) =
      (push *) P │ᵇᶜ /-preserves-⌣₁ 𝐹 𝐹′ 𝐹″
   /-preserves-⌣₁ {𝑎 = ᵛ∇ᵛ} {𝑎′ = ᵇ∇ᵇ} {𝑎″ = ᵇ∇ᵇ} (P │ᵇᵇ 𝐹) (.P │ᵇᵇ 𝐹′) (.P │ᵇᵇ 𝐹″) =
      (push *) P │ᶜᵇ /-preserves-⌣₁ 𝐹 𝐹′ 𝐹″
   /-preserves-⌣₁ {𝑎 = ᵛ∇ᵛ} {𝑎′ = ᵇ∇ᵇ} {𝑎″ = ᵛ∇ᵛ} (P │ᵇᵇ 𝐹) (.P │ᵇᵇ 𝐹′) (.P │ᵇᵇ 𝐹″) =
      (push *) P │ᶜᶜ /-preserves-⌣₁ 𝐹 𝐹′ 𝐹″
   /-preserves-⌣₁ {𝑎 = ᵛ∇ᵛ} {𝑎′ = ᵛ∇ᵛ} {𝑎″ = ᵇ∇ᵇ} (P │ᵇᵇ 𝐹) (.P │ᵇᵇ 𝐹′) (.P │ᵇᵇ 𝐹″) =
      (push *) P │ᶜᵇ /-preserves-⌣₁ 𝐹 𝐹′ 𝐹″
   /-preserves-⌣₁ {𝑎 = ᵛ∇ᵛ} {𝑎′ = ᵛ∇ᵛ} {𝑎″ = ᵛ∇ᵛ} (P │ᵇᵇ 𝐹) (.P │ᵇᵇ 𝐹′) (.P │ᵇᵇ 𝐹″) =
      (push *) P │ᶜᶜ /-preserves-⌣₁ 𝐹 𝐹′ 𝐹″
   /-preserves-⌣₁ {𝑎 = ᵇ∇ᵇ} (P │ᵇᵇ 𝐹) (.P │ᵇᶜ 𝐹′) (.P │ᵇᶜ 𝐹″) = (push *) P │ᵇᶜ /-preserves-⌣₁ 𝐹 𝐹′ 𝐹″
   /-preserves-⌣₁ {𝑎 = ᵛ∇ᵛ} (P │ᵇᵇ 𝐹) (.P │ᵇᶜ 𝐹′) (.P │ᵇᶜ 𝐹″) = (push *) P │ᶜᶜ /-preserves-⌣₁ 𝐹 𝐹′ 𝐹″
   ...
   /-preserves-⌣₁ (E ᵇ│• 𝐹) (𝐸 │•ᵥ 𝐹′) (_ᵇ│ᵥ_ {𝑎 = ᵛ∇ᵛ} E′ 𝐹″) = (push *ᵇᵇ⌣) 𝐸 │• /-preserves-⌣₁ 𝐹 𝐹′ 𝐹″
