...
module Transition.Concur.Transition where
   ...
   /-preserves-⌣₁ (_│ᵥ•_ {y = y} 𝐸 𝐹) (𝐸′ │•ᵥ 𝐹′) (_│ᵥ_ {•x⌣•u = ˣ∇ˣ} 𝐸″ 𝐹″) with (pop y *ᵇ) (E/E′ (⊖₁ 𝐸))
   ...
   /-preserves-⌣₁ (_ᵇ│ᵥ_ {𝑎 = ᵇ∇ᵇ} E 𝐹) (_│ᵥ_ {•x⌣•u = ᵇ∇ᵇ} 𝐸 𝐹′) (_ᵇ│ᵥ_ {𝑎 = ˣ∇ˣ} E′ 𝐹″) =
      (push *ᵇᵇ⌣) 𝐸 │ᵥ• (/-preserves-⌣₁ 𝐹 𝐹′ 𝐹″)
   /-preserves-⌣₁ (_ᵇ│ᵥ_ {𝑎 = ᵇ∇ᵇ} E 𝐹) (_│ᵥ_ {•x⌣•u = ˣ∇ˣ} 𝐸 𝐹′) (_ᵇ│ᵥ_ {𝑎 = ᵇ∇ᵇ} E′ 𝐹″) =
      (push *ᵇᵇ⌣) 𝐸 │ᵥ /-preserves-⌣₁ 𝐹 𝐹′ 𝐹″
   /-preserves-⌣₁ (_ᵇ│ᵥ_ {𝑎 = ᵇ∇ᵇ} E 𝐹) (_│ᵥ_ {•x⌣•u = ˣ∇ˣ} 𝐸 𝐹′) (_ᵇ│ᵥ_ {𝑎 = ˣ∇ˣ} E′ 𝐹″) =
      (push *ᵇᵇ⌣) 𝐸 │ᵥ• /-preserves-⌣₁ 𝐹 𝐹′ 𝐹″
   /-preserves-⌣₁ (_ᵇ│ᵥ_ {𝑎 = ˣ∇ˣ} E 𝐹) (_│ᵥ_ {•x⌣•u = ᵇ∇ᵇ} 𝐸 𝐹′) (_ᵇ│ᵥ_ {𝑎 = ᵇ∇ᵇ} E′ 𝐹″) =
      (push *ᵇᵇ⌣) 𝐸 │•ᵥ /-preserves-⌣₁ 𝐹 𝐹′ 𝐹″
   /-preserves-⌣₁ (_ᵇ│ᵥ_ {𝑎 = ˣ∇ˣ} E 𝐹) (_│ᵥ_ {•x⌣•u = ᵇ∇ᵇ} 𝐸 𝐹′) (_ᵇ│ᵥ_ {𝑎 = ˣ∇ˣ} E′ 𝐹″) =
      (push *ᵇᵇ⌣) 𝐸 │• /-preserves-⌣₁ 𝐹 𝐹′ 𝐹″
   /-preserves-⌣₁ (_ᵇ│ᵥ_ {𝑎 = ˣ∇ˣ} E 𝐹) (_│ᵥ_ {•x⌣•u = ˣ∇ˣ} 𝐸 𝐹′) (_ᵇ│ᵥ_ {𝑎 = ᵇ∇ᵇ} E′ 𝐹″) =
      (push *ᵇᵇ⌣) 𝐸 │•ᵥ /-preserves-⌣₁ 𝐹 𝐹′ 𝐹″
   /-preserves-⌣₁ (_ᵇ│ᵥ_ {𝑎 = ˣ∇ˣ} E 𝐹) (_│ᵥ_ {•x⌣•u = ˣ∇ˣ} 𝐸 𝐹′) (_ᵇ│ᵥ_ {𝑎 = ˣ∇ˣ} E′ 𝐹″) =
      (push *ᵇᵇ⌣) 𝐸 │• /-preserves-⌣₁ 𝐹 𝐹′ 𝐹″
   ...
   ... | pop-y*E′/E″ = νᶜᶜ (/-preserves-⌣₁ 𝐸 𝐸′ 𝐸″ │ᵥ• /-preserves-⌣₁ 𝐹 𝐹′ 𝐹″)
   /-preserves-⌣₁ (_│ᵥ_ {•x⌣•u = ˣ∇ˣ} 𝐸 𝐹) (_│ᵥ•_ {y = y} 𝐸′ 𝐹′) (𝐸″ │ᵥ• 𝐹″) with (pop y *ᵇ) (E/E′ (⊖₁ 𝐸′))
   ... | pop-y*E′/E″ = νᶜᶜ (/-preserves-⌣₁ 𝐸 𝐸′ 𝐸″ │• /-preserves-⌣₁ 𝐹 𝐹′ 𝐹″)
   /-preserves-⌣₁ (_│ᵥ_ {•x⌣•u = ᵇ∇ᵇ} 𝐸 𝐹) (𝐸′ │ᵥ 𝐹′) (_│ᵥ_ {•x⌣•u = ᵇ∇ᵇ} 𝐸″ 𝐹″) =
      νᶜᶜ (/-preserves-⌣₁ 𝐸 𝐸′ 𝐸″ │ᵥ /-preserves-⌣₁ 𝐹 𝐹′ 𝐹″)
   /-preserves-⌣₁ (_│ᵥ_ {•x⌣•u = ᵇ∇ᵇ} 𝐸 𝐹) (_│ᵥ_ {•x⌣•u = ᵇ∇ᵇ} 𝐸′ 𝐹′) (_│ᵥ_ {•x⌣•u = ˣ∇ˣ} 𝐸″ 𝐹″) =
      νᶜᶜ (/-preserves-⌣₁ 𝐸 𝐸′ 𝐸″ │ᵥ• /-preserves-⌣₁ 𝐹 𝐹′ 𝐹″)
   /-preserves-⌣₁ (_│ᵥ_ {•x⌣•u = ˣ∇ˣ} 𝐸 𝐹) (_│ᵥ_ {•x⌣•u = ᵇ∇ᵇ} 𝐸′ 𝐹′) (_│ᵥ_ {•x⌣•u = ᵇ∇ᵇ} 𝐸″ 𝐹″) =
      νᶜᶜ (/-preserves-⌣₁ 𝐸 𝐸′ 𝐸″ │•ᵥ /-preserves-⌣₁ 𝐹 𝐹′ 𝐹″)
   /-preserves-⌣₁ (_│ᵥ_ {•x⌣•u = ᵇ∇ᵇ} 𝐸 𝐹) (_│ᵥ_ {•x⌣•u = ˣ∇ˣ} 𝐸′ 𝐹′) (_│ᵥ_ {•x⌣•u = ˣ∇ˣ} 𝐸″ 𝐹″) =
      νᶜᶜ (/-preserves-⌣₁ 𝐸 𝐸′ 𝐸″ │ᵥ• /-preserves-⌣₁ 𝐹 𝐹′ 𝐹″)
   /-preserves-⌣₁ (_│ᵥ_ {•x⌣•u = ˣ∇ˣ} 𝐸 𝐹) (_│ᵥ_ {•x⌣•u = ᵇ∇ᵇ} 𝐸′ 𝐹′) (_│ᵥ_ {•x⌣•u = ˣ∇ˣ} 𝐸″ 𝐹″) =
      νᶜᶜ (/-preserves-⌣₁ 𝐸 𝐸′ 𝐸″ │• /-preserves-⌣₁ 𝐹 𝐹′ 𝐹″)
   /-preserves-⌣₁ (_│ᵥ_ {•x⌣•u = ˣ∇ˣ} 𝐸 𝐹) (_│ᵥ_ {•x⌣•u = ˣ∇ˣ} 𝐸′ 𝐹′) (_│ᵥ_ {•x⌣•u = ᵇ∇ᵇ} 𝐸″ 𝐹″) =
      νᶜᶜ (/-preserves-⌣₁ 𝐸 𝐸′ 𝐸″ │•ᵥ /-preserves-⌣₁ 𝐹 𝐹′ 𝐹″)
   /-preserves-⌣₁ (_│ᵥ_ {•x⌣•u = ˣ∇ˣ} 𝐸 𝐹) (_│ᵥ_ {•x⌣•u = ˣ∇ˣ} 𝐸′ 𝐹′) (_│ᵥ_ {•x⌣•u = ˣ∇ˣ} 𝐸″ 𝐹″) =
      νᶜᶜ (/-preserves-⌣₁ 𝐸 𝐸′ 𝐸″ │• /-preserves-⌣₁ 𝐹 𝐹′ 𝐹″)
