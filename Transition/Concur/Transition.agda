...
-}
   ...
   ᵇᶜ│ˡ-preserves 𝐸 Q [ _│•ᵇ_ {y = y} 𝐸′ F ] [ _│•ᶜ_ {a = a} 𝐹 .F ] with (pop y *ᶜ) (E/E′ (⊖ 𝐹))
   ... | _ rewrite pop∘push y a = [ {!!} │•ᵇ F ]
   ᵇᶜ│ˡ-preserves 𝐸 Q [ 𝐸′ │ᵥᵇ F ] [ 𝐹 │ᵥᶜ .F ] = [ {!!} │ᵥᵇ F ]
   ᵇᶜ│ˡ-preserves 𝐸 Q [ 𝐸′ ᵇᶜ│ .Q ] [ 𝐹 ᶜᶜ│ .Q ] = [ {!!} ᵇᶜ│ Q ]
   ᵇᶜ│ˡ-preserves 𝐸 Q [ 𝐸′ ᵇᵇ│ .Q ] [ 𝐹 ᵇᶜ│ .Q ]ˡ = [ {!!} ᵇᵇ│ Q ]
   ᵇᶜ│ˡ-preserves 𝐸 Q [ 𝐸′ ᵇᶜ│ .Q ] [ 𝐹 ᶜᶜ│ .Q ]ˡ = [ {!!} ᵇᶜ│ Q ]
   ᵇᶜ│ˡ-preserves 𝐸 Q [ 𝐸′ ᵇᵇ│ .Q ]ˡ [ 𝐹 ᵇᶜ│ .Q ]ˡ = [ {!!} ᵇᵇ│ Q ]
