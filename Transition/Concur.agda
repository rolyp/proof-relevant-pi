module Transition.Concur where
   ...
   ... | pop-y*E′/E rewrite pop∘push u y = pop-y*E′/E │ᵥ E′/E (⊖₁ 𝐹) ᵀΔ νᶜ ((id *ᵇ) (E/E′ (⊖₁ 𝐸)) │• E/E′ (⊖₁ 𝐹))
   ⊖₁ (𝐸 │ᵥ 𝐹) = νᶜ ({!!} │• E′/E (⊖₁ 𝐹)) {- E′/E (⊖₁ 𝐸) -} ᵀΔ νᶜ ({!!} │• E/E′ (⊖₁ 𝐹)) -- E/E′ (⊖₁ 𝐸)
   ⊖₁ (𝐸 │ᵥ′ 𝐹) = νᶜ ({!!} │ᵥ E′/E (⊖₁ 𝐹)) {- E′/E (⊖₁ 𝐸) -} ᵀΔ νᶜ ({!!} │ᵥ E/E′ (⊖₁ 𝐹)) -- E/E′ (⊖₁ 𝐸)
   ⊖₁ (ν• 𝐸) = E′/E (⊖₁ 𝐸) ᵀΔ E/E′ (⊖₁ 𝐸)
