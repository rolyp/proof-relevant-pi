module Transition.Concur where
   ...
   ... | pop-y*E/E′ rewrite pop∘push a y = ᶜ∇ᶜ ∶ E′/E │• F Δ pop-y*E/E′ ᶜ│ target F
   ...
   ... | push*E rewrite push-* x = ᵇ∇ᶜ ∶ push*E │• F′/F Δ ν• (target E │ᶜ F/F′)
   ...
   ... | ᵇ∇ᵇ ∶ E′/E Δ E/E′ | ᵛ∇ᵛ ∶ F′/F Δ F/F′ rewrite push-* x | push-* u =
   ...
   ... | swap*E/E′ rewrite trans (∘-*₁ x ᴿ.swap∘shift-shift) (shift-* push x) = ᵇ∇ᵇ ∶ E′/E Δ ν• swap*E/E′
   ⊖₁ (ν•ᶜ E⌣E′) with ⊖₁ E⌣E′
   ...
   ... | ᵛ∇ᵛ ∶ E/E′ Δ E′/E = ᵛ∇ᵛ ∶ E′/E Δ E/E′
   ... | ᵇ∇ᵇ ∶ E/E′ Δ E′/E = ᵇ∇ᵇ ∶ E′/E Δ E/E′
   ... | ᵇ∇ᶜ ∶ E/E′ Δ E′/E = ᶜ∇ᵇ ∶ E′/E Δ E/E′
   ... | ᶜ∇ᵇ ∶ E/E′ Δ E′/E = ᵇ∇ᶜ ∶ E′/E Δ E/E′
   ... | ᶜ∇ᶜ ∶ E/E′ Δ E′/E = ᶜ∇ᶜ ∶ E′/E Δ E/E′
